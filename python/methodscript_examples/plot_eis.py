...
def main():
    ...
    applied_frequency = ps.serial.get_values_by_column(curves, 0)
    measured_z_real = ps.serial.get_values_by_column(curves, 1)
    measured_z_imag = ps.serial.get_values_by_column(curves, 2)
