...
class Capabilities(BaseModel):
    ...
    def acv_max_frequency(self) -> int:
        ...
        return self._cap.MaxFrequencyACV
    ...
    def adc_auxiliary(self) -> AnalogComponent:
        ...
        return AnalogComponent.convert(self._cap.ADCAuxiliary)
    ...
    def adc_bipot(self) -> AnalogComponent:
        ...
        return AnalogComponent.convert(self._cap.ADCBiPot)
    ...
    def adc_current(self) -> AnalogComponent:
        ...
        return AnalogComponent.convert(self._cap.ADCCurrent)
    ...
    def adc_potential(self) -> AnalogComponent:
        ...
        return AnalogComponent.convert(self._cap.ADCPotential)
    ...
    def dac_auxiliary(self) -> AnalogComponent:
        ...
        return AnalogComponent.convert(self._cap.DACAuxiliary)
    ...
    def dac_bipot(self) -> AnalogComponent:
        ...
        return AnalogComponent.convert(self._cap.DACBiPot)
    ...
    def dac_current(self) -> AnalogComponent:
        ...
        return AnalogComponent.convert(self._cap.DACCurrent)

    @computed_field
    @property
    def dac_potential(self) -> AnalogComponent:
        """Gets an object with values to calculate the potential from the integer value received from the instrument."""
        return AnalogComponent.convert(self._cap.DACPotential)
    ...
    def firmware_version(self) -> float:
        ...
        return self._cap.FirmwareVersion
    ...
    def max_current(self) -> float:
        ...
        return self._cap.MaxCurrent

    @computed_field
    @property
    def max_n_points(self) -> float:
    ...
    def min_potential_bipot(self) -> float:
        ...
        return self._cap.MinPotentialBipot
