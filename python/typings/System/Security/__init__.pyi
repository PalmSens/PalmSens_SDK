...
import clr
from System import Array, Array_1, Attribute, Exception, IDisposable, SystemException
from System.Collections import ArrayList, Hashtable, ICollection, IDictionary, IEnumerator
from System.Reflection import AssemblyName, MethodBase, MethodInfo
...
class AllowPartiallyTrustedCallersAttribute(Attribute):
    ...
    def PartialTrustVisibilityLevel(
        self, value: PartialTrustVisibilityLevel
...
class PermissionSet(ICollection, IStackWalk, ISecurityEncodable, IDeserializationCallback):
    ...
    @staticmethod
    def ConvertPermissionSet(
        inFormat: str, inData: Array_1[int], outFormat: str
    ) -> Array_1[int]: ...
