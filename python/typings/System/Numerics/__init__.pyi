...
from System import Decimal, Array_1, ReadOnlySpan_1, Span_1, IFormatProvider, ValueTuple_2, UIntPtr, IComparable_1, IComparable, ISpanParsable_1, ISpanFormattable, IUtf8SpanParsable_1, IUtf8SpanFormattable, IEquatable_1, IFormattable
...
class BigInteger(IBinaryInteger_1[BigInteger], ISignedNumber_1[BigInteger]):
    ...
    class CreateSaturating_MethodGroup:
        ...
        class CreateSaturating_1(typing.Generic[CreateSaturating_1_T1]):
            CreateSaturating_1_TOther = BigInteger.CreateSaturating_MethodGroup.CreateSaturating_1_T1
    ...
    class CreateTruncating_MethodGroup:
        ...
        class CreateTruncating_1(typing.Generic[CreateTruncating_1_T1]):
            CreateTruncating_1_TOther = BigInteger.CreateTruncating_MethodGroup.CreateTruncating_1_T1
    ...
    class DivRem_MethodGroup:
        @typing.overload
        def __call__(self, left: BigInteger, right: BigInteger) -> ValueTuple_2[BigInteger, BigInteger]:...
        @typing.overload
        def __call__(self, dividend: BigInteger, divisor: BigInteger, remainder: clr.Reference[BigInteger]) -> BigInteger:...
    ...
    class TryParse_MethodGroup:
        ...
        @typing.overload
        def __call__(self, s: ReadOnlySpan_1[str], provider: IFormatProvider, result: clr.Reference[BigInteger]) -> bool:...
        @typing.overload
        def __call__(self, s: str, provider: IFormatProvider, result: clr.Reference[BigInteger]) -> bool:...
        @typing.overload
...
class Complex(ISignedNumber_1[Complex]):
    ...
    class CreateSaturating_MethodGroup:
        ...
        CreateSaturating_1_T1 = typing.TypeVar('CreateSaturating_1_T1')
        class CreateSaturating_1(typing.Generic[CreateSaturating_1_T1]):
            CreateSaturating_1_TOther = Complex.CreateSaturating_MethodGroup.CreateSaturating_1_T1
    ...
    class CreateTruncating_MethodGroup:
        ...
        CreateTruncating_1_T1 = typing.TypeVar('CreateTruncating_1_T1')
        class CreateTruncating_1(typing.Generic[CreateTruncating_1_T1]):
            CreateTruncating_1_TOther = Complex.CreateTruncating_MethodGroup.CreateTruncating_1_T1
    ...
    class Parse_MethodGroup:
        ...
        @typing.overload
        def __call__(self, s: ReadOnlySpan_1[str], style: NumberStyles, provider: IFormatProvider) -> Complex:...
        @typing.overload
        def __call__(self, s: str, style: NumberStyles, provider: IFormatProvider) -> Complex:...
    ...
    class TryParse_MethodGroup:
        @typing.overload
        def __call__(self, s: ReadOnlySpan_1[str], provider: IFormatProvider, result: clr.Reference[Complex]) -> bool:...
        @typing.overload
        def __call__(self, s: str, provider: IFormatProvider, result: clr.Reference[Complex]) -> bool:...
        @typing.overload
        def __call__(self, s: ReadOnlySpan_1[str], style: NumberStyles, provider: IFormatProvider, result: clr.Reference[Complex]) -> bool:...
        @typing.overload
        def __call__(self, s: str, style: NumberStyles, provider: IFormatProvider, result: clr.Reference[Complex]) -> bool:...
