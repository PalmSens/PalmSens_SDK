...
from System.Collections.Generic import IComparer_1, IEqualityComparer_1
from System.Globalization import NumberStyles

class BigInteger(IBinaryInteger_1[BigInteger], ISignedNumber_1[BigInteger]):
    ...
    @typing.overload
    def __init__(
        self, value: ReadOnlySpan_1[int], isUnsigned: bool = ..., isBigEndian: bool = ...
    ) -> None: ...
    @property
    ...
    @staticmethod
    def Clamp(value: BigInteger, min: BigInteger, max: BigInteger) -> BigInteger: ...
    @staticmethod
    ...
    # Operator not supported op_Explicit(value: Complex)
    @typing.overload
    ...
    # Operator not supported op_Implicit(value: Int128)
    ...
    # Operator not supported op_Implicit(value: UInt128)
    ...
    # Operator not supported op_UnsignedRightShift(value: BigInteger, shiftAmount: Int32)
    @staticmethod
    ...
    class CreateChecked_MethodGroup:
        ...
        ) -> CreateChecked_1[CreateChecked_1_T1]: ...

        CreateChecked_1_T1 = typing.TypeVar('CreateChecked_1_T1')
        class CreateChecked_1(typing.Generic[CreateChecked_1_T1]):
            CreateChecked_1_TOther = BigInteger.CreateChecked_MethodGroup.CreateChecked_1_T1
            def __call__(self, value: CreateChecked_1_TOther) -> BigInteger: ...
    ...
    class CreateSaturating_MethodGroup:
        ...
        ) -> CreateSaturating_1[CreateSaturating_1_T1]: ...

        CreateSaturating_1_T1 = typing.TypeVar('CreateSaturating_1_T1')
        class CreateSaturating_1(typing.Generic[CreateSaturating_1_T1]):
            CreateSaturating_1_TOther = (
                BigInteger.CreateSaturating_MethodGroup.CreateSaturating_1_T1
            )
            def __call__(self, value: CreateSaturating_1_TOther) -> BigInteger: ...
    ...
    class CreateTruncating_MethodGroup:
        ...
        ) -> CreateTruncating_1[CreateTruncating_1_T1]: ...

        CreateTruncating_1_T1 = typing.TypeVar('CreateTruncating_1_T1')
        class CreateTruncating_1(typing.Generic[CreateTruncating_1_T1]):
            CreateTruncating_1_TOther = (
                BigInteger.CreateTruncating_MethodGroup.CreateTruncating_1_T1
            )
            def __call__(self, value: CreateTruncating_1_TOther) -> BigInteger: ...
    ...
    class DivRem_MethodGroup:
        @typing.overload
        def __call__(
            self, left: BigInteger, right: BigInteger
        ) -> ValueTuple_2[BigInteger, BigInteger]: ...
        @typing.overload
        def __call__(
            self,
            dividend: BigInteger,
            divisor: BigInteger,
            remainder: clr.Reference[BigInteger],
        ) -> BigInteger: ...
    ...
    class Parse_MethodGroup:
        ...
        @typing.overload
        def __call__(self, s: ReadOnlySpan_1[str], provider: IFormatProvider) -> BigInteger: ...
        @typing.overload
        ...
        @typing.overload
        def __call__(
            self, value: str, style: NumberStyles, provider: IFormatProvider
        ) -> BigInteger: ...
    ...
    class TryParse_MethodGroup:
        @typing.overload
        def __call__(
            self, value: ReadOnlySpan_1[str], result: clr.Reference[BigInteger]
        ) -> bool: ...
        @typing.overload
        ...
        def __call__(
            ...
            provider: IFormatProvider,
            result: clr.Reference[BigInteger],
        ) -> bool: ...
        @typing.overload
        def __call__(
            self, s: str, provider: IFormatProvider, result: clr.Reference[BigInteger]
        ) -> bool: ...
        @typing.overload
        def __call__(
            self,
...
class Complex(ISignedNumber_1[Complex]):
    ...
    # Operator not supported op_Decrement(value: Complex)
    @typing.overload
    ...
    # Operator not supported op_Implicit(value: IntPtr)
    # Operator not supported op_Implicit(value: UIntPtr)
    # Operator not supported op_Increment(value: Complex)
    ...
    def __pos__(self, value: Complex) -> Complex: ...
    @staticmethod
    ...
    class CreateChecked_MethodGroup:
        ...
        CreateChecked_1_T1 = typing.TypeVar('CreateChecked_1_T1')
        class CreateChecked_1(typing.Generic[CreateChecked_1_T1]):
            CreateChecked_1_TOther = Complex.CreateChecked_MethodGroup.CreateChecked_1_T1
            def __call__(self, value: CreateChecked_1_TOther) -> Complex: ...
    ...
    class CreateSaturating_MethodGroup:
        ...
        class CreateSaturating_1(typing.Generic[CreateSaturating_1_T1]):
            CreateSaturating_1_TOther = (
                Complex.CreateSaturating_MethodGroup.CreateSaturating_1_T1
            )
            def __call__(self, value: CreateSaturating_1_TOther) -> Complex: ...
    ...
    class CreateTruncating_MethodGroup:
        ...
        class CreateTruncating_1(typing.Generic[CreateTruncating_1_T1]):
            CreateTruncating_1_TOther = (
                Complex.CreateTruncating_MethodGroup.CreateTruncating_1_T1
            )
            def __call__(self, value: CreateTruncating_1_TOther) -> Complex: ...
    ...
    class Parse_MethodGroup:
        @typing.overload
        def __call__(self, s: ReadOnlySpan_1[str], provider: IFormatProvider) -> Complex: ...
        @typing.overload
        def __call__(self, s: str, provider: IFormatProvider) -> Complex: ...
        @typing.overload
        def __call__(
            self, s: ReadOnlySpan_1[str], style: NumberStyles, provider: IFormatProvider
        ) -> Complex: ...
        @typing.overload
        def __call__(
            self, s: str, style: NumberStyles, provider: IFormatProvider
        ) -> Complex: ...
    ...
    class TryParse_MethodGroup:
        ...
        def __call__(
            ...
            s: ReadOnlySpan_1[str],
            provider: IFormatProvider,
            result: clr.Reference[Complex],
        ) -> bool: ...
        @typing.overload
        def __call__(
            self, s: str, provider: IFormatProvider, result: clr.Reference[Complex]
        ) -> bool: ...
        @typing.overload
        def __call__(
            self,
...
class IAdditionOperators_3(
    typing.Generic[
        IAdditionOperators_3_TSelf, IAdditionOperators_3_TOther, IAdditionOperators_3_TResult
    ],
    typing.Protocol,
):
    @abc.abstractmethod
    def __add__(
        self, left: IAdditionOperators_3_TSelf, right: IAdditionOperators_3_TOther
    ) -> IAdditionOperators_3_TResult: ...
...
class IAdditiveIdentity_2(
    typing.Generic[IAdditiveIdentity_2_TSelf, IAdditiveIdentity_2_TResult], typing.Protocol
):
    @classmethod
    @property
...
class IBinaryInteger_GenericClasses(abc.ABCMeta):
    ...
    def __getitem__(
        ...
        IBinaryInteger_1[Generic_IBinaryInteger_GenericClasses_IBinaryInteger_1_TSelf]
    ]: ...
...
class IBinaryInteger_1(
    ...
    @staticmethod
    def RotateLeft(
        value: IBinaryInteger_1_TSelf, rotateAmount: int
    ) -> IBinaryInteger_1_TSelf: ...
    @staticmethod
    def RotateRight(
        value: IBinaryInteger_1_TSelf, rotateAmount: int
    ) -> IBinaryInteger_1_TSelf: ...
    ...
    def TryReadBigEndian(
        ...
        isUnsigned: bool,
        value: clr.Reference[IBinaryInteger_1_TSelf],
    ) -> bool: ...
    @staticmethod
    @abc.abstractmethod
    ...
    class ReadBigEndian_MethodGroup(
        typing.Generic[ReadBigEndian_MethodGroup_IBinaryInteger_1_TSelf]
    ):
        ReadBigEndian_MethodGroup_IBinaryInteger_1_TSelf = (
    ...
    class ReadLittleEndian_MethodGroup(
        typing.Generic[ReadLittleEndian_MethodGroup_IBinaryInteger_1_TSelf]
    ):
        ReadLittleEndian_MethodGroup_IBinaryInteger_1_TSelf = (
    ...
    class WriteBigEndian_MethodGroup(
        typing.Generic[WriteBigEndian_MethodGroup_IBinaryInteger_1_TSelf]
    ):
        WriteBigEndian_MethodGroup_IBinaryInteger_1_TSelf = (
    ...
    class WriteLittleEndian_MethodGroup(
        typing.Generic[WriteLittleEndian_MethodGroup_IBinaryInteger_1_TSelf]
    ):
        WriteLittleEndian_MethodGroup_IBinaryInteger_1_TSelf = (
...
class IBinaryNumber_GenericClasses(abc.ABCMeta):
    ...
    def __getitem__(
        ...
        IBinaryNumber_1[Generic_IBinaryNumber_GenericClasses_IBinaryNumber_1_TSelf]
    ]: ...
...
class IBitwiseOperators_3(
    typing.Generic[
        IBitwiseOperators_3_TSelf, IBitwiseOperators_3_TOther, IBitwiseOperators_3_TResult
    ],
    typing.Protocol,
):
    @abc.abstractmethod
    def __and__(
        self, left: IBitwiseOperators_3_TSelf, right: IBitwiseOperators_3_TOther
    ) -> IBitwiseOperators_3_TResult: ...
    @abc.abstractmethod
    def __or__(
        self, left: IBitwiseOperators_3_TSelf, right: IBitwiseOperators_3_TOther
    ) -> IBitwiseOperators_3_TResult: ...
...
class IComparisonOperators_3(
    typing.Generic[
        IComparisonOperators_3_TSelf,
        IComparisonOperators_3_TOther,
        IComparisonOperators_3_TResult,
    ],
    ...
    @abc.abstractmethod
    def __gt__(
        self, left: IComparisonOperators_3_TSelf, right: IComparisonOperators_3_TOther
    ) -> IComparisonOperators_3_TResult: ...
    @abc.abstractmethod
    def __ge__(
        self, left: IComparisonOperators_3_TSelf, right: IComparisonOperators_3_TOther
...
class IDivisionOperators_3(
    typing.Generic[
        IDivisionOperators_3_TSelf, IDivisionOperators_3_TOther, IDivisionOperators_3_TResult
    ],
    typing.Protocol,
):
    ...
    @abc.abstractmethod
    def __truediv__(
        self, left: IDivisionOperators_3_TSelf, right: IDivisionOperators_3_TOther
    ) -> IDivisionOperators_3_TResult: ...
...
class IEqualityOperators_3(
    typing.Generic[
        IEqualityOperators_3_TSelf, IEqualityOperators_3_TOther, IEqualityOperators_3_TResult
    ],
    typing.Protocol,
):
    @abc.abstractmethod
    def __eq__(
        self, left: IEqualityOperators_3_TSelf, right: IEqualityOperators_3_TOther
    ) -> IEqualityOperators_3_TResult: ...
    @abc.abstractmethod
    def __ne__(
        self, left: IEqualityOperators_3_TSelf, right: IEqualityOperators_3_TOther
    ) -> IEqualityOperators_3_TResult: ...
...
class IFloatingPoint_GenericClasses(abc.ABCMeta):
    ...
    def __getitem__(
        ...
        IFloatingPoint_1[Generic_IFloatingPoint_GenericClasses_IFloatingPoint_1_TSelf]
    ]: ...
...
class IFloatingPoint_1(
    ...
    @abc.abstractmethod
    def TryWriteExponentBigEndian(
        self, destination: Span_1[int], bytesWritten: clr.Reference[int]
    ) -> bool: ...
    @abc.abstractmethod
    def TryWriteExponentLittleEndian(
        self, destination: Span_1[int], bytesWritten: clr.Reference[int]
    ) -> bool: ...
    @abc.abstractmethod
    def TryWriteSignificandBigEndian(
        self, destination: Span_1[int], bytesWritten: clr.Reference[int]
    ) -> bool: ...
    @abc.abstractmethod
    def TryWriteSignificandLittleEndian(
        self, destination: Span_1[int], bytesWritten: clr.Reference[int]
    ) -> bool: ...
    ...
    class WriteExponentBigEndian_MethodGroup(
        typing.Generic[WriteExponentBigEndian_MethodGroup_IFloatingPoint_1_TSelf]
    ):
        WriteExponentBigEndian_MethodGroup_IFloatingPoint_1_TSelf = (
    ...
    WriteSignificandLittleEndian: WriteSignificandLittleEndian_MethodGroup[
        IFloatingPoint_1_TSelf
    ]
...
class IFloatingPointConstants_1(
    typing.Generic[IFloatingPointConstants_1_TSelf],
    INumberBase_1[IFloatingPointConstants_1_TSelf],
    typing.Protocol,
):
    @classmethod
    @property
...
class IFloatingPointIeee754_1(
    ...
    def FusedMultiplyAdd(
        left: IFloatingPointIeee754_1_TSelf,
        right: IFloatingPointIeee754_1_TSelf,
        addend: IFloatingPointIeee754_1_TSelf,
    ) -> IFloatingPointIeee754_1_TSelf: ...
    @staticmethod
    @abc.abstractmethod
    ...
    @staticmethod
    def ReciprocalEstimate(
        x: IFloatingPointIeee754_1_TSelf,
    ) -> IFloatingPointIeee754_1_TSelf: ...
    @staticmethod
    def ReciprocalSqrtEstimate(
        x: IFloatingPointIeee754_1_TSelf,
    ) -> IFloatingPointIeee754_1_TSelf: ...
    @staticmethod
    @abc.abstractmethod
...
class IMinMaxValue_GenericClasses(abc.ABCMeta):
    ...
    def __getitem__(
        ...
        IMinMaxValue_1[Generic_IMinMaxValue_GenericClasses_IMinMaxValue_1_TSelf]
    ]: ...
...
class IModulusOperators_3(
    typing.Generic[
        IModulusOperators_3_TSelf, IModulusOperators_3_TOther, IModulusOperators_3_TResult
    ],
    typing.Protocol,
):
    @abc.abstractmethod
    def __mod__(
        self, left: IModulusOperators_3_TSelf, right: IModulusOperators_3_TOther
    ) -> IModulusOperators_3_TResult: ...
...
class IMultiplicativeIdentity_2(
    typing.Generic[IMultiplicativeIdentity_2_TSelf, IMultiplicativeIdentity_2_TResult],
    typing.Protocol,
):
    @classmethod
    @property
...
class IMultiplyOperators_3(
    typing.Generic[
        IMultiplyOperators_3_TSelf, IMultiplyOperators_3_TOther, IMultiplyOperators_3_TResult
    ],
    typing.Protocol,
):
    ...
    @abc.abstractmethod
    def __mul__(
        self, left: IMultiplyOperators_3_TSelf, right: IMultiplyOperators_3_TOther
    ) -> IMultiplyOperators_3_TResult: ...

class INumber_GenericClasses(abc.ABCMeta):
    Generic_INumber_GenericClasses_INumber_1_TSelf = typing.TypeVar(
        'Generic_INumber_GenericClasses_INumber_1_TSelf'
    )
    def __getitem__(
...
class INumber_1(
    ...
    @staticmethod
    def Clamp(
        value: INumber_1_TSelf, min: INumber_1_TSelf, max: INumber_1_TSelf
    ) -> INumber_1_TSelf: ...
    @staticmethod
...
class INumberBase_1(
    ...
    @staticmethod
    @abc.abstractmethod
    def MaxMagnitudeNumber(
        x: INumberBase_1_TSelf, y: INumberBase_1_TSelf
    ) -> INumberBase_1_TSelf: ...
    @staticmethod
    @abc.abstractmethod
    ...
    @staticmethod
    @abc.abstractmethod
    def MinMagnitudeNumber(
        x: INumberBase_1_TSelf, y: INumberBase_1_TSelf
    ) -> INumberBase_1_TSelf: ...
    # Skipped CreateChecked due to it being static, abstract and generic.

    CreateChecked: CreateChecked_MethodGroup[INumberBase_1_TSelf]
    CreateChecked_MethodGroup_INumberBase_1_TSelf = typing.TypeVar(
        'CreateChecked_MethodGroup_INumberBase_1_TSelf'
    )
    class CreateChecked_MethodGroup(
        typing.Generic[CreateChecked_MethodGroup_INumberBase_1_TSelf]
    ):
        CreateChecked_MethodGroup_INumberBase_1_TSelf = (
            INumberBase_1.CreateChecked_MethodGroup_INumberBase_1_TSelf
        )
        def __getitem__(
            self, t: typing.Type[CreateChecked_1_T1]
        ) -> CreateChecked_1[
            CreateChecked_MethodGroup_INumberBase_1_TSelf, CreateChecked_1_T1
        ]: ...

        CreateChecked_1_INumberBase_1_TSelf = typing.TypeVar(
            'CreateChecked_1_INumberBase_1_TSelf'
        )
        CreateChecked_1_T1 = typing.TypeVar('CreateChecked_1_T1')
        class CreateChecked_1(
            typing.Generic[CreateChecked_1_INumberBase_1_TSelf, CreateChecked_1_T1]
        ):
            CreateChecked_1_INumberBase_1_TSelf = (
            ...
            def __call__(
                self, value: CreateChecked_1_TOther
            ) -> CreateChecked_1_INumberBase_1_TSelf: ...
    ...
    class CreateSaturating_MethodGroup(
        typing.Generic[CreateSaturating_MethodGroup_INumberBase_1_TSelf]
    ):
        CreateSaturating_MethodGroup_INumberBase_1_TSelf = (
        ...
        def __getitem__(
            ...
            CreateSaturating_MethodGroup_INumberBase_1_TSelf, CreateSaturating_1_T1
        ]: ...

        CreateSaturating_1_INumberBase_1_TSelf = typing.TypeVar(
            'CreateSaturating_1_INumberBase_1_TSelf'
        )
        CreateSaturating_1_T1 = typing.TypeVar('CreateSaturating_1_T1')
        class CreateSaturating_1(
            typing.Generic[CreateSaturating_1_INumberBase_1_TSelf, CreateSaturating_1_T1]
        ):
            CreateSaturating_1_INumberBase_1_TSelf = INumberBase_1.CreateSaturating_MethodGroup.CreateSaturating_1_INumberBase_1_TSelf
            CreateSaturating_1_TOther = (
                INumberBase_1.CreateSaturating_MethodGroup.CreateSaturating_1_T1
            )
            def __call__(
                self, value: CreateSaturating_1_TOther
            ) -> CreateSaturating_1_INumberBase_1_TSelf: ...
    ...
    class CreateTruncating_MethodGroup(
        typing.Generic[CreateTruncating_MethodGroup_INumberBase_1_TSelf]
    ):
        CreateTruncating_MethodGroup_INumberBase_1_TSelf = (
        ...
        def __getitem__(
            ...
            CreateTruncating_MethodGroup_INumberBase_1_TSelf, CreateTruncating_1_T1
        ]: ...

        CreateTruncating_1_INumberBase_1_TSelf = typing.TypeVar(
            'CreateTruncating_1_INumberBase_1_TSelf'
        )
        CreateTruncating_1_T1 = typing.TypeVar('CreateTruncating_1_T1')
        class CreateTruncating_1(
            typing.Generic[CreateTruncating_1_INumberBase_1_TSelf, CreateTruncating_1_T1]
        ):
            CreateTruncating_1_INumberBase_1_TSelf = INumberBase_1.CreateTruncating_MethodGroup.CreateTruncating_1_INumberBase_1_TSelf
            CreateTruncating_1_TOther = (
                INumberBase_1.CreateTruncating_MethodGroup.CreateTruncating_1_T1
            )
            def __call__(
                self, value: CreateTruncating_1_TOther
            ) -> CreateTruncating_1_INumberBase_1_TSelf: ...
...
class IPowerFunctions_GenericClasses(abc.ABCMeta):
    ...
    def __getitem__(
        ...
        IPowerFunctions_1[Generic_IPowerFunctions_GenericClasses_IPowerFunctions_1_TSelf]
    ]: ...
...
class IPowerFunctions_1(
    typing.Generic[IPowerFunctions_1_TSelf],
    INumberBase_1[IPowerFunctions_1_TSelf],
    typing.Protocol,
):
    @staticmethod
    @abc.abstractmethod
    def Pow(
        x: IPowerFunctions_1_TSelf, y: IPowerFunctions_1_TSelf
    ) -> IPowerFunctions_1_TSelf: ...
...
class IRootFunctions_GenericClasses(abc.ABCMeta):
    ...
    def __getitem__(
        ...
        IRootFunctions_1[Generic_IRootFunctions_GenericClasses_IRootFunctions_1_TSelf]
    ]: ...
...
class IRootFunctions_1(
    typing.Generic[IRootFunctions_1_TSelf],
    IFloatingPointConstants_1[IRootFunctions_1_TSelf],
    typing.Protocol,
):
    @staticmethod
    @abc.abstractmethod
    ...
    @abc.abstractmethod
    def Hypot(
        x: IRootFunctions_1_TSelf, y: IRootFunctions_1_TSelf
    ) -> IRootFunctions_1_TSelf: ...
    @staticmethod
    @abc.abstractmethod
...
class IShiftOperators_3(
    typing.Generic[
        IShiftOperators_3_TSelf, IShiftOperators_3_TOther, IShiftOperators_3_TResult
    ],
    typing.Protocol,
):
    @abc.abstractmethod
    def __lshift__(
        self, value: IShiftOperators_3_TSelf, shiftAmount: IShiftOperators_3_TOther
    ) -> IShiftOperators_3_TResult: ...
    @abc.abstractmethod
    def __rshift__(
        self, value: IShiftOperators_3_TSelf, shiftAmount: IShiftOperators_3_TOther
    ) -> IShiftOperators_3_TResult: ...
...
class ISignedNumber_GenericClasses(abc.ABCMeta):
    ...
    def __getitem__(
        ...
        ISignedNumber_1[Generic_ISignedNumber_GenericClasses_ISignedNumber_1_TSelf]
    ]: ...
...
class ISignedNumber_1(
    typing.Generic[ISignedNumber_1_TSelf], INumberBase_1[ISignedNumber_1_TSelf], typing.Protocol
):
    @classmethod
    @property
...
class ISubtractionOperators_3(
    typing.Generic[
        ISubtractionOperators_3_TSelf,
        ISubtractionOperators_3_TOther,
        ISubtractionOperators_3_TResult,
    ],
    typing.Protocol,
):
    ...
    @abc.abstractmethod
    def __sub__(
        self, left: ISubtractionOperators_3_TSelf, right: ISubtractionOperators_3_TOther
    ) -> ISubtractionOperators_3_TResult: ...
...
class ITrigonometricFunctions_1(
    ...
    def DegreesToRadians(
        degrees: ITrigonometricFunctions_1_TSelf,
    ) -> ITrigonometricFunctions_1_TSelf: ...
    @staticmethod
    def RadiansToDegrees(
        radians: ITrigonometricFunctions_1_TSelf,
    ) -> ITrigonometricFunctions_1_TSelf: ...
    @staticmethod
    @abc.abstractmethod
...
class IUnaryNegationOperators_2(
    typing.Generic[IUnaryNegationOperators_2_TSelf, IUnaryNegationOperators_2_TResult],
    typing.Protocol,
):
    # Operator not supported op_CheckedUnaryNegation(value: TSelf)
    @abc.abstractmethod
    def __neg__(
        self, value: IUnaryNegationOperators_2_TSelf
    ) -> IUnaryNegationOperators_2_TResult: ...
...
class IUnsignedNumber_GenericClasses(abc.ABCMeta):
    ...
    def __getitem__(
        ...
        IUnsignedNumber_1[Generic_IUnsignedNumber_GenericClasses_IUnsignedNumber_1_TSelf]
    ]: ...
...
class IUnsignedNumber_1(
    typing.Generic[IUnsignedNumber_1_TSelf],
    INumberBase_1[IUnsignedNumber_1_TSelf],
    typing.Protocol,
):
    pass
...
class Matrix3x2(IEquatable_1[Matrix3x2]):
    def __init__(
        self, m11: float, m12: float, m21: float, m22: float, m31: float, m32: float
    ) -> None: ...
    M11: float
    M12: float
    M21: float
    ...
    class CreateSkew_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, radiansX: float, radiansY: float, centerPoint: Vector2
        ) -> Matrix3x2: ...
...
class Matrix4x4(IEquatable_1[Matrix4x4]):
    ...
    @staticmethod
    def CreateOrthographic(
        width: float, height: float, zNearPlane: float, zFarPlane: float
    ) -> Matrix4x4: ...
    @staticmethod
    def CreateOrthographicLeftHanded(
        width: float, height: float, zNearPlane: float, zFarPlane: float
    ) -> Matrix4x4: ...
    @staticmethod
    ...
    class CreateScale_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, xScale: float, yScale: float, zScale: float, centerPoint: Vector3
        ) -> Matrix4x4: ...
    ...
    class CreateTranslation_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, xPosition: float, yPosition: float, zPosition: float
        ) -> Matrix4x4: ...
...
class Quaternion(IEquatable_1[Quaternion]):
    ...
    @staticmethod
    def Slerp(
        quaternion1: Quaternion, quaternion2: Quaternion, amount: float
    ) -> Quaternion: ...
    @staticmethod
...
class TotalOrderIeee754Comparer_1(
    ...
    def Compare(
        self, x: TotalOrderIeee754Comparer_1_T, y: TotalOrderIeee754Comparer_1_T
    ) -> int: ...
    # Skipped Equals due to it being static, abstract and generic.
    ...
    class Equals_MethodGroup(typing.Generic[Equals_MethodGroup_TotalOrderIeee754Comparer_1_T]):
        ...
        def __call__(
            self,
            other: TotalOrderIeee754Comparer_1[
                Equals_MethodGroup_TotalOrderIeee754Comparer_1_T
            ],
        ) -> bool: ...
        @typing.overload
        ...
        def __call__(
            self,
            x: Equals_MethodGroup_TotalOrderIeee754Comparer_1_T,
            y: Equals_MethodGroup_TotalOrderIeee754Comparer_1_T,
        ) -> bool: ...
    ...
    class GetHashCode_MethodGroup(
        typing.Generic[GetHashCode_MethodGroup_TotalOrderIeee754Comparer_1_T]
    ):
        GetHashCode_MethodGroup_TotalOrderIeee754Comparer_1_T = (
        ...
        @typing.overload
        def __call__(
            self, obj: GetHashCode_MethodGroup_TotalOrderIeee754Comparer_1_T
        ) -> int: ...

class Vector_GenericClasses(abc.ABCMeta):
    Generic_Vector_GenericClasses_Vector_1_T = typing.TypeVar(
        'Generic_Vector_GenericClasses_Vector_1_T'
    )
    def __getitem__(
...
class Vector_0(abc.ABC):
    ...
    class Add_MethodGroup:
        ...
        class Add_1(typing.Generic[Add_1_T1]):
            ...
            def __call__(
                self, left: Vector_1[Add_1_T], right: Vector_1[Add_1_T]
            ) -> Vector_1[Add_1_T]: ...
    ...
    class AndNot_MethodGroup:
        ...
        class AndNot_1(typing.Generic[AndNot_1_T1]):
            ...
            def __call__(
                self, left: Vector_1[AndNot_1_T], right: Vector_1[AndNot_1_T]
            ) -> Vector_1[AndNot_1_T]: ...
    ...
    class AsVectorByte_MethodGroup:
        def __getitem__(
            self, t: typing.Type[AsVectorByte_1_T1]
        ) -> AsVectorByte_1[AsVectorByte_1_T1]: ...
    ...
    class AsVectorDouble_MethodGroup:
        def __getitem__(
            self, t: typing.Type[AsVectorDouble_1_T1]
        ) -> AsVectorDouble_1[AsVectorDouble_1_T1]: ...
    ...
    class AsVectorInt16_MethodGroup:
        def __getitem__(
            self, t: typing.Type[AsVectorInt16_1_T1]
        ) -> AsVectorInt16_1[AsVectorInt16_1_T1]: ...
    ...
    class AsVectorInt32_MethodGroup:
        def __getitem__(
            self, t: typing.Type[AsVectorInt32_1_T1]
        ) -> AsVectorInt32_1[AsVectorInt32_1_T1]: ...
    ...
    class AsVectorInt64_MethodGroup:
        def __getitem__(
            self, t: typing.Type[AsVectorInt64_1_T1]
        ) -> AsVectorInt64_1[AsVectorInt64_1_T1]: ...
    ...
    class AsVectorNInt_MethodGroup:
        def __getitem__(
            self, t: typing.Type[AsVectorNInt_1_T1]
        ) -> AsVectorNInt_1[AsVectorNInt_1_T1]: ...
    ...
    class AsVectorNUInt_MethodGroup:
        def __getitem__(
            self, t: typing.Type[AsVectorNUInt_1_T1]
        ) -> AsVectorNUInt_1[AsVectorNUInt_1_T1]: ...
    ...
    class AsVectorSByte_MethodGroup:
        def __getitem__(
            self, t: typing.Type[AsVectorSByte_1_T1]
        ) -> AsVectorSByte_1[AsVectorSByte_1_T1]: ...
    ...
    class AsVectorSingle_MethodGroup:
        def __getitem__(
            self, t: typing.Type[AsVectorSingle_1_T1]
        ) -> AsVectorSingle_1[AsVectorSingle_1_T1]: ...
    ...
    class AsVectorUInt16_MethodGroup:
        def __getitem__(
            self, t: typing.Type[AsVectorUInt16_1_T1]
        ) -> AsVectorUInt16_1[AsVectorUInt16_1_T1]: ...
    ...
    class AsVectorUInt32_MethodGroup:
        def __getitem__(
            self, t: typing.Type[AsVectorUInt32_1_T1]
        ) -> AsVectorUInt32_1[AsVectorUInt32_1_T1]: ...
    ...
    class AsVectorUInt64_MethodGroup:
        def __getitem__(
            self, t: typing.Type[AsVectorUInt64_1_T1]
        ) -> AsVectorUInt64_1[AsVectorUInt64_1_T1]: ...
    ...
    class ConditionalSelect_MethodGroup:
        ...
        class ConditionalSelect_1(typing.Generic[ConditionalSelect_1_T1]):
            ConditionalSelect_1_T = (
                Vector_0.ConditionalSelect_MethodGroup.ConditionalSelect_1_T1
            )
            def __call__(
                self,
    ...
    class Divide_MethodGroup:
        ...
        class Divide_1(typing.Generic[Divide_1_T1]):
            ...
            @typing.overload
            def __call__(
                self, left: Vector_1[Divide_1_T], right: Vector_1[Divide_1_T]
            ) -> Vector_1[Divide_1_T]: ...
            @typing.overload
            def __call__(
                self, left: Vector_1[Divide_1_T], right: Divide_1_T
            ) -> Vector_1[Divide_1_T]: ...
    ...
    class Dot_MethodGroup:
        ...
        class Dot_1(typing.Generic[Dot_1_T1]):
            ...
            def __call__(
                self, left: Vector_1[Dot_1_T], right: Vector_1[Dot_1_T]
            ) -> Dot_1_T: ...
    ...
    class Equals_MethodGroup:
        ...
        class Equals_1(typing.Generic[Equals_1_T1]):
            ...
            def __call__(
                self, left: Vector_1[Equals_1_T], right: Vector_1[Equals_1_T]
            ) -> Vector_1[Equals_1_T]: ...
    ...
    class EqualsAll_MethodGroup:
        ...
        class EqualsAll_1(typing.Generic[EqualsAll_1_T1]):
            ...
            def __call__(
                self, left: Vector_1[EqualsAll_1_T], right: Vector_1[EqualsAll_1_T]
            ) -> bool: ...
    ...
    class EqualsAny_MethodGroup:
        ...
        class EqualsAny_1(typing.Generic[EqualsAny_1_T1]):
            ...
            def __call__(
                self, left: Vector_1[EqualsAny_1_T], right: Vector_1[EqualsAny_1_T]
            ) -> bool: ...
    ...
    class GetElement_MethodGroup:
        ...
        class GetElement_1(typing.Generic[GetElement_1_T1]):
            ...
            def __call__(
                self, vector: Vector_1[GetElement_1_T], index: int
            ) -> GetElement_1_T: ...
    ...
    class GreaterThanAll_MethodGroup:
        ...
        class GreaterThanAll_1(typing.Generic[GreaterThanAll_1_T1]):
            ...
            def __call__(
                self, left: Vector_1[GreaterThanAll_1_T], right: Vector_1[GreaterThanAll_1_T]
            ) -> bool: ...
    ...
    class GreaterThanAny_MethodGroup:
        ...
        class GreaterThanAny_1(typing.Generic[GreaterThanAny_1_T1]):
            ...
            def __call__(
                self, left: Vector_1[GreaterThanAny_1_T], right: Vector_1[GreaterThanAny_1_T]
            ) -> bool: ...
    ...
    class GreaterThanOrEqual_MethodGroup:
        ...
        class GreaterThanOrEqual_1(typing.Generic[GreaterThanOrEqual_1_T1]):
            GreaterThanOrEqual_1_T = (
                Vector_0.GreaterThanOrEqual_MethodGroup.GreaterThanOrEqual_1_T1
            )
            def __call__(
                self,
                left: Vector_1[GreaterThanOrEqual_1_T],
                right: Vector_1[GreaterThanOrEqual_1_T],
    ...
    class GreaterThanOrEqualAll_MethodGroup:
        ...
        class GreaterThanOrEqualAll_1(typing.Generic[GreaterThanOrEqualAll_1_T1]):
            GreaterThanOrEqualAll_1_T = (
                Vector_0.GreaterThanOrEqualAll_MethodGroup.GreaterThanOrEqualAll_1_T1
            )
            def __call__(
                self,
                left: Vector_1[GreaterThanOrEqualAll_1_T],
                right: Vector_1[GreaterThanOrEqualAll_1_T],
            ) -> bool: ...
    ...
    class GreaterThanOrEqualAny_MethodGroup:
        ...
        class GreaterThanOrEqualAny_1(typing.Generic[GreaterThanOrEqualAny_1_T1]):
            GreaterThanOrEqualAny_1_T = (
                Vector_0.GreaterThanOrEqualAny_MethodGroup.GreaterThanOrEqualAny_1_T1
            )
            def __call__(
                self,
                left: Vector_1[GreaterThanOrEqualAny_1_T],
                right: Vector_1[GreaterThanOrEqualAny_1_T],
            ) -> bool: ...
    ...
    class LessThanAll_MethodGroup:
        ...
        class LessThanAll_1(typing.Generic[LessThanAll_1_T1]):
            ...
            def __call__(
                self, left: Vector_1[LessThanAll_1_T], right: Vector_1[LessThanAll_1_T]
            ) -> bool: ...
    ...
    class LessThanAny_MethodGroup:
        ...
        class LessThanAny_1(typing.Generic[LessThanAny_1_T1]):
            ...
            def __call__(
                self, left: Vector_1[LessThanAny_1_T], right: Vector_1[LessThanAny_1_T]
            ) -> bool: ...
    ...
    class LessThanOrEqualAll_MethodGroup:
        ...
        class LessThanOrEqualAll_1(typing.Generic[LessThanOrEqualAll_1_T1]):
            LessThanOrEqualAll_1_T = (
                Vector_0.LessThanOrEqualAll_MethodGroup.LessThanOrEqualAll_1_T1
            )
            def __call__(
                self,
                left: Vector_1[LessThanOrEqualAll_1_T],
                right: Vector_1[LessThanOrEqualAll_1_T],
            ) -> bool: ...
    ...
    class LessThanOrEqualAny_MethodGroup:
        ...
        class LessThanOrEqualAny_1(typing.Generic[LessThanOrEqualAny_1_T1]):
            LessThanOrEqualAny_1_T = (
                Vector_0.LessThanOrEqualAny_MethodGroup.LessThanOrEqualAny_1_T1
            )
            def __call__(
                self,
                left: Vector_1[LessThanOrEqualAny_1_T],
                right: Vector_1[LessThanOrEqualAny_1_T],
            ) -> bool: ...
    ...
    class LoadAlignedNonTemporal_MethodGroup:
        ...
        class LoadAlignedNonTemporal_1(typing.Generic[LoadAlignedNonTemporal_1_T1]):
            LoadAlignedNonTemporal_1_T = (
                Vector_0.LoadAlignedNonTemporal_MethodGroup.LoadAlignedNonTemporal_1_T1
            )
            def __call__(
    ...
    class Max_MethodGroup:
        ...
        class Max_1(typing.Generic[Max_1_T1]):
            ...
            def __call__(
                self, left: Vector_1[Max_1_T], right: Vector_1[Max_1_T]
            ) -> Vector_1[Max_1_T]: ...
    ...
    class Min_MethodGroup:
        ...
        class Min_1(typing.Generic[Min_1_T1]):
            ...
            def __call__(
                self, left: Vector_1[Min_1_T], right: Vector_1[Min_1_T]
            ) -> Vector_1[Min_1_T]: ...
    ...
    class Multiply_MethodGroup:
        ...
        class Multiply_1(typing.Generic[Multiply_1_T1]):
            ...
            @typing.overload
            def __call__(
                self, left: Vector_1[Multiply_1_T], right: Multiply_1_T
            ) -> Vector_1[Multiply_1_T]: ...
            @typing.overload
            def __call__(
                self, left: Multiply_1_T, right: Vector_1[Multiply_1_T]
            ) -> Vector_1[Multiply_1_T]: ...
    ...
    class OnesComplement_MethodGroup:
        ...
        class OnesComplement_1(typing.Generic[OnesComplement_1_T1]):
            ...
            def __call__(
                self, value: Vector_1[OnesComplement_1_T]
            ) -> Vector_1[OnesComplement_1_T]: ...
    ...
    class SquareRoot_MethodGroup:
        def __getitem__(
            self, t: typing.Type[SquareRoot_1_T1]
        ) -> SquareRoot_1[SquareRoot_1_T1]: ...
    ...
    class Store_MethodGroup:
        ...
        class Store_1(typing.Generic[Store_1_T1]):
            ...
            def __call__(
                self, source: Vector_1[Store_1_T], destination: clr.Reference[Store_1_T]
            ) -> None: ...
    ...
    class StoreAligned_MethodGroup:
        ...
        class StoreAligned_1(typing.Generic[StoreAligned_1_T1]):
            ...
            def __call__(
                self,
                source: Vector_1[StoreAligned_1_T],
    ...
    class StoreAlignedNonTemporal_MethodGroup:
        ...
        class StoreAlignedNonTemporal_1(typing.Generic[StoreAlignedNonTemporal_1_T1]):
            StoreAlignedNonTemporal_1_T = (
                Vector_0.StoreAlignedNonTemporal_MethodGroup.StoreAlignedNonTemporal_1_T1
            )
            def __call__(
                self,
    ...
    class Widen_MethodGroup:
        def __call__(
            self,
            source: Vector_1[float],
            low: clr.Reference[Vector_1[float]],
            high: clr.Reference[Vector_1[float]],
        ) -> None: ...
    ...
    class WithElement_MethodGroup:
        ...
        class WithElement_1(typing.Generic[WithElement_1_T1]):
            ...
            def __call__(
                self, vector: Vector_1[WithElement_1_T], index: int, value: WithElement_1_T
    ...
    class Xor_MethodGroup:
        ...
        class Xor_1(typing.Generic[Xor_1_T1]):
            ...
            def __call__(
                self, left: Vector_1[Xor_1_T], right: Vector_1[Xor_1_T]
            ) -> Vector_1[Xor_1_T]: ...
...
class Vector_1(typing.Generic[Vector_1_T], IFormattable, IEquatable_1[Vector_1[Vector_1_T]]):
    ...
    def GetHashCode(self) -> int: ...
    def __add__(
        self, left: Vector_1[Vector_1_T], right: Vector_1[Vector_1_T]
    ) -> Vector_1[Vector_1_T]: ...
    def __and__(
        self, left: Vector_1[Vector_1_T], right: Vector_1[Vector_1_T]
    ) -> Vector_1[Vector_1_T]: ...
    ...
    @typing.overload
    def __truediv__(
        self, left: Vector_1[Vector_1_T], right: Vector_1_T
    ) -> Vector_1[Vector_1_T]: ...
    ...
    def __lshift__(
        self, value: Vector_1[Vector_1_T], shiftCount: int
    ) -> Vector_1[Vector_1_T]: ...
    @typing.overload
    def __mul__(
        self, left: Vector_1[Vector_1_T], right: Vector_1[Vector_1_T]
    ...
    @typing.overload
    def __mul__(
        self, value: Vector_1[Vector_1_T], factor: Vector_1_T
    ) -> Vector_1[Vector_1_T]: ...
    @typing.overload
    def __mul__(
        self, factor: Vector_1_T, value: Vector_1[Vector_1_T]
    ) -> Vector_1[Vector_1_T]: ...
    ...
    class CopyTo_MethodGroup(typing.Generic[CopyTo_MethodGroup_Vector_1_T]):
        ...
        @typing.overload
        def __call__(
            self, destination: Array_1[CopyTo_MethodGroup_Vector_1_T], startIndex: int
        ) -> None: ...
