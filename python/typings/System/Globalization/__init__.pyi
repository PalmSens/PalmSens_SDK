...
class CompareInfo(IDeserializationCallback):
    ...
    def GetSortKeyLength(
        self, source: ReadOnlySpan_1[str], options: CompareOptions = ...
    ) -> int: ...
    ...
    class Compare_MethodGroup:
        ...
        def __call__(
            self,
            string1: ReadOnlySpan_1[str],
            string2: ReadOnlySpan_1[str],
    ...
    class IndexOf_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, source: ReadOnlySpan_1[str], value: Rune, options: CompareOptions = ...
        ) -> int: ...
        @typing.overload
        ...
        @typing.overload
        def __call__(
            self, source: str, value: str, startIndex: int, options: CompareOptions
        ) -> int: ...
...
class CultureNotFoundException(ArgumentException):
    ...
    @typing.overload
    def __init__(
        self, message: str, invalidCultureId: int, innerException: Exception
    ) -> None: ...
    @typing.overload
    def __init__(
        self, message: str, invalidCultureName: str, innerException: Exception
    ) -> None: ...
    @typing.overload
...
class GlobalizationExtensions(abc.ABC):
    @staticmethod
    def GetStringComparer(
        compareInfo: CompareInfo, options: CompareOptions
    ) -> StringComparer: ...
