...
import clr
from System import Array_1, Attribute, Exception, IDisposable, SystemException
from System.Collections import IDictionary, IDictionaryEnumerator, IEnumerable
...
class NeutralResourcesLanguageAttribute(Attribute):
    ...
    @typing.overload
    def __init__(
        self, cultureName: str, location: UltimateResourceFallbackLocation
    ) -> None: ...
    @property
    def CultureName(self) -> str: ...
    @property
...
class ResourceManager:
    ...
    @typing.overload
    def __init__(
        self, baseName: str, assembly: Assembly, usingResourceSet: typing.Type[typing.Any]
    ) -> None: ...
    @typing.overload
    ...
    def CreateFileBasedResourceManager(
        baseName: str, resourceDir: str, usingResourceSet: typing.Type[typing.Any]
    ) -> ResourceManager: ...
    def GetResourceSet(
...
class ResourceReader(IResourceReader):
    ...
    def GetResourceData(
        self,
        resourceName: str,
        resourceType: clr.Reference[str],
        resourceData: clr.Reference[Array_1[int]],
    ) -> None: ...
