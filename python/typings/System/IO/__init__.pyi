...
from System.Collections.Generic import IAsyncEnumerable_1, IEnumerable_1, IReadOnlyList_1
...
class BufferedStream(Stream):
    ...
    class ReadAsync_MethodGroup:
        @typing.overload
        def __call__(
            self, buffer: Memory_1[int], cancellationToken: CancellationToken = ...
        ) -> ValueTask_1[int]: ...
        @typing.overload
        def __call__(
            self,
    ...
    class WriteAsync_MethodGroup:
        @typing.overload
        def __call__(
            self, buffer: ReadOnlyMemory_1[int], cancellationToken: CancellationToken = ...
        ) -> ValueTask: ...
        @typing.overload
        def __call__(
            self,
...
class Directory(abc.ABC):
    ...
    class EnumerateDirectories_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, path: str, searchPattern: str, searchOption: SearchOption
        ) -> IEnumerable_1[str]: ...
        @typing.overload
        def __call__(
            self, path: str, searchPattern: str, enumerationOptions: EnumerationOptions
        ) -> IEnumerable_1[str]: ...
...
class DirectoryInfo(FileSystemInfo):
    ...
    class EnumerateDirectories_MethodGroup:
        ...
        ) -> IEnumerable_1[DirectoryInfo]: ...
        @typing.overload
        def __call__(
            self, searchPattern: str, enumerationOptions: EnumerationOptions
        ) -> IEnumerable_1[DirectoryInfo]: ...
...
class File(abc.ABC):
    ...
    @staticmethod
    def ReadAllBytesAsync(
        path: str, cancellationToken: CancellationToken = ...
    ) -> Task_1[Array_1[int]]: ...
    @staticmethod
    def ResolveLinkTarget(linkPath: str, returnFinalTarget: bool) -> FileSystemInfo: ...
    @staticmethod
    ...
    @staticmethod
    def WriteAllBytesAsync(
        path: str, bytes: Array_1[int], cancellationToken: CancellationToken = ...
    ) -> Task: ...
    ...
    class AppendAllLines_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, path: str, contents: IEnumerable_1[str], encoding: Encoding
        ) -> None: ...
    ...
    class AppendAllTextAsync_MethodGroup:
        @typing.overload
        def __call__(
            self, path: str, contents: str, cancellationToken: CancellationToken = ...
        ) -> Task: ...
        @typing.overload
        def __call__(
            self,
    ...
    class ReadAllLinesAsync_MethodGroup:
        @typing.overload
        def __call__(
            self, path: str, cancellationToken: CancellationToken = ...
        ) -> Task_1[Array_1[str]]: ...
        @typing.overload
        def __call__(
            self, path: str, encoding: Encoding, cancellationToken: CancellationToken = ...
        ) -> Task_1[Array_1[str]]: ...
    ...
    class Replace_MethodGroup:
        @typing.overload
        def __call__(
            self, sourceFileName: str, destinationFileName: str, destinationBackupFileName: str
        ) -> None: ...
        @typing.overload
        def __call__(
            self,
    ...
    class SetAttributes_MethodGroup:
        @typing.overload
        def __call__(
            self, fileHandle: SafeFileHandle, fileAttributes: FileAttributes
        ) -> None: ...
        @typing.overload
...
class FileInfo(FileSystemInfo):
    ...
    class Open_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, mode: FileMode, access: FileAccess, share: FileShare
        ) -> FileStream: ...
    ...
    class Replace_MethodGroup:
        @typing.overload
        def __call__(
            self, destinationFileName: str, destinationBackupFileName: str
        ) -> FileInfo: ...
        @typing.overload
        def __call__(
            self,
...
class FileStream(Stream):
    ...
    @typing.overload
    def __init__(
        self, handle: int, access: FileAccess, ownsHandle: bool, bufferSize: int
    ) -> None: ...
    @typing.overload
    def __init__(
        self, handle: int, access: FileAccess, ownsHandle: bool, bufferSize: int, isAsync: bool
    ) -> None: ...
    @typing.overload
...
class FileStreamOptions:
    ...
    def UnixCreateMode(
        self, value: typing.Optional[UnixFileMode]
    ) -> typing.Optional[UnixFileMode]: ...
...
class MemoryStream(Stream):
    ...
    @typing.overload
    def __init__(
        self, buffer: Array_1[int], index: int, count: int, writable: bool
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class Path(abc.ABC):
    ...
    class Join_MethodGroup:
        ...
        def __call__(
            self,
            path1: ReadOnlySpan_1[str],
            path2: ReadOnlySpan_1[str],
            path3: ReadOnlySpan_1[str],
        ) -> str: ...
        @typing.overload
        def __call__(self, path1: str, path2: str, path3: str) -> str: ...
        @typing.overload
...
class RandomAccess(abc.ABC):
    ...
    class Read_MethodGroup:
        ...
        def __call__(
            ...
            buffers: IReadOnlyList_1[Memory_1[int]],
            fileOffset: int,
        ) -> int: ...
        @typing.overload
        def __call__(
            self, handle: SafeFileHandle, buffer: Span_1[int], fileOffset: int
        ) -> int: ...
    ...
    class Write_MethodGroup:
        ...
        def __call__(
            self,
            handle: SafeFileHandle,
            buffers: IReadOnlyList_1[ReadOnlyMemory_1[int]],
            fileOffset: int,
        ) -> None: ...
        @typing.overload
        def __call__(
            self, handle: SafeFileHandle, buffer: ReadOnlySpan_1[int], fileOffset: int
        ) -> None: ...
...
class Stream(MarshalByRefObject, IAsyncDisposable, IDisposable):
    ...
    def Flush(self) -> None: ...
    def ReadAtLeast(
        self, buffer: Span_1[int], minimumBytes: int, throwOnEndOfStream: bool = ...
    ) -> int: ...
    def ReadAtLeastAsync(
        self,
        buffer: Memory_1[int],
        minimumBytes: int,
        throwOnEndOfStream: bool = ...,
        cancellationToken: CancellationToken = ...,
    ) -> ValueTask_1[int]: ...
    def ReadByte(self) -> int: ...
    @abc.abstractmethod
    ...
    class CopyToAsync_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, destination: Stream, cancellationToken: CancellationToken
        ) -> Task: ...
        @typing.overload
        def __call__(
            self, destination: Stream, bufferSize: int, cancellationToken: CancellationToken
...
class StreamReader(TextReader):
    ...
    class ReadAsync_MethodGroup:
        @typing.overload
        def __call__(
            self, buffer: Memory_1[str], cancellationToken: CancellationToken = ...
        ) -> ValueTask_1[int]: ...
        @typing.overload
...
class StreamWriter(TextWriter):
    ...
    @typing.overload
    def __init__(
        self, path: str, append: bool, encoding: Encoding, bufferSize: int
    ) -> None: ...
    @typing.overload
    ...
    class WriteAsync_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, buffer: ReadOnlyMemory_1[str], cancellationToken: CancellationToken = ...
        ) -> Task: ...
        @typing.overload
...
class StringWriter(TextWriter):
    ...
    class WriteAsync_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, value: StringBuilder, cancellationToken: CancellationToken = ...
        ) -> Task: ...
        @typing.overload
        def __call__(self, buffer: Array_1[str], index: int, count: int) -> Task: ...
...
class UnmanagedMemoryAccessor(IDisposable):
    ...
    @typing.overload
    def __init__(
        self, buffer: SafeBuffer, offset: int, capacity: int, access: FileAccess
    ) -> None: ...
    @property
    def CanRead(self) -> bool: ...
    @property
    ...
    class ReadArray_MethodGroup:
        ...
        class ReadArray_1(typing.Generic[ReadArray_1_T1]):
            ...
            def __call__(
                self, position: int, array: Array_1[ReadArray_1_T], offset: int, count: int
            ) -> int: ...
    ...
    class WriteArray_MethodGroup:
        ...
        class WriteArray_1(typing.Generic[WriteArray_1_T1]):
            ...
            def __call__(
                self, position: int, array: Array_1[WriteArray_1_T], offset: int, count: int
            ) -> None: ...
...
class UnmanagedMemoryStream(Stream):
    ...
    @typing.overload
    def __init__(
        self, buffer: SafeBuffer, offset: int, length: int, access: FileAccess
    ) -> None: ...
    @typing.overload
    def __init__(self, pointer: clr.Reference[int], length: int) -> None: ...
    @typing.overload
    def __init__(
        self, pointer: clr.Reference[int], length: int, capacity: int, access: FileAccess
    ) -> None: ...
    @property
    def CanRead(self) -> bool: ...
    @property
