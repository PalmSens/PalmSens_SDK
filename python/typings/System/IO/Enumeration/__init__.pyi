...
class FileSystemEnumerable_1(typing.Generic[FileSystemEnumerable_1_TResult], IEnumerable_1[FileSystemEnumerable_1_TResult]):
    ...
    def ShouldIncludePredicate(self, value: FindPredicate_1[FileSystemEnumerable_1_TResult]) -> FindPredicate_1[FileSystemEnumerable_1_TResult]: ...
    @property
    def ShouldRecursePredicate(self) -> FindPredicate_1[FileSystemEnumerable_1_TResult]: ...
    @ShouldRecursePredicate.setter
    def ShouldRecursePredicate(self, value: FindPredicate_1[FileSystemEnumerable_1_TResult]) -> FindPredicate_1[FileSystemEnumerable_1_TResult]: ...
