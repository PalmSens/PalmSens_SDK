...
from System.IO import EnumerationOptions, FileAttributes, FileSystemInfo
...
class FileSystemEnumerable_GenericClasses(abc.ABCMeta):
    Generic_FileSystemEnumerable_GenericClasses_FileSystemEnumerable_1_TResult = typing.TypeVar(
        'Generic_FileSystemEnumerable_GenericClasses_FileSystemEnumerable_1_TResult'
    )
    def __getitem__(
        self,
        types: typing.Type[
...
class FileSystemEnumerable_1(
    typing.Generic[FileSystemEnumerable_1_TResult],
    IEnumerable_1[FileSystemEnumerable_1_TResult],
):
    def __init__(
        self,
        directory: str,
        transform: FileSystemEnumerable_1.FindTransform_1[FileSystemEnumerable_1_TResult],
        options: EnumerationOptions = ...,
    ) -> None: ...

    FindPredicate_GenericClasses_FileSystemEnumerable_1_TResult = typing.TypeVar(
        'FindPredicate_GenericClasses_FileSystemEnumerable_1_TResult'
    )
    class FindPredicate_GenericClasses(
        typing.Generic[FindPredicate_GenericClasses_FileSystemEnumerable_1_TResult], abc.ABCMeta
    ):
        FindPredicate_GenericClasses_FileSystemEnumerable_1_TResult = (
            FileSystemEnumerable_1.FindPredicate_GenericClasses_FileSystemEnumerable_1_TResult
        )
        def __call__(
            self,
        ) -> FileSystemEnumerable_1.FindPredicate_1[
            FindPredicate_GenericClasses_FileSystemEnumerable_1_TResult
        ]: ...
    ...
    class FindPredicate_1(typing.Generic[FindPredicate_1_TResult], MulticastDelegate):
        ...
        def BeginInvoke(
            self,
            entry: clr.Reference[FileSystemEntry],
            callback: AsyncCallback,
            object: typing.Any,
        ) -> IAsyncResult: ...
        def EndInvoke(
            self, entry: clr.Reference[FileSystemEntry], result: IAsyncResult
        ) -> bool: ...
        def Invoke(self, entry: clr.Reference[FileSystemEntry]) -> bool: ...

    FindTransform_GenericClasses_FileSystemEnumerable_1_TResult = typing.TypeVar(
        'FindTransform_GenericClasses_FileSystemEnumerable_1_TResult'
    )
    class FindTransform_GenericClasses(
        typing.Generic[FindTransform_GenericClasses_FileSystemEnumerable_1_TResult], abc.ABCMeta
    ):
        FindTransform_GenericClasses_FileSystemEnumerable_1_TResult = (
            FileSystemEnumerable_1.FindTransform_GenericClasses_FileSystemEnumerable_1_TResult
        )
        def __call__(
            self,
        ) -> FileSystemEnumerable_1.FindTransform_1[
            FindTransform_GenericClasses_FileSystemEnumerable_1_TResult
        ]: ...
    ...
    class FindTransform_1(typing.Generic[FindTransform_1_TResult], MulticastDelegate):
        ...
        def EndInvoke(
            self, entry: clr.Reference[FileSystemEntry], result: IAsyncResult
        ) -> FindTransform_1_TResult: ...
        def Invoke(self, entry: clr.Reference[FileSystemEntry]) -> FindTransform_1_TResult: ...

    @property
    def ShouldIncludePredicate(self) -> FindPredicate_1[FileSystemEnumerable_1_TResult]: ...
    @ShouldIncludePredicate.setter
    def ShouldIncludePredicate(
        self, value: FindPredicate_1[FileSystemEnumerable_1_TResult]
    ) -> FindPredicate_1[FileSystemEnumerable_1_TResult]: ...
    @property
    def ShouldRecursePredicate(self) -> FindPredicate_1[FileSystemEnumerable_1_TResult]: ...
    @ShouldRecursePredicate.setter
    def ShouldRecursePredicate(
        self, value: FindPredicate_1[FileSystemEnumerable_1_TResult]
    ) -> FindPredicate_1[FileSystemEnumerable_1_TResult]: ...
    def GetEnumerator(self) -> IEnumerator_1[FileSystemEnumerable_1_TResult]: ...

class FileSystemEnumerator_GenericClasses(abc.ABCMeta):
    Generic_FileSystemEnumerator_GenericClasses_FileSystemEnumerator_1_TResult = typing.TypeVar(
        'Generic_FileSystemEnumerator_GenericClasses_FileSystemEnumerator_1_TResult'
    )
    def __getitem__(
        self,
        types: typing.Type[
...
class FileSystemEnumerator_1(
    typing.Generic[FileSystemEnumerator_1_TResult],
    CriticalFinalizerObject,
    IEnumerator_1[FileSystemEnumerator_1_TResult],
):
...
class FileSystemName(abc.ABC):
    @staticmethod
    def MatchesSimpleExpression(
        expression: ReadOnlySpan_1[str], name: ReadOnlySpan_1[str], ignoreCase: bool = ...
    ) -> bool: ...
    @staticmethod
    def MatchesWin32Expression(
        expression: ReadOnlySpan_1[str], name: ReadOnlySpan_1[str], ignoreCase: bool = ...
    ) -> bool: ...
    @staticmethod
