...
import clr
from System import Array_1, Attribute, Exception, ReadOnlySpan_1, TimeSpan
...
class Debug(abc.ABC):
    ...
    class Assert_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, condition: bool, message: clr.Reference[Debug.AssertInterpolatedStringHandler]
        ) -> None: ...
        @typing.overload
        ...
        def __call__(
            self,
            condition: bool,
            message: clr.Reference[Debug.AssertInterpolatedStringHandler],
            detailMessage: clr.Reference[Debug.AssertInterpolatedStringHandler],
        ) -> None: ...
        @typing.overload
        def __call__(
            self,
    ...
    class WriteIf_MethodGroup:
        ...
        def __call__(
            self,
            condition: bool,
            message: clr.Reference[Debug.WriteIfInterpolatedStringHandler],
        ) -> None: ...
        @typing.overload
...
class DebuggerVisualizerAttribute(Attribute):
    ...
    def __init__(
        self,
        visualizer: typing.Type[typing.Any],
        visualizerObjectSource: typing.Type[typing.Any],
    ) -> None: ...
    @typing.overload
    def __init__(
        self, visualizer: typing.Type[typing.Any], visualizerObjectSourceTypeName: str
    ) -> None: ...
    @typing.overload
    def __init__(self, visualizerTypeName: str) -> None: ...
    @typing.overload
    def __init__(
        self, visualizerTypeName: str, visualizerObjectSource: typing.Type[typing.Any]
    ) -> None: ...
    @typing.overload
    def __init__(
        self, visualizerTypeName: str, visualizerObjectSourceTypeName: str
    ) -> None: ...
    @property
...
class DebugProvider:
    ...
    @staticmethod
    def FailCore(
        stackTrace: str, message: str, detailMessage: str, errorSource: str
    ) -> None: ...
