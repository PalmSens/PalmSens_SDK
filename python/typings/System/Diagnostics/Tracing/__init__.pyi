...
class EventListener(IDisposable, abc.ABC):
    ...
    class EnableEvents_MethodGroup:
        ...
        def __call__(
            ...
            arguments: IDictionary_2[str, str],
        ) -> None: ...
...
class EventSource(IDisposable):
    ...
    @typing.overload
    def __init__(
        self, eventSourceName: str, config: EventSourceSettings, traits: Array_1[str]
    ) -> None: ...
    ...
    def SendCommand(
        ...
        commandArguments: IDictionary_2[str, str],
    ) -> None: ...
    def ToString(self) -> str: ...
    ...
    class GenerateManifest_MethodGroup:
        @typing.overload
        def __call__(
            self, eventSourceType: typing.Type[typing.Any], assemblyPathToIncludeInManifest: str
        ) -> str: ...
        @typing.overload
        def __call__(
            self,
            eventSourceType: typing.Type[typing.Any],
    ...
    class IsEnabled_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, level: EventLevel, keywords: EventKeywords, channel: EventChannel
        ) -> bool: ...
    ...
    class SetCurrentThreadActivityId_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, activityId: Guid, oldActivityThatWillContinue: clr.Reference[Guid]
        ) -> None: ...
    ...
    class Write_MethodGroup:
        ...
        class Write_1(typing.Generic[Write_1_T1]):
            ...
            @typing.overload
            def __call__(
                self, eventName: str, options: EventSourceOptions, data: Write_1_T
            ) -> None: ...
            @typing.overload
            def __call__(
                self,
                eventName: str,
                options: clr.Reference[EventSourceOptions],
                data: clr.Reference[Write_1_T],
            ) -> None: ...
            @typing.overload
            def __call__(
                self,
                eventName: str,
                options: clr.Reference[EventSourceOptions],
                activityId: clr.Reference[Guid],
                relatedActivityId: clr.Reference[Guid],
                data: clr.Reference[Write_1_T],
            ) -> None: ...
...
class EventWrittenEventArgs(EventArgs):
    ...
    @Payload.setter
    def Payload(
        self, value: ReadOnlyCollection_1[typing.Any]
    ) -> ReadOnlyCollection_1[typing.Any]: ...
    @property
...
class IncrementingPollingCounter(DiagnosticCounter):
    def __init__(
        self, name: str, eventSource: EventSource, totalValueProvider: Func_1[float]
    ) -> None: ...
    @property
    def DisplayName(self) -> str: ...
    @DisplayName.setter
...
class PollingCounter(DiagnosticCounter):
    def __init__(
        self, name: str, eventSource: EventSource, metricProvider: Func_1[float]
    ) -> None: ...
    @property
    def DisplayName(self) -> str: ...
    @DisplayName.setter
