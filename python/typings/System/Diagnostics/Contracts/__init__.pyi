...
import clr
from System import Attribute, EventArgs, Exception, Predicate_1
...
class Contract(abc.ABC):
    ...
    class EnsuresOnThrow_MethodGroup:
        def __getitem__(
            self, t: typing.Type[EnsuresOnThrow_1_T1]
        ) -> EnsuresOnThrow_1[EnsuresOnThrow_1_T1]: ...

        EnsuresOnThrow_1_T1 = typing.TypeVar('EnsuresOnThrow_1_T1')
        class EnsuresOnThrow_1(typing.Generic[EnsuresOnThrow_1_T1]):
            EnsuresOnThrow_1_TException = (
                Contract.EnsuresOnThrow_MethodGroup.EnsuresOnThrow_1_T1
            )
            @typing.overload
            def __call__(self, condition: bool) -> None: ...
            @typing.overload
    ...
    class Exists_MethodGroup:
        ...
        class Exists_1(typing.Generic[Exists_1_T1]):
            ...
            def __call__(
                self, collection: IEnumerable_1[Exists_1_T], predicate: Predicate_1[Exists_1_T]
            ) -> bool: ...

        def __call__(
            self, fromInclusive: int, toExclusive: int, predicate: Predicate_1[int]
        ) -> bool: ...
    ...
    class ForAll_MethodGroup:
        ...
        class ForAll_1(typing.Generic[ForAll_1_T1]):
            ...
            def __call__(
                self, collection: IEnumerable_1[ForAll_1_T], predicate: Predicate_1[ForAll_1_T]
            ) -> bool: ...
    ...
    class ValueAtReturn_MethodGroup:
        def __getitem__(
            self, t: typing.Type[ValueAtReturn_1_T1]
        ) -> ValueAtReturn_1[ValueAtReturn_1_T1]: ...
        ...
        class ValueAtReturn_1(typing.Generic[ValueAtReturn_1_T1]):
            ...
            def __call__(
                self, value: clr.Reference[ValueAtReturn_1_T]
            ) -> ValueAtReturn_1_T: ...
