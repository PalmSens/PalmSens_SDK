...
class DynamicDependencyAttribute(Attribute):
    ...
    @typing.overload
    def __init__(
        self, memberTypes: DynamicallyAccessedMemberTypes, type: typing.Type[typing.Any]
    ) -> None: ...
    @typing.overload
    def __init__(
        self, memberTypes: DynamicallyAccessedMemberTypes, typeName: str, assemblyName: str
    ) -> None: ...
    @property
