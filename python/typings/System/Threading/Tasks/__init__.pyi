...
from System.Collections.Generic import IAsyncEnumerable_1, IEnumerable_1
...
class Task_GenericClasses(abc.ABCMeta):
    Generic_Task_GenericClasses_Task_1_TResult = typing.TypeVar(
        'Generic_Task_GenericClasses_Task_1_TResult'
    )
    def __getitem__(
...
class Task_0(IDisposable, IAsyncResult):
    ...
    class ContinueWith_MethodGroup:
        ...
        ) -> ContinueWith_1[ContinueWith_1_T1]: ...
        ...
        @typing.overload
        def __call__(
            self, continuationAction: Action_1[Task], cancellationToken: CancellationToken
        ) -> Task: ...
        @typing.overload
        def __call__(
            self, continuationAction: Action_1[Task], scheduler: TaskScheduler
        ) -> Task: ...
        @typing.overload
        def __call__(
            self, continuationAction: Action_2[Task, typing.Any], state: typing.Any
        ) -> Task: ...
        @typing.overload
        def __call__(
            self,
    ...
    class Delay_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, millisecondsDelay: int, cancellationToken: CancellationToken
        ) -> Task: ...
        @typing.overload
    ...
    class FromCanceled_MethodGroup:
        def __getitem__(
            self, t: typing.Type[FromCanceled_1_T1]
        ) -> FromCanceled_1[FromCanceled_1_T1]: ...
    ...
    class FromException_MethodGroup:
        def __getitem__(
            self, t: typing.Type[FromException_1_T1]
        ) -> FromException_1[FromException_1_T1]: ...
    ...
    class FromResult_MethodGroup:
        def __getitem__(
            self, t: typing.Type[FromResult_1_T1]
        ) -> FromResult_1[FromResult_1_T1]: ...
        ...
        class FromResult_1(typing.Generic[FromResult_1_T1]):
            ...
            def __call__(
                self, result: FromResult_1_TResult
            ) -> Task_1[FromResult_1_TResult]: ...
    ...
    class Run_MethodGroup:
        ...
        class Run_1(typing.Generic[Run_1_T1]):
            ...
            @typing.overload
            def __call__(
                self, function: Func_1[Task_1[Run_1_TResult]]
            ...
            def __call__(
                self,
                function: Func_1[Task_1[Run_1_TResult]],
                cancellationToken: CancellationToken,
            ) -> Task_1[Run_1_TResult]: ...
            @typing.overload
            def __call__(
        ...
        @typing.overload
        def __call__(
            self, function: Func_1[Task], cancellationToken: CancellationToken
        ) -> Task: ...
        @typing.overload
    ...
    class WaitAll_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, tasks: Array_1[Task], cancellationToken: CancellationToken
        ) -> None: ...
        @typing.overload
    ...
    class WhenAll_MethodGroup:
        ...
        class WhenAll_1(typing.Generic[WhenAll_1_T1]):
            ...
            @typing.overload
            def __call__(
                self, tasks: Array_1[Task_1[WhenAll_1_TResult]]
    ...
    class WhenAny_MethodGroup:
        ...
        class WhenAny_1(typing.Generic[WhenAny_1_T1]):
            ...
            @typing.overload
            def __call__(
                self, tasks: Array_1[Task_1[WhenAny_1_TResult]]
...
class Task_1(typing.Generic[Task_1_TResult], Task_0):
    ...
    @typing.overload
    def __init__(
        self, function: Func_1[Task_1_TResult], cancellationToken: CancellationToken
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    @typing.overload
    def __init__(
        self, function: Func_1[Task_1_TResult], creationOptions: TaskCreationOptions
    ) -> None: ...
    @typing.overload
    def __init__(
        self, function: Func_2[typing.Any, Task_1_TResult], state: typing.Any
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    ConfigureAwait_MethodGroup_Task_1_TResult = typing.TypeVar(
        'ConfigureAwait_MethodGroup_Task_1_TResult'
    )
    class ConfigureAwait_MethodGroup(typing.Generic[ConfigureAwait_MethodGroup_Task_1_TResult]):
        ConfigureAwait_MethodGroup_Task_1_TResult = (
            Task_1.ConfigureAwait_MethodGroup_Task_1_TResult
        )
        @typing.overload
        def __call__(
    ...
    ContinueWith_MethodGroup_Task_1_TResult = typing.TypeVar(
        'ContinueWith_MethodGroup_Task_1_TResult'
    )
    class ContinueWith_MethodGroup(typing.Generic[ContinueWith_MethodGroup_Task_1_TResult]):
        ...
        class ContinueWith_1(typing.Generic[ContinueWith_1_Task_1_TResult, ContinueWith_1_T1]):
            ContinueWith_1_Task_1_TResult = (
                Task_1.ContinueWith_MethodGroup.ContinueWith_1_Task_1_TResult
            )
            ...
            def __call__(
                ...
                continuationFunction: Func_2[
                    Task_1[ContinueWith_1_Task_1_TResult], ContinueWith_1_TNewResult
                ],
        ...
        @typing.overload
        def __call__(
            self, continuationAction: Action_1[Task_1[ContinueWith_MethodGroup_Task_1_TResult]]
        ) -> Task: ...
        @typing.overload
        def __call__(
            self,
        ...
        def __call__(
            self,
            continuationAction: Action_2[
                Task_1[ContinueWith_MethodGroup_Task_1_TResult], typing.Any
            ],
            state: typing.Any,
        ) -> Task: ...
        @typing.overload
    ...
    WaitAsync_MethodGroup_Task_1_TResult = typing.TypeVar(
        'WaitAsync_MethodGroup_Task_1_TResult'
    )
...
class TaskAsyncEnumerableExtensions(abc.ABC):
    ...
    class ConfigureAwait_MethodGroup:
        def __getitem__(
            self, t: typing.Type[ConfigureAwait_1_T1]
        ) -> ConfigureAwait_1[ConfigureAwait_1_T1]: ...

        ConfigureAwait_1_T1 = typing.TypeVar('ConfigureAwait_1_T1')
        class ConfigureAwait_1(typing.Generic[ConfigureAwait_1_T1]):
            ConfigureAwait_1_T = (
                TaskAsyncEnumerableExtensions.ConfigureAwait_MethodGroup.ConfigureAwait_1_T1
            )
            def __call__(
                self,
                source: IAsyncEnumerable_1[ConfigureAwait_1_T],
                continueOnCapturedContext: bool,
            ) -> ConfiguredCancelableAsyncEnumerable_1[ConfigureAwait_1_T]: ...

        def __call__(
            self, source: IAsyncDisposable, continueOnCapturedContext: bool
        ) -> ConfiguredAsyncDisposable: ...
    ...
    class ToBlockingEnumerable_MethodGroup:
        ...
        class ToBlockingEnumerable_1(typing.Generic[ToBlockingEnumerable_1_T1]):
            ...
            def __call__(
                self,
                source: IAsyncEnumerable_1[ToBlockingEnumerable_1_T],
                cancellationToken: CancellationToken = ...,
    ...
    class WithCancellation_MethodGroup:
        def __getitem__(
            self, t: typing.Type[WithCancellation_1_T1]
        ) -> WithCancellation_1[WithCancellation_1_T1]: ...

        WithCancellation_1_T1 = typing.TypeVar('WithCancellation_1_T1')
        class WithCancellation_1(typing.Generic[WithCancellation_1_T1]):
            WithCancellation_1_T = (
                TaskAsyncEnumerableExtensions.WithCancellation_MethodGroup.WithCancellation_1_T1
            )
            def __call__(
                self,
                source: IAsyncEnumerable_1[WithCancellation_1_T],
                cancellationToken: CancellationToken,
...
class TaskCanceledException(OperationCanceledException):
    ...
    @typing.overload
    def __init__(
        self, message: str, innerException: Exception, token: CancellationToken
    ) -> None: ...
    @typing.overload
...
class TaskCompletionSource(
    TaskCompletionSource_0, metaclass=TaskCompletionSource_GenericClasses
): ...
...
class TaskCompletionSource_1(typing.Generic[TaskCompletionSource_1_TResult]):
    ...
    class SetCanceled_MethodGroup(
        typing.Generic[SetCanceled_MethodGroup_TaskCompletionSource_1_TResult]
    ):
        SetCanceled_MethodGroup_TaskCompletionSource_1_TResult = (
    ...
    class SetException_MethodGroup(
        typing.Generic[SetException_MethodGroup_TaskCompletionSource_1_TResult]
    ):
        SetException_MethodGroup_TaskCompletionSource_1_TResult = (
    ...
    class TrySetCanceled_MethodGroup(
        typing.Generic[TrySetCanceled_MethodGroup_TaskCompletionSource_1_TResult]
    ):
        TrySetCanceled_MethodGroup_TaskCompletionSource_1_TResult = (
    ...
    class TrySetException_MethodGroup(
        typing.Generic[TrySetException_MethodGroup_TaskCompletionSource_1_TResult]
    ):
        TrySetException_MethodGroup_TaskCompletionSource_1_TResult = (
...
class TaskExtensions(abc.ABC):
    ...
    class Unwrap_MethodGroup:
        ...
        class Unwrap_1(typing.Generic[Unwrap_1_T1]):
            ...
            def __call__(
                self, task: Task_1[Task_1[Unwrap_1_TResult]]
            ) -> Task_1[Unwrap_1_TResult]: ...
...
class TaskFactory_GenericClasses(abc.ABCMeta):
    ...
    def __getitem__(
        ...
        TaskFactory_1[Generic_TaskFactory_GenericClasses_TaskFactory_1_TResult]
    ]: ...
...
class TaskFactory_0:
    ...
    class ContinueWhenAll_MethodGroup:
        ...
        ) -> ContinueWhenAll_1[ContinueWhenAll_1_T1]: ...

        ContinueWhenAll_1_T1 = typing.TypeVar('ContinueWhenAll_1_T1')
        class ContinueWhenAll_1(typing.Generic[ContinueWhenAll_1_T1]):
            ContinueWhenAll_1_TAntecedentResult = (
                TaskFactory_0.ContinueWhenAll_MethodGroup.ContinueWhenAll_1_T1
            )
            ContinueWhenAll_1_TResult = (
                TaskFactory_0.ContinueWhenAll_MethodGroup.ContinueWhenAll_1_T1
            )
            @typing.overload
            def __call__(
                ...
                continuationAction: Action_1[
                    Array_1[Task_1[ContinueWhenAll_1_TAntecedentResult]]
                ],
            ) -> Task: ...
            @typing.overload
            def __call__(
        ...
        def __getitem__(
            self,
            t: typing.Tuple[
                typing.Type[ContinueWhenAll_2_T1], typing.Type[ContinueWhenAll_2_T2]
            ],
        ...
        class ContinueWhenAll_2(typing.Generic[ContinueWhenAll_2_T1, ContinueWhenAll_2_T2]):
            ContinueWhenAll_2_TAntecedentResult = (
                TaskFactory_0.ContinueWhenAll_MethodGroup.ContinueWhenAll_2_T1
            )
            ContinueWhenAll_2_TResult = (
                TaskFactory_0.ContinueWhenAll_MethodGroup.ContinueWhenAll_2_T2
            )
            @typing.overload
            def __call__(
                self,
                ...
                continuationFunction: Func_2[
                    Array_1[Task_1[ContinueWhenAll_2_TAntecedentResult]],
                    ContinueWhenAll_2_TResult,
                ],
        ...
        @typing.overload
        def __call__(
            self, tasks: Array_1[Task], continuationAction: Action_1[Array_1[Task]]
        ) -> Task: ...
        @typing.overload
        def __call__(
            self,
    ...
    class ContinueWhenAny_MethodGroup:
        ...
        ) -> ContinueWhenAny_1[ContinueWhenAny_1_T1]: ...

        ContinueWhenAny_1_T1 = typing.TypeVar('ContinueWhenAny_1_T1')
        class ContinueWhenAny_1(typing.Generic[ContinueWhenAny_1_T1]):
            ContinueWhenAny_1_TAntecedentResult = (
                TaskFactory_0.ContinueWhenAny_MethodGroup.ContinueWhenAny_1_T1
            )
            ContinueWhenAny_1_TResult = (
                TaskFactory_0.ContinueWhenAny_MethodGroup.ContinueWhenAny_1_T1
            )
            @typing.overload
            def __call__(
        ...
        def __getitem__(
            self,
            t: typing.Tuple[
                typing.Type[ContinueWhenAny_2_T1], typing.Type[ContinueWhenAny_2_T2]
            ],
        ...
        class ContinueWhenAny_2(typing.Generic[ContinueWhenAny_2_T1, ContinueWhenAny_2_T2]):
            ContinueWhenAny_2_TAntecedentResult = (
                TaskFactory_0.ContinueWhenAny_MethodGroup.ContinueWhenAny_2_T1
            )
            ContinueWhenAny_2_TResult = (
                TaskFactory_0.ContinueWhenAny_MethodGroup.ContinueWhenAny_2_T2
            )
            @typing.overload
            def __call__(
                self,
                ...
                continuationFunction: Func_2[
                    Task_1[ContinueWhenAny_2_TAntecedentResult], ContinueWhenAny_2_TResult
                ],
        ...
        @typing.overload
        def __call__(
            self, tasks: Array_1[Task], continuationAction: Action_1[Task]
        ) -> Task: ...
        @typing.overload
        def __call__(
            self,
    ...
    class FromAsync_MethodGroup:
        ...
        def __getitem__(
            self,
            t: typing.Tuple[
                typing.Type[FromAsync_3_T1],
                typing.Type[FromAsync_3_T2],
                typing.Type[FromAsync_3_T3],
            ],
        ...
        class FromAsync_3(typing.Generic[FromAsync_3_T1, FromAsync_3_T2, FromAsync_3_T3]):
            ...
            def __call__(
                ...
                arg1: FromAsync_3_TArg1,
                arg2: FromAsync_3_TArg2,
                state: typing.Any,
        ...
        class FromAsync_4(
            typing.Generic[FromAsync_4_T1, FromAsync_4_T2, FromAsync_4_T3, FromAsync_4_T4]
        ):
            ...
            def __call__(
                ...
                arg1: FromAsync_4_TArg1,
                arg2: FromAsync_4_TArg2,
                arg3: FromAsync_4_TArg3,
                state: typing.Any,
        ...
        @typing.overload
        def __call__(
            self, asyncResult: IAsyncResult, endMethod: Action_1[IAsyncResult]
        ) -> Task: ...
        @typing.overload
        def __call__(
            self,
    ...
    class StartNew_MethodGroup:
        ...
        class StartNew_1(typing.Generic[StartNew_1_T1]):
            ...
            @typing.overload
            def __call__(
                self, function: Func_1[StartNew_1_TResult]
            ...
            @typing.overload
            def __call__(
                self, function: Func_2[typing.Any, StartNew_1_TResult], state: typing.Any
            ) -> Task_1[StartNew_1_TResult]: ...
            @typing.overload
            def __call__(
                self,
...
class TaskFactory_1(typing.Generic[TaskFactory_1_TResult]):
    ...
    class ContinueWhenAll_MethodGroup(
        typing.Generic[ContinueWhenAll_MethodGroup_TaskFactory_1_TResult]
    ):
        ContinueWhenAll_MethodGroup_TaskFactory_1_TResult = (
        ...
        def __getitem__(
            ...
            ContinueWhenAll_MethodGroup_TaskFactory_1_TResult, ContinueWhenAll_1_T1
        ]: ...

        ContinueWhenAll_1_TaskFactory_1_TResult = typing.TypeVar(
            'ContinueWhenAll_1_TaskFactory_1_TResult'
        )
        ContinueWhenAll_1_T1 = typing.TypeVar('ContinueWhenAll_1_T1')
        class ContinueWhenAll_1(
            typing.Generic[ContinueWhenAll_1_TaskFactory_1_TResult, ContinueWhenAll_1_T1]
        ):
            ...
            ContinueWhenAll_1_TAntecedentResult = (
                TaskFactory_1.ContinueWhenAll_MethodGroup.ContinueWhenAll_1_T1
            )
            @typing.overload
            def __call__(
                self,
        ...
        def __call__(
            ...
            tasks: Array_1[Task],
            continuationFunction: Func_2[
                Array_1[Task], ContinueWhenAll_MethodGroup_TaskFactory_1_TResult
            ],
    ...
    class ContinueWhenAny_MethodGroup(
        typing.Generic[ContinueWhenAny_MethodGroup_TaskFactory_1_TResult]
    ):
        ContinueWhenAny_MethodGroup_TaskFactory_1_TResult = (
        ...
        def __getitem__(
            ...
            ContinueWhenAny_MethodGroup_TaskFactory_1_TResult, ContinueWhenAny_1_T1
        ]: ...

        ContinueWhenAny_1_TaskFactory_1_TResult = typing.TypeVar(
            'ContinueWhenAny_1_TaskFactory_1_TResult'
        )
        ContinueWhenAny_1_T1 = typing.TypeVar('ContinueWhenAny_1_T1')
        class ContinueWhenAny_1(
            typing.Generic[ContinueWhenAny_1_TaskFactory_1_TResult, ContinueWhenAny_1_T1]
        ):
            ...
            ContinueWhenAny_1_TAntecedentResult = (
                TaskFactory_1.ContinueWhenAny_MethodGroup.ContinueWhenAny_1_T1
            )
            @typing.overload
            def __call__(
                self,
                tasks: Array_1[Task_1[ContinueWhenAny_1_TAntecedentResult]],
                continuationFunction: Func_2[
                    Task_1[ContinueWhenAny_1_TAntecedentResult],
                    ContinueWhenAny_1_TaskFactory_1_TResult,
                ],
        ...
        def __call__(
            ...
            tasks: Array_1[Task],
            continuationFunction: Func_2[
                Task, ContinueWhenAny_MethodGroup_TaskFactory_1_TResult
            ],
    ...
    FromAsync_MethodGroup_TaskFactory_1_TResult = typing.TypeVar(
        'FromAsync_MethodGroup_TaskFactory_1_TResult'
    )
    class FromAsync_MethodGroup(typing.Generic[FromAsync_MethodGroup_TaskFactory_1_TResult]):
        FromAsync_MethodGroup_TaskFactory_1_TResult = (
            TaskFactory_1.FromAsync_MethodGroup_TaskFactory_1_TResult
        )
        @typing.overload
        def __getitem__(
            self, t: typing.Type[FromAsync_1_T1]
        ...
        class FromAsync_1(typing.Generic[FromAsync_1_TaskFactory_1_TResult, FromAsync_1_T1]):
            FromAsync_1_TaskFactory_1_TResult = (
                TaskFactory_1.FromAsync_MethodGroup.FromAsync_1_TaskFactory_1_TResult
            )
        ...
        def __getitem__(
            ...
            FromAsync_MethodGroup_TaskFactory_1_TResult, FromAsync_2_T1, FromAsync_2_T2
        ]: ...
        ...
        FromAsync_2_T2 = typing.TypeVar('FromAsync_2_T2')
        class FromAsync_2(
            typing.Generic[FromAsync_2_TaskFactory_1_TResult, FromAsync_2_T1, FromAsync_2_T2]
        ):
            FromAsync_2_TaskFactory_1_TResult = (
                TaskFactory_1.FromAsync_MethodGroup.FromAsync_2_TaskFactory_1_TResult
            )
        ...
        class FromAsync_3(
            typing.Generic[
                FromAsync_3_TaskFactory_1_TResult,
                FromAsync_3_T1,
                FromAsync_3_T2,
                FromAsync_3_T3,
            ]
            ...
            FromAsync_3_TaskFactory_1_TResult = (
                TaskFactory_1.FromAsync_MethodGroup.FromAsync_3_TaskFactory_1_TResult
            )
    ...
    StartNew_MethodGroup_TaskFactory_1_TResult = typing.TypeVar(
        'StartNew_MethodGroup_TaskFactory_1_TResult'
    )
    class StartNew_MethodGroup(typing.Generic[StartNew_MethodGroup_TaskFactory_1_TResult]):
        StartNew_MethodGroup_TaskFactory_1_TResult = (
            TaskFactory_1.StartNew_MethodGroup_TaskFactory_1_TResult
        )
        @typing.overload
        def __call__(
...
class ValueTask_0(IEquatable_1[ValueTask]):
    ...
    class FromCanceled_MethodGroup:
        ...
        class FromCanceled_1(typing.Generic[FromCanceled_1_T1]):
            ...
            def __call__(
                self, cancellationToken: CancellationToken
            ) -> ValueTask_1[FromCanceled_1_TResult]: ...
    ...
    class FromException_MethodGroup:
        ...
        class FromException_1(typing.Generic[FromException_1_T1]):
            ...
            ) -> ValueTask_1[FromException_1_TResult]: ...
    ...
    class FromResult_MethodGroup:
        ...
        class FromResult_1(typing.Generic[FromResult_1_T1]):
            ...
            def __call__(
                self, result: FromResult_1_TResult
            ) -> ValueTask_1[FromResult_1_TResult]: ...

ValueTask_1_TResult = typing.TypeVar('ValueTask_1_TResult')

class ValueTask_1(
    typing.Generic[ValueTask_1_TResult], IEquatable_1[ValueTask_1[ValueTask_1_TResult]]
):
    @typing.overload
    ...
    def GetHashCode(self) -> int: ...
    def __eq__(
        self, left: ValueTask_1[ValueTask_1_TResult], right: ValueTask_1[ValueTask_1_TResult]
    ) -> bool: ...
    def __ne__(
        self, left: ValueTask_1[ValueTask_1_TResult], right: ValueTask_1[ValueTask_1_TResult]
    ) -> bool: ...
    ...
    Equals_MethodGroup_ValueTask_1_TResult = typing.TypeVar(
        'Equals_MethodGroup_ValueTask_1_TResult'
    )
    class Equals_MethodGroup(typing.Generic[Equals_MethodGroup_ValueTask_1_TResult]):
        Equals_MethodGroup_ValueTask_1_TResult = (
            ValueTask_1.Equals_MethodGroup_ValueTask_1_TResult
        )
        @typing.overload
        def __call__(
            self, other: ValueTask_1[Equals_MethodGroup_ValueTask_1_TResult]
        ) -> bool: ...
        @typing.overload
        def __call__(self, obj: typing.Any) -> bool: ...
