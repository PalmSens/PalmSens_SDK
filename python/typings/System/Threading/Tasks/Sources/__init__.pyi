...
class IValueTaskSource_GenericClasses(abc.ABCMeta):
    ...
    def __getitem__(
        self,
        types: typing.Type[Generic_IValueTaskSource_GenericClasses_IValueTaskSource_1_TResult],
    ) -> typing.Type[
        IValueTaskSource_1[Generic_IValueTaskSource_GenericClasses_IValueTaskSource_1_TResult]
    ]: ...
...
ManualResetValueTaskSourceCore_1_TResult = typing.TypeVar(
    'ManualResetValueTaskSourceCore_1_TResult'
)

class ManualResetValueTaskSourceCore_1(
    typing.Generic[ManualResetValueTaskSourceCore_1_TResult]
):
    @property
