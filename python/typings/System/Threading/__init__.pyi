...
class AbandonedMutexException(SystemException):
    ...
    @typing.overload
    def __init__(
        self, message: str, inner: Exception, location: int, handle: WaitHandle
    ) -> None: ...
    @typing.overload
...
class AsyncLocal_1(typing.Generic[AsyncLocal_1_T]):
    ...
    @typing.overload
    def __init__(
        self, valueChangedHandler: Action_1[AsyncLocalValueChangedArgs_1[AsyncLocal_1_T]]
    ) -> None: ...
    @property
...
class CancellationToken(IEquatable_1[CancellationToken]):
    ...
    class Register_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, callback: Action_2[typing.Any, CancellationToken], state: typing.Any
        ) -> CancellationTokenRegistration: ...
        @typing.overload
        def __call__(
            self, callback: Action_1[typing.Any], state: typing.Any
        ) -> CancellationTokenRegistration: ...
        @typing.overload
        def __call__(
...
class CancellationTokenRegistration(
    IAsyncDisposable, IDisposable, IEquatable_1[CancellationTokenRegistration]
):
    @property
    ...
    def GetHashCode(self) -> int: ...
    def __eq__(
        self, left: CancellationTokenRegistration, right: CancellationTokenRegistration
    ) -> bool: ...
    def __ne__(
        self, left: CancellationTokenRegistration, right: CancellationTokenRegistration
    ) -> bool: ...
...
class CancellationTokenSource(IDisposable):
    ...
    class CreateLinkedTokenSource_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, token1: CancellationToken, token2: CancellationToken
...
class CompressedStack(ISerializable):
    ...
    @staticmethod
    def Run(
        compressedStack: CompressedStack, callback: ContextCallback, state: typing.Any
    ) -> None: ...
...
class ContextCallback(MulticastDelegate):
    ...
    def BeginInvoke(
        self, state: typing.Any, callback: AsyncCallback, object: typing.Any
    ) -> IAsyncResult: ...
...
class ExecutionContext(ISerializable, IDisposable):
    ...
    @staticmethod
    def Run(
        executionContext: ExecutionContext, callback: ContextCallback, state: typing.Any
    ) -> None: ...
    @staticmethod
...
class Interlocked(abc.ABC):
    ...
    class CompareExchange_MethodGroup:
        def __getitem__(
            self, t: typing.Type[CompareExchange_1_T1]
        ) -> CompareExchange_1[CompareExchange_1_T1]: ...
        ...
        class CompareExchange_1(typing.Generic[CompareExchange_1_T1]):
            ...
            def __call__(
                self,
                location1: clr.Reference[CompareExchange_1_T],
                value: CompareExchange_1_T,
                comparand: CompareExchange_1_T,
            ) -> CompareExchange_1_T: ...

        @typing.overload
        def __call__(
            self, location1: clr.Reference[float], value: float, comparand: float
        ) -> float: ...
        ...
        @typing.overload
        def __call__(
            self, location1: clr.Reference[UIntPtr], value: UIntPtr, comparand: UIntPtr
        ) -> UIntPtr: ...
        @typing.overload
        def __call__(
            self, location1: clr.Reference[typing.Any], value: typing.Any, comparand: typing.Any
        ) -> typing.Any: ...
    ...
    class Exchange_MethodGroup:
        ...
        class Exchange_1(typing.Generic[Exchange_1_T1]):
            ...
            def __call__(
                self, location1: clr.Reference[Exchange_1_T], value: Exchange_1_T
            ) -> Exchange_1_T: ...
        ...
        @typing.overload
        def __call__(
            self, location1: clr.Reference[typing.Any], value: typing.Any
        ) -> typing.Any: ...
...
class IOCompletionCallback(MulticastDelegate):
    ...
    def EndInvoke(self, result: IAsyncResult) -> None: ...
    def Invoke(
        self, errorCode: int, numBytes: int, pOVERLAP: clr.Reference[NativeOverlapped]
    ) -> None: ...
    ...
    class EnsureInitialized_MethodGroup:
        ...
        class EnsureInitialized_1(typing.Generic[EnsureInitialized_1_T1]):
            EnsureInitialized_1_T = (
                LazyInitializer.EnsureInitialized_MethodGroup.EnsureInitialized_1_T1
            )
            @typing.overload
            def __call__(
                self, target: clr.Reference[EnsureInitialized_1_T]
            ) -> EnsureInitialized_1_T: ...
            @typing.overload
            def __call__(
                self,
            ...
            def __call__(
                ...
                syncLock: clr.Reference[typing.Any],
            ) -> EnsureInitialized_1_T: ...
            @typing.overload
            def __call__(
                self,
...
class Monitor(abc.ABC):
    ...
    class TryEnter_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, obj: typing.Any, millisecondsTimeout: int, lockTaken: clr.Reference[bool]
        ) -> None: ...
        @typing.overload
        def __call__(
            self, obj: typing.Any, timeout: TimeSpan, lockTaken: clr.Reference[bool]
        ) -> None: ...
    ...
    class Wait_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, obj: typing.Any, millisecondsTimeout: int, exitContext: bool
        ) -> bool: ...
        @typing.overload
...
class Mutex(WaitHandle):
    ...
    @typing.overload
    def __init__(
        self, initiallyOwned: bool, name: str, createdNew: clr.Reference[bool]
    ) -> None: ...
    @property
    def Handle(self) -> int: ...
    @Handle.setter
...
class Overlapped:
    ...
    class Pack_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, iocb: IOCompletionCallback, userData: typing.Any
...
class ParameterizedThreadStart(MulticastDelegate):
    ...
    def Target(self) -> typing.Any: ...
    def BeginInvoke(
        self, obj: typing.Any, callback: AsyncCallback, object: typing.Any
    ) -> IAsyncResult: ...
    def EndInvoke(self, result: IAsyncResult) -> None: ...
...
class PeriodicTimer(IDisposable):
    ...
    def Dispose(self) -> None: ...
    def WaitForNextTickAsync(
        self, cancellationToken: CancellationToken = ...
    ) -> ValueTask_1[bool]: ...

class PreAllocatedOverlapped(IDisposable):
    def __init__(
        self, callback: IOCompletionCallback, state: typing.Any, pinData: typing.Any
    ) -> None: ...
    def Dispose(self) -> None: ...
    @staticmethod
    def UnsafeCreate(
        callback: IOCompletionCallback, state: typing.Any, pinData: typing.Any
...
class Semaphore(WaitHandle):
    ...
    @typing.overload
    def __init__(
        self, initialCount: int, maximumCount: int, name: str, createdNew: clr.Reference[bool]
    ) -> None: ...
    @property
    def Handle(self) -> int: ...
    @Handle.setter
...
class SpinLock:
    ...
    class TryEnter_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, millisecondsTimeout: int, lockTaken: clr.Reference[bool]
        ) -> None: ...
        @typing.overload
...
class SynchronizationContext:
    ...
    def Wait(
        self, waitHandles: Array_1[int], waitAll: bool, millisecondsTimeout: int
    ) -> int: ...
...
class ThreadPool(abc.ABC):
    ...
    def GetAvailableThreads(
        workerThreads: clr.Reference[int], completionPortThreads: clr.Reference[int]
    ) -> None: ...
    @staticmethod
    def GetMaxThreads(
        workerThreads: clr.Reference[int], completionPortThreads: clr.Reference[int]
    ...
    class QueueUserWorkItem_MethodGroup:
        ...
        class QueueUserWorkItem_1(typing.Generic[QueueUserWorkItem_1_T1]):
            QueueUserWorkItem_1_TState = (
                ThreadPool.QueueUserWorkItem_MethodGroup.QueueUserWorkItem_1_T1
            )
            def __call__(
                self,
                callBack: Action_1[QueueUserWorkItem_1_TState],
                state: QueueUserWorkItem_1_TState,
                preferLocal: bool,
            ) -> bool: ...
    ...
    class UnsafeQueueUserWorkItem_MethodGroup:
        ...
        class UnsafeQueueUserWorkItem_1(typing.Generic[UnsafeQueueUserWorkItem_1_T1]):
            ...
            def __call__(
                ...
                state: UnsafeQueueUserWorkItem_1_TState,
                preferLocal: bool,
            ) -> bool: ...
...
class ThreadPoolBoundHandle(IDisposable):
    ...
    class AllocateNativeOverlapped_MethodGroup:
        @typing.overload
        def __call__(
            self, preAllocated: PreAllocatedOverlapped
        ) -> clr.Reference[NativeOverlapped]: ...
        @typing.overload
        def __call__(
            self, callback: IOCompletionCallback, state: typing.Any, pinData: typing.Any
...
class Timer(MarshalByRefObject, ITimer):
    ...
    @typing.overload
    def __init__(
        self, callback: TimerCallback, state: typing.Any, dueTime: int, period: int
    ) -> None: ...
    @typing.overload
    def __init__(
        self, callback: TimerCallback, state: typing.Any, dueTime: TimeSpan, period: TimeSpan
    ) -> None: ...
    @classmethod
    @property
...
class Volatile(abc.ABC):
    ...
    class Write_MethodGroup:
        ...
        class Write_1(typing.Generic[Write_1_T1]):
            ...
            def __call__(
                self, location: clr.Reference[Write_1_T], value: Write_1_T
            ) -> None: ...
...
class WaitHandle(MarshalByRefObject, IDisposable):
    ...
    class WaitAll_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, waitHandles: Array_1[WaitHandle], millisecondsTimeout: int
        ) -> bool: ...
        @typing.overload
        def __call__(self, waitHandles: Array_1[WaitHandle], timeout: TimeSpan) -> bool: ...
        @typing.overload
        def __call__(
            self, waitHandles: Array_1[WaitHandle], millisecondsTimeout: int, exitContext: bool
        ) -> bool: ...
        @typing.overload
        def __call__(
            self, waitHandles: Array_1[WaitHandle], timeout: TimeSpan, exitContext: bool
        ) -> bool: ...
...
class WaitOrTimerCallback(MulticastDelegate):
    ...
    def Target(self) -> typing.Any: ...
    def BeginInvoke(
        self, state: typing.Any, timedOut: bool, callback: AsyncCallback, object: typing.Any
    ) -> IAsyncResult: ...
    def EndInvoke(self, result: IAsyncResult) -> None: ...
