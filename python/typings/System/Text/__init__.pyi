...
from System.Globalization import CultureInfo, UnicodeCategory
...
class Ascii(abc.ABC):
    ...
    class ToLowerInPlace_MethodGroup:
        @typing.overload
        def __call__(
            self, value: Span_1[int], bytesWritten: clr.Reference[int]
        ) -> OperationStatus: ...
        @typing.overload
        def __call__(
            self, value: Span_1[str], charsWritten: clr.Reference[int]
        ) -> OperationStatus: ...
...
class ASCIIEncoding(Encoding):
    ...
    def TryGetBytes(
        self, chars: ReadOnlySpan_1[str], bytes: Span_1[int], bytesWritten: clr.Reference[int]
    ) -> bool: ...
    def TryGetChars(
        self, bytes: ReadOnlySpan_1[int], chars: Span_1[str], charsWritten: clr.Reference[int]
    ) -> bool: ...
...
class Decoder(abc.ABC):
    ...
    class GetChars_MethodGroup:
        @typing.overload
        def __call__(
            self, bytes: ReadOnlySpan_1[int], chars: Span_1[str], flush: bool
        ) -> int: ...
        @typing.overload
        def __call__(
            self,
...
class Encoder(abc.ABC):
    ...
    class GetBytes_MethodGroup:
        @typing.overload
        def __call__(
            self, chars: ReadOnlySpan_1[str], bytes: Span_1[int], flush: bool
        ) -> int: ...
        @typing.overload
        def __call__(
            self,
...
class Encoding(ICloneable, abc.ABC):
    ...
    def CreateTranscodingStream(
        innerStream: Stream,
        innerStreamEncoding: Encoding,
        outerStreamEncoding: Encoding,
        leaveOpen: bool = ...,
    ) -> Stream: ...
    def Equals(self, value: typing.Any) -> bool: ...
    def GetDecoder(self) -> Decoder: ...
    ...
    class Convert_MethodGroup:
        @typing.overload
        def __call__(
            self, srcEncoding: Encoding, dstEncoding: Encoding, bytes: Array_1[int]
        ) -> Array_1[int]: ...
        @typing.overload
        def __call__(
            self,
    ...
    class GetBytes_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, s: str, charIndex: int, charCount: int, bytes: Array_1[int], byteIndex: int
        ) -> int: ...
...
class EncodingInfo:
    def __init__(
        self, provider: EncodingProvider, codePage: int, name: str, displayName: str
    ) -> None: ...
    @property
    def CodePage(self) -> int: ...
    @property
...
class Rune(
    ...
    def DecodeFromUtf16(
        source: ReadOnlySpan_1[str],
        result: clr.Reference[Rune],
        charsConsumed: clr.Reference[int],
    ) -> OperationStatus: ...
    @staticmethod
    def DecodeFromUtf8(
        source: ReadOnlySpan_1[int],
    ...
    class TryCreate_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, highSurrogate: str, lowSurrogate: str, result: clr.Reference[Rune]
        ) -> bool: ...
...
class StringBuilder(ISerializable):
    ...
    class AppendInterpolatedStringHandler:
        @typing.overload
        def __init__(
            self, literalLength: int, formattedCount: int, stringBuilder: StringBuilder
        ) -> None: ...
        @typing.overload
        def __init__(
            self,
    ...
    class Append_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, handler: clr.Reference[StringBuilder.AppendInterpolatedStringHandler]
        ) -> StringBuilder: ...
        @typing.overload
        ...
        @typing.overload
        def __call__(
            self, value: Array_1[str], startIndex: int, charCount: int
        ) -> StringBuilder: ...
        @typing.overload
        def __call__(self, value: str, startIndex: int, count: int) -> StringBuilder: ...
        @typing.overload
        def __call__(
            self, value: StringBuilder, startIndex: int, count: int
        ) -> StringBuilder: ...
    ...
    class AppendFormat_MethodGroup:
        @typing.overload
        def __getitem__(
            self, t: typing.Type[AppendFormat_1_T1]
        ) -> AppendFormat_1[AppendFormat_1_T1]: ...
        ...
        class AppendFormat_1(typing.Generic[AppendFormat_1_T1]):
            ...
            def __call__(
                ...
                arg0: AppendFormat_1_TArg0,
            ) -> StringBuilder: ...

        @typing.overload
        def __getitem__(
            self,
            t: typing.Tuple[typing.Type[AppendFormat_2_T1], typing.Type[AppendFormat_2_T2]],
        ...
        class AppendFormat_2(typing.Generic[AppendFormat_2_T1, AppendFormat_2_T2]):
            ...
            def __call__(
                ...
                provider: IFormatProvider,
                format: CompositeFormat,
                arg0: AppendFormat_2_TArg0,
                arg1: AppendFormat_2_TArg1,
            ) -> StringBuilder: ...
        ...
        def __getitem__(
            self,
            t: typing.Tuple[
                typing.Type[AppendFormat_3_T1],
                typing.Type[AppendFormat_3_T2],
                typing.Type[AppendFormat_3_T3],
            ],
        ...
        class AppendFormat_3(
            typing.Generic[AppendFormat_3_T1, AppendFormat_3_T2, AppendFormat_3_T3]
        ):
            ...
            def __call__(
                ...
                provider: IFormatProvider,
                format: CompositeFormat,
                arg0: AppendFormat_3_TArg0,
                arg1: AppendFormat_3_TArg1,
                arg2: AppendFormat_3_TArg2,
            ) -> StringBuilder: ...
        ...
        @typing.overload
        def __call__(
            self, format: str, arg0: typing.Any, arg1: typing.Any
        ) -> StringBuilder: ...
        @typing.overload
        def __call__(
            self, provider: IFormatProvider, format: str, args: Array_1[typing.Any]
        ) -> StringBuilder: ...
        @typing.overload
        def __call__(
            self, provider: IFormatProvider, format: str, arg0: typing.Any
        ) -> StringBuilder: ...
        @typing.overload
        def __call__(
            self, provider: IFormatProvider, format: CompositeFormat, args: Array_1[typing.Any]
        ) -> StringBuilder: ...
        @typing.overload
        def __call__(
            self,
            provider: IFormatProvider,
            format: CompositeFormat,
            args: ReadOnlySpan_1[typing.Any],
        ) -> StringBuilder: ...
        @typing.overload
        def __call__(
            self, format: str, arg0: typing.Any, arg1: typing.Any, arg2: typing.Any
        ) -> StringBuilder: ...
        @typing.overload
        def __call__(
            self, provider: IFormatProvider, format: str, arg0: typing.Any, arg1: typing.Any
        ) -> StringBuilder: ...
        @typing.overload
        def __call__(
            self,
    ...
    class AppendJoin_MethodGroup:
        def __getitem__(
            self, t: typing.Type[AppendJoin_1_T1]
        ) -> AppendJoin_1[AppendJoin_1_T1]: ...
        ...
        class AppendJoin_1(typing.Generic[AppendJoin_1_T1]):
            ...
            def __call__(
                self, separator: str, values: IEnumerable_1[AppendJoin_1_T]
            ) -> StringBuilder: ...
    ...
    class CopyTo_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, sourceIndex: int, destination: Array_1[str], destinationIndex: int, count: int
        ) -> None: ...
    ...
    class Insert_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, index: int, value: Array_1[str], startIndex: int, charCount: int
        ) -> StringBuilder: ...
    ...
    class Replace_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, oldChar: str, newChar: str, startIndex: int, count: int
        ) -> StringBuilder: ...
...
class UnicodeEncoding(Encoding):
    ...
    @typing.overload
    def __init__(
        self, bigEndian: bool, byteOrderMark: bool, throwOnInvalidBytes: bool
    ) -> None: ...
    CharSize: int
    @property
    def BodyName(self) -> str: ...
...
class UTF8Encoding(Encoding):
    ...
    @typing.overload
    def __init__(
        self, encoderShouldEmitUTF8Identifier: bool, throwOnInvalidBytes: bool
    ) -> None: ...
    @property
    def BodyName(self) -> str: ...
    @property
