...
class XPathExpression(abc.ABC):
    ...
    class Compile_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, xpath: str, nsResolver: IXmlNamespaceResolver
        ) -> XPathExpression: ...
...
class XPathItem(abc.ABC):
    ...
    class ValueAs_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, returnType: typing.Type[typing.Any], nsResolver: IXmlNamespaceResolver
        ) -> typing.Any: ...
...
class XPathNavigator(XPathItem, IXmlNamespaceResolver, IXPathNavigable, ICloneable):
    ...
    def AppendChildElement(
        self, prefix: str, localName: str, namespaceURI: str, value: str
    ) -> None: ...
    def CheckValidity(
        self, schemas: XmlSchemaSet, validationEventHandler: ValidationEventHandler
    ) -> bool: ...
    @abc.abstractmethod
    ...
    class Select_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, xpath: str, resolver: IXmlNamespaceResolver
        ) -> XPathNodeIterator: ...
    ...
    class SelectAncestors_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, name: str, namespaceURI: str, matchSelf: bool
        ) -> XPathNodeIterator: ...
