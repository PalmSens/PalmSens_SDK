...
from System.Collections.Generic import IComparer_1, IEnumerable_1, IEqualityComparer_1
...
class XDocument(XContainer):
    ...
    class LoadAsync_MethodGroup:
        @typing.overload
        def __call__(
            self, stream: Stream, options: LoadOptions, cancellationToken: CancellationToken
        ) -> Task_1[XDocument]: ...
        @typing.overload
        def __call__(
            self,
        ...
        @typing.overload
        def __call__(
            self, reader: XmlReader, options: LoadOptions, cancellationToken: CancellationToken
        ) -> Task_1[XDocument]: ...
    ...
    class SaveAsync_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, stream: Stream, options: SaveOptions, cancellationToken: CancellationToken
        ) -> Task: ...
        @typing.overload
        def __call__(
            self,
...
class XNode(XObject):
    ...
    @staticmethod
    def ReadFromAsync(
        reader: XmlReader, cancellationToken: CancellationToken
    ) -> Task_1[XNode]: ...
    def Remove(self) -> None: ...
    @abc.abstractmethod
    def WriteTo(self, writer: XmlWriter) -> None: ...
...
class XObject(IXmlLineInfo, abc.ABC):
    ...
    class Annotation_MethodGroup:
        def __getitem__(
            self, t: typing.Type[Annotation_1_T1]
        ) -> Annotation_1[Annotation_1_T1]: ...
    ...
    class Annotations_MethodGroup:
        def __getitem__(
            self, t: typing.Type[Annotations_1_T1]
        ) -> Annotations_1[Annotations_1_T1]: ...
    ...
    class RemoveAnnotations_MethodGroup:
        def __getitem__(
            self, t: typing.Type[RemoveAnnotations_1_T1]
        ) -> RemoveAnnotations_1[RemoveAnnotations_1_T1]: ...
