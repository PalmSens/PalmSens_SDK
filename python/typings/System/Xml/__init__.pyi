...
class XmlDocument(XmlNode):
    ...
    def CreateXmlDeclaration(
        self, version: str, encoding: str, standalone: str
    ) -> XmlDeclaration: ...
    ...
    class CreateNode_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, type: XmlNodeType, prefix: str, name: str, namespaceURI: str
        ) -> XmlNode: ...
...
class XmlParserContext:
    ...
    @typing.overload
    def __init__(
        self, nt: XmlNameTable, nsMgr: XmlNamespaceManager, xmlLang: str, xmlSpace: XmlSpace
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class XmlReader(IDisposable, abc.ABC):
    ...
    def ReadContentAsBase64Async(
        self, buffer: Array_1[int], index: int, count: int
    ) -> Task_1[int]: ...
    ...
    def ReadElementContentAsBase64(
        self, buffer: Array_1[int], index: int, count: int
    ) -> int: ...
    def ReadElementContentAsBase64Async(
        self, buffer: Array_1[int], index: int, count: int
    ) -> Task_1[int]: ...
    def ReadElementContentAsBinHex(
        self, buffer: Array_1[int], index: int, count: int
    ) -> int: ...
    ...
    def ReadValueChunkAsync(
        self, buffer: Array_1[str], index: int, count: int
    ) -> Task_1[int]: ...
    @abc.abstractmethod
    ...
    class Create_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, input: Stream, settings: XmlReaderSettings, baseUri: str
        ) -> XmlReader: ...
        @typing.overload
        def __call__(
            self, input: TextReader, settings: XmlReaderSettings, baseUri: str
        ) -> XmlReader: ...
        @typing.overload
        def __call__(
            self, inputUri: str, settings: XmlReaderSettings, inputContext: XmlParserContext
        ) -> XmlReader: ...
        @typing.overload
        def __call__(
            self, input: Stream, settings: XmlReaderSettings, inputContext: XmlParserContext
        ) -> XmlReader: ...
        @typing.overload
        def __call__(
            self, input: TextReader, settings: XmlReaderSettings, inputContext: XmlParserContext
        ) -> XmlReader: ...
...
class XmlResolver(abc.ABC):
    ...
    @abc.abstractmethod
    def GetEntity(
        self, absoluteUri: Uri, role: str, ofObjectToReturn: typing.Type[typing.Any]
    ) -> typing.Any: ...
    def GetEntityAsync(
        self, absoluteUri: Uri, role: str, ofObjectToReturn: typing.Type[typing.Any]
    ) -> Task_1[typing.Any]: ...
...
class XmlWriter(IAsyncDisposable, IDisposable, abc.ABC):
    ...
    def WriteAttributeStringAsync(
        self, prefix: str, localName: str, ns: str, value: str
    ) -> Task: ...
    @abc.abstractmethod
