...
import clr
from System import Array, Array_1, ICloneable
...
class ArrayList(IList, ICloneable):
    ...
    class BinarySearch_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, index: int, count: int, value: typing.Any, comparer: IComparer
        ) -> int: ...
...
class DictionaryEntry:
    ...
    def Deconstruct(
        self, key: clr.Reference[typing.Any], value: clr.Reference[typing.Any]
    ) -> None: ...
