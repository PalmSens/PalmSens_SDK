...
from System.Collections import IComparer, IDictionary, IDictionaryEnumerator, ICollection, IEqualityComparer, IEnumerable, IEnumerator, IList
...
class Dictionary_2(typing.Generic[Dictionary_2_TKey, Dictionary_2_TValue], IReadOnlyDictionary_2[Dictionary_2_TKey, Dictionary_2_TValue], IDictionary_2[Dictionary_2_TKey, Dictionary_2_TValue], IDictionary, IDeserializationCallback, ISerializable):
    @typing.overload
    def __init__(self) -> None: ...
    @typing.overload
...
class EqualityComparer_1(typing.Generic[EqualityComparer_1_T], IEqualityComparer_1[EqualityComparer_1_T], IEqualityComparer, abc.ABC):
    @classmethod
    @property
