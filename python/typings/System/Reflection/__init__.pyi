...
class Assembly(ISerializable, ICustomAttributeProvider, abc.ABC):
    ...
    class CreateInstance_MethodGroup:
        ...
        def __call__(
            ...
            culture: CultureInfo,
            activationAttributes: Array_1[typing.Any],
        ) -> typing.Any: ...
    ...
    class GetType_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, name: str, throwOnError: bool, ignoreCase: bool
    ...
    class Load_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, rawAssembly: Array_1[int], rawSymbolStore: Array_1[int]
        ) -> Assembly: ...
    ...
    class LoadModule_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, moduleName: str, rawModule: Array_1[int], rawSymbolStore: Array_1[int]
        ) -> Module: ...
...
class AssemblyName(ISerializable, IDeserializationCallback, ICloneable):
    ...
    def VersionCompatibility(
        self, value: AssemblyVersionCompatibility
    ...
    def ReferenceMatchesDefinition(
        reference: AssemblyName, definition: AssemblyName
    ) -> bool: ...
...
class Binder(abc.ABC):
    ...
    def BindToMethod(
        self,
        bindingAttr: BindingFlags,
        match: Array_1[MethodBase],
        args: clr.Reference[Array_1[typing.Any]],
        modifiers: Array_1[ParameterModifier],
        culture: CultureInfo,
        names: Array_1[str],
        state: clr.Reference[typing.Any],
    ) -> MethodBase: ...
    @abc.abstractmethod
    def ChangeType(
        self, value: typing.Any, type: typing.Type[typing.Any], culture: CultureInfo
    ) -> typing.Any: ...
    @abc.abstractmethod
    def ReorderArgumentArray(
        self, args: clr.Reference[Array_1[typing.Any]], state: typing.Any
    ) -> None: ...
    @abc.abstractmethod
    def SelectMethod(
        self,
        bindingAttr: BindingFlags,
        match: Array_1[MethodBase],
        types: Array_1[typing.Type[typing.Any]],
        modifiers: Array_1[ParameterModifier],
    ) -> MethodBase: ...
    @abc.abstractmethod
    def SelectProperty(
        self,
        bindingAttr: BindingFlags,
        match: Array_1[PropertyInfo],
        returnType: typing.Type[typing.Any],
        indexes: Array_1[typing.Type[typing.Any]],
        modifiers: Array_1[ParameterModifier],
    ) -> PropertyInfo: ...
...
class ConstructorInvoker:
    ...
    class Invoke_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, arg1: typing.Any, arg2: typing.Any, arg3: typing.Any
        ) -> typing.Any: ...
        @typing.overload
        def __call__(
            self, arg1: typing.Any, arg2: typing.Any, arg3: typing.Any, arg4: typing.Any
        ) -> typing.Any: ...
...
class CustomAttributeExtensions(abc.ABC):
    ...
    class GetCustomAttribute_MethodGroup:
        def __getitem__(
            self, t: typing.Type[GetCustomAttribute_1_T1]
        ) -> GetCustomAttribute_1[GetCustomAttribute_1_T1]: ...
        ...
        class GetCustomAttribute_1(typing.Generic[GetCustomAttribute_1_T1]):
            GetCustomAttribute_1_T = (
                CustomAttributeExtensions.GetCustomAttribute_MethodGroup.GetCustomAttribute_1_T1
            )
            @typing.overload
            ...
            @typing.overload
            def __call__(
                self, element: MemberInfo, inherit: bool
            ) -> GetCustomAttribute_1_T: ...
            @typing.overload
            def __call__(
                self, element: ParameterInfo, inherit: bool
            ) -> GetCustomAttribute_1_T: ...

        @typing.overload
        def __call__(
            self, element: Assembly, attributeType: typing.Type[typing.Any]
        ) -> Attribute: ...
        @typing.overload
        def __call__(
            self, element: Module, attributeType: typing.Type[typing.Any]
        ) -> Attribute: ...
        @typing.overload
        def __call__(
            self, element: MemberInfo, attributeType: typing.Type[typing.Any]
        ) -> Attribute: ...
        @typing.overload
        def __call__(
            self, element: ParameterInfo, attributeType: typing.Type[typing.Any]
        ) -> Attribute: ...
        @typing.overload
        def __call__(
            self, element: MemberInfo, attributeType: typing.Type[typing.Any], inherit: bool
        ) -> Attribute: ...
        @typing.overload
        def __call__(
            self, element: ParameterInfo, attributeType: typing.Type[typing.Any], inherit: bool
        ) -> Attribute: ...
    ...
    class GetCustomAttributes_MethodGroup:
        def __getitem__(
            self, t: typing.Type[GetCustomAttributes_1_T1]
        ) -> GetCustomAttributes_1[GetCustomAttributes_1_T1]: ...
        ...
        class GetCustomAttributes_1(typing.Generic[GetCustomAttributes_1_T1]):
            ...
            @typing.overload
            def __call__(
                self, element: MemberInfo
            ) -> IEnumerable_1[GetCustomAttributes_1_T]: ...
            @typing.overload
            def __call__(
                self, element: ParameterInfo
            ) -> IEnumerable_1[GetCustomAttributes_1_T]: ...
            @typing.overload
            def __call__(
                self, element: MemberInfo, inherit: bool
...
class CustomAttributeNamedArgument(IEquatable_1[CustomAttributeNamedArgument]):
    @typing.overload
    def __init__(
        self, memberInfo: MemberInfo, typedArgument: CustomAttributeTypedArgument
    ) -> None: ...
    @typing.overload
    ...
    def GetHashCode(self) -> int: ...
    def __eq__(
        self, left: CustomAttributeNamedArgument, right: CustomAttributeNamedArgument
    ) -> bool: ...
    def __ne__(
        self, left: CustomAttributeNamedArgument, right: CustomAttributeNamedArgument
    ) -> bool: ...
...
class CustomAttributeTypedArgument(IEquatable_1[CustomAttributeTypedArgument]):
    ...
    def GetHashCode(self) -> int: ...
    def __eq__(
        self, left: CustomAttributeTypedArgument, right: CustomAttributeTypedArgument
    ) -> bool: ...
    def __ne__(
        self, left: CustomAttributeTypedArgument, right: CustomAttributeTypedArgument
    ) -> bool: ...
...
class FieldInfo(MemberInfo):
    ...
    class GetFieldFromHandle_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, handle: RuntimeFieldHandle, declaringType: RuntimeTypeHandle
        ) -> FieldInfo: ...
...
class MethodBase(MemberInfo):
    ...
    class GetMethodFromHandle_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, handle: RuntimeMethodHandle, declaringType: RuntimeTypeHandle
        ) -> MethodBase: ...
...
class MethodInfo(MethodBase):
    ...
    class CreateDelegate_MethodGroup:
        def __getitem__(
            self, t: typing.Type[CreateDelegate_1_T1]
        ) -> CreateDelegate_1[CreateDelegate_1_T1]: ...
...
class MethodInvoker:
    ...
    class Invoke_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, obj: typing.Any, arg1: typing.Any, arg2: typing.Any
        ) -> typing.Any: ...
        @typing.overload
        def __call__(
            self, obj: typing.Any, arg1: typing.Any, arg2: typing.Any, arg3: typing.Any
        ) -> typing.Any: ...
        @typing.overload
        def __call__(
            self,
...
class Module(ISerializable, ICustomAttributeProvider, abc.ABC):
    ...
    def Equals(self, o: typing.Any) -> bool: ...
    def FindTypes(
        self, filter: TypeFilter, filterCriteria: typing.Any
    ) -> Array_1[typing.Type[typing.Any]]: ...
    def GetCustomAttributesData(self) -> IList_1[CustomAttributeData]: ...
    def GetHashCode(self) -> int: ...
    def GetObjectData(self, info: SerializationInfo, context: StreamingContext) -> None: ...
    def GetPEKind(
        self,
        peKind: clr.Reference[PortableExecutableKinds],
        machine: clr.Reference[ImageFileMachine],
    ) -> None: ...
    def GetTypes(self) -> Array_1[typing.Type[typing.Any]]: ...
    def IsDefined(self, attributeType: typing.Type[typing.Any], inherit: bool) -> bool: ...
    ...
    class GetMethod_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, name: str, types: Array_1[typing.Type[typing.Any]]
        ) -> MethodInfo: ...
        @typing.overload
        def __call__(
            self,
    ...
    class GetType_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, className: str, throwOnError: bool, ignoreCase: bool
        ) -> typing.Type[typing.Any]: ...
    ...
    class ResolveField_MethodGroup:
        ...
        def __call__(
            self,
            metadataToken: int,
            genericTypeArguments: Array_1[typing.Type[typing.Any]],
            genericMethodArguments: Array_1[typing.Type[typing.Any]],
        ) -> FieldInfo: ...
...
class PropertyInfo(MemberInfo):
    ...
    class SetValue_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, obj: typing.Any, value: typing.Any, index: Array_1[typing.Any]
        ) -> None: ...
        @typing.overload
        def __call__(
            self,
...
class ReflectionTypeLoadException(SystemException):
    @typing.overload
    def __init__(
        self, classes: Array_1[typing.Type[typing.Any]], exceptions: Array_1[Exception]
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        classes: Array_1[typing.Type[typing.Any]],
        exceptions: Array_1[Exception],
        message: str,
    ) -> None: ...
    @property
    def Data(self) -> IDictionary: ...
...
class RuntimeReflectionExtensions(abc.ABC):
    ...
    @staticmethod
    def GetRuntimeInterfaceMap(
        typeInfo: TypeInfo, interfaceType: typing.Type[typing.Any]
    ) -> InterfaceMapping: ...
    @staticmethod
    def GetRuntimeMethod(
        type: typing.Type[typing.Any], name: str, parameters: Array_1[typing.Type[typing.Any]]
    ) -> MethodInfo: ...
    @staticmethod
