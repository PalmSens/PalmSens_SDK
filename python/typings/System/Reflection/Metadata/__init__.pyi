...
class AssemblyExtensions(abc.ABC):
    @staticmethod
    def TryGetRawMetadata(
        assembly: Assembly, blob: clr.Reference[clr.Reference[int]], length: clr.Reference[int]
    ) -> bool: ...
...
class MetadataUpdater(abc.ABC):
    ...
    def ApplyUpdate(
        assembly: Assembly,
        metadataDelta: ReadOnlySpan_1[int],
        ilDelta: ReadOnlySpan_1[int],
        pdbDelta: ReadOnlySpan_1[int],
    ) -> None: ...
