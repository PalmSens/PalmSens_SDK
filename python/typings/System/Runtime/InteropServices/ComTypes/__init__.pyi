...
class IConnectionPoint(typing.Protocol):
    ...
    def GetConnectionPointContainer(
        self, ppCPC: clr.Reference[IConnectionPointContainer]
    ) -> None: ...
    @abc.abstractmethod
...
class IConnectionPointContainer(typing.Protocol):
    ...
    def FindConnectionPoint(
        self, riid: clr.Reference[Guid], ppCP: clr.Reference[IConnectionPoint]
    ) -> None: ...
...
class IMoniker(typing.Protocol):
    ...
    def BindToObject(
        ...
        pbc: IBindCtx,
        pmkToLeft: IMoniker,
        riidResult: clr.Reference[Guid],
        ppvResult: clr.Reference[typing.Any],
    ) -> None: ...
    @abc.abstractmethod
    def BindToStorage(
        self,
        pbc: IBindCtx,
        pmkToLeft: IMoniker,
        riid: clr.Reference[Guid],
        ppvObj: clr.Reference[typing.Any],
    ) -> None: ...
    @abc.abstractmethod
    def CommonPrefixWith(
        self, pmkOther: IMoniker, ppmkPrefix: clr.Reference[IMoniker]
    ) -> None: ...
    @abc.abstractmethod
    def ComposeWith(
        self,
        ...
        ppmkComposite: clr.Reference[IMoniker],
    ) -> None: ...
    @abc.abstractmethod
    ...
    @abc.abstractmethod
    def GetDisplayName(
        self, pbc: IBindCtx, pmkToLeft: IMoniker, ppszDisplayName: clr.Reference[str]
    ) -> None: ...
    @abc.abstractmethod
    def GetSizeMax(self, pcbSize: clr.Reference[int]) -> None: ...
    @abc.abstractmethod
    def GetTimeOfLastChange(
        self, pbc: IBindCtx, pmkToLeft: IMoniker, pFileTime: clr.Reference[FILETIME]
    ) -> None: ...
    @abc.abstractmethod
    ...
    def ParseDisplayName(
        ...
        pmkToLeft: IMoniker,
        pszDisplayName: str,
        pchEaten: clr.Reference[int],
        ppmkOut: clr.Reference[IMoniker],
    ) -> None: ...
    @abc.abstractmethod
    def Reduce(
        self,
        pbc: IBindCtx,
        dwReduceHowFar: int,
        ppmkToLeft: clr.Reference[IMoniker],
        ppmkReduced: clr.Reference[IMoniker],
    ) -> None: ...
    @abc.abstractmethod
    def RelativePathTo(
        self, pmkOther: IMoniker, ppmkRelPath: clr.Reference[IMoniker]
    ) -> None: ...
    @abc.abstractmethod
...
class IRunningObjectTable(typing.Protocol):
    ...
    @abc.abstractmethod
    def GetObject(
        self, pmkObjectName: IMoniker, ppunkObject: clr.Reference[typing.Any]
    ) -> int: ...
    @abc.abstractmethod
    def GetTimeOfLastChange(
        self, pmkObjectName: IMoniker, pfiletime: clr.Reference[FILETIME]
    ) -> int: ...
    @abc.abstractmethod
    ...
    @abc.abstractmethod
    def Register(
        self, grfFlags: int, punkObject: typing.Any, pmkObjectName: IMoniker
    ) -> int: ...
    @abc.abstractmethod
...
class ITypeComp(typing.Protocol):
    ...
    def Bind(
        ...
        lHashVal: int,
        wFlags: int,
        ppTInfo: clr.Reference[ITypeInfo],
        pDescKind: clr.Reference[DESCKIND],
        pBindPtr: clr.Reference[BINDPTR],
    ) -> None: ...
    @abc.abstractmethod
    def BindType(
        self,
        ...
        lHashVal: int,
        ppTInfo: clr.Reference[ITypeInfo],
        ppTComp: clr.Reference[ITypeComp],
    ) -> None: ...

class ITypeInfo(typing.Protocol):
    @abc.abstractmethod
    def AddressOfMember(
        self, memid: int, invKind: INVOKEKIND, ppv: clr.Reference[int]
    ) -> None: ...
    @abc.abstractmethod
    def CreateInstance(
        self,
        pUnkOuter: typing.Any,
        riid: clr.Reference[Guid],
        ppvObj: clr.Reference[typing.Any],
    ) -> None: ...
    @abc.abstractmethod
    def GetContainingTypeLib(
        self, ppTLB: clr.Reference[ITypeLib], pIndex: clr.Reference[int]
    ) -> None: ...
    @abc.abstractmethod
    def GetDllEntry(
        self, memid: int, invKind: INVOKEKIND, pBstrDllName: int, pBstrName: int, pwOrdinal: int
    ) -> None: ...
    @abc.abstractmethod
    def GetDocumentation(
        self,
        index: int,
        strName: clr.Reference[str],
        strDocString: clr.Reference[str],
        dwHelpContext: clr.Reference[int],
        strHelpFile: clr.Reference[str],
    ) -> None: ...
    @abc.abstractmethod
    def GetFuncDesc(self, index: int, ppFuncDesc: clr.Reference[int]) -> None: ...
    @abc.abstractmethod
    def GetIDsOfNames(
        self, rgszNames: Array_1[str], cNames: int, pMemId: Array_1[int]
    ) -> None: ...
    @abc.abstractmethod
    def GetImplTypeFlags(
        self, index: int, pImplTypeFlags: clr.Reference[IMPLTYPEFLAGS]
    ) -> None: ...
    @abc.abstractmethod
    def GetMops(self, memid: int, pBstrMops: clr.Reference[str]) -> None: ...
    @abc.abstractmethod
    def GetNames(
        self, memid: int, rgBstrNames: Array_1[str], cMaxNames: int, pcNames: clr.Reference[int]
    ) -> None: ...
    @abc.abstractmethod
    ...
    def Invoke(
        self,
        pvInstance: typing.Any,
        memid: int,
        wFlags: int,
        pDispParams: clr.Reference[DISPPARAMS],
        pVarResult: int,
        pExcepInfo: int,
        puArgErr: clr.Reference[int],
    ) -> None: ...
    @abc.abstractmethod
...
class ITypeInfo2(ITypeInfo, typing.Protocol):
    ...
    @abc.abstractmethod
    def GetCustData(
        self, guid: clr.Reference[Guid], pVarVal: clr.Reference[typing.Any]
    ) -> None: ...
    @abc.abstractmethod
    def GetDllEntry(
        self, memid: int, invKind: INVOKEKIND, pBstrDllName: int, pBstrName: int, pwOrdinal: int
    ...
    def GetDocumentation2(
        self,
        memid: int,
        pbstrHelpString: clr.Reference[str],
        pdwHelpStringContext: clr.Reference[int],
        pbstrHelpStringDll: clr.Reference[str],
    ) -> None: ...
    @abc.abstractmethod
    def GetFuncCustData(
        self, index: int, guid: clr.Reference[Guid], pVarVal: clr.Reference[typing.Any]
    ) -> None: ...
    @abc.abstractmethod
    def GetFuncDesc(self, index: int, ppFuncDesc: clr.Reference[int]) -> None: ...
    @abc.abstractmethod
    def GetFuncIndexOfMemId(
        self, memid: int, invKind: INVOKEKIND, pFuncIndex: clr.Reference[int]
    ) -> None: ...
    @abc.abstractmethod
    def GetIDsOfNames(
        self, rgszNames: Array_1[str], cNames: int, pMemId: Array_1[int]
    ...
    def GetParamCustData(
        ...
        indexFunc: int,
        indexParam: int,
        guid: clr.Reference[Guid],
        pVarVal: clr.Reference[typing.Any],
    ) -> None: ...
    @abc.abstractmethod
    def GetRefTypeInfo(self, hRef: int, ppTI: clr.Reference[ITypeInfo]) -> None: ...
    @abc.abstractmethod
...
class ITypeLib(typing.Protocol):
    ...
    def FindName(
        ...
        szNameBuf: str,
        lHashVal: int,
        ppTInfo: Array_1[ITypeInfo],
        rgMemId: Array_1[int],
        pcFound: clr.Reference[int],
    ) -> None: ...
    @abc.abstractmethod
    def GetDocumentation(
        self,
    ...
    def GetTypeInfoOfGuid(
        self, guid: clr.Reference[Guid], ppTInfo: clr.Reference[ITypeInfo]
    ) -> None: ...
    @abc.abstractmethod
...
class ITypeLib2(ITypeLib, typing.Protocol):
    ...
    def GetLibStatistics(
        self, pcUniqueNames: int, pcchUniqueNames: clr.Reference[int]
    ) -> None: ...
    @abc.abstractmethod
    def GetTypeComp(self, ppTComp: clr.Reference[ITypeComp]) -> None: ...
    @abc.abstractmethod
