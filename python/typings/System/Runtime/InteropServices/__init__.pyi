...
from System.Reflection import Assembly, MethodBase, MethodInfo, Module
...
class CollectionsMarshal(abc.ABC):
    ...
    class GetValueRefOrAddDefault_MethodGroup:
        def __getitem__(
            self,
            t: typing.Tuple[
                typing.Type[GetValueRefOrAddDefault_2_T1],
                typing.Type[GetValueRefOrAddDefault_2_T2],
            ],
        ) -> GetValueRefOrAddDefault_2[
            GetValueRefOrAddDefault_2_T1, GetValueRefOrAddDefault_2_T2
        ]: ...
        ...
        class GetValueRefOrAddDefault_2(
            typing.Generic[GetValueRefOrAddDefault_2_T1, GetValueRefOrAddDefault_2_T2]
        ):
            ...
            def __call__(
                ...
                dictionary: Dictionary_2[
                    GetValueRefOrAddDefault_2_TKey, GetValueRefOrAddDefault_2_TValue
                ],
    ...
    class GetValueRefOrNullRef_MethodGroup:
        def __getitem__(
            self,
            t: typing.Tuple[
                typing.Type[GetValueRefOrNullRef_2_T1], typing.Type[GetValueRefOrNullRef_2_T2]
            ],
        ...
        class GetValueRefOrNullRef_2(
            typing.Generic[GetValueRefOrNullRef_2_T1, GetValueRefOrNullRef_2_T2]
        ):
            GetValueRefOrNullRef_2_TKey = (
                CollectionsMarshal.GetValueRefOrNullRef_MethodGroup.GetValueRefOrNullRef_2_T1
            )
            ...
            def __call__(
                self,
                dictionary: Dictionary_2[
                    GetValueRefOrNullRef_2_TKey, GetValueRefOrNullRef_2_TValue
                ],
...
class ComEventInterfaceAttribute(Attribute):
    def __init__(
        self, SourceInterface: typing.Type[typing.Any], EventProvider: typing.Type[typing.Any]
    ) -> None: ...
    @property
...
class ComWrappers(abc.ABC):
    class ComInterfaceDispatch:
        ...
        class GetInstance_MethodGroup:
            def __getitem__(
                self, t: typing.Type[GetInstance_1_T1]
            ) -> GetInstance_1[GetInstance_1_T1]: ...

            GetInstance_1_T1 = typing.TypeVar('GetInstance_1_T1')
            class GetInstance_1(typing.Generic[GetInstance_1_T1]):
                GetInstance_1_T = (
                    ComWrappers.ComInterfaceDispatch.GetInstance_MethodGroup.GetInstance_1_T1
                )
                def __call__(
                    self, dispatchPtr: clr.Reference[ComWrappers.ComInterfaceDispatch]
                ) -> GetInstance_1_T: ...
    ...
    @staticmethod
    def GetIUnknownImpl(
        fpQueryInterface: clr.Reference[int],
        fpAddRef: clr.Reference[int],
        fpRelease: clr.Reference[int],
    ) -> None: ...
    def GetOrCreateComInterfaceForObject(
        self, instance: typing.Any, flags: CreateComInterfaceFlags
    ) -> int: ...
    def GetOrCreateObjectForComInstance(
        self, externalComObject: int, flags: CreateObjectFlags
    ) -> typing.Any: ...
    @staticmethod
    ...
    class GetOrRegisterObjectForComInstance_MethodGroup:
        @typing.overload
        def __call__(
            self, externalComObject: int, flags: CreateObjectFlags, wrapper: typing.Any
        ) -> typing.Any: ...
        @typing.overload
        def __call__(
            self,
            externalComObject: int,
...
class DllImportResolver(MulticastDelegate):
    ...
    def BeginInvoke(
        ...
        libraryName: str,
        assembly: Assembly,
        searchPath: typing.Optional[DllImportSearchPath],
...
class ICustomQueryInterface(typing.Protocol):
    @abc.abstractmethod
    def GetInterface(
        self, iid: clr.Reference[Guid], ppv: clr.Reference[int]
    ) -> CustomQueryInterfaceResult: ...

class IDynamicInterfaceCastable(typing.Protocol):
    @abc.abstractmethod
    def GetInterfaceImplementation(
        self, interfaceType: RuntimeTypeHandle
    ) -> RuntimeTypeHandle: ...
    @abc.abstractmethod
    def IsInterfaceImplemented(
        self, interfaceType: RuntimeTypeHandle, throwIfNotImplemented: bool
    ) -> bool: ...
...
class LibraryImportAttribute(Attribute):
    ...
    def StringMarshallingCustomType(
        self, value: typing.Type[typing.Any]
...
class Marshal(abc.ABC):
    ...
    class Copy_MethodGroup:
        @typing.overload
        def __call__(
            self, source: int, destination: Array_1[float], startIndex: int, length: int
        ) -> None: ...
        ...
        @typing.overload
        def __call__(
            self, source: int, destination: Array_1[str], startIndex: int, length: int
        ) -> None: ...
        ...
        @typing.overload
        def __call__(
            self, source: Array_1[float], startIndex: int, destination: int, length: int
        ) -> None: ...
        ...
        @typing.overload
        def __call__(
            self, source: Array_1[str], startIndex: int, destination: int, length: int
        ) -> None: ...
    ...
    class CreateAggregatedObject_MethodGroup:
        ...
        class CreateAggregatedObject_1(typing.Generic[CreateAggregatedObject_1_T1]):
            CreateAggregatedObject_1_T = (
                Marshal.CreateAggregatedObject_MethodGroup.CreateAggregatedObject_1_T1
            )
    ...
    class CreateWrapperOfType_MethodGroup:
        def __getitem__(
            self,
            t: typing.Tuple[
                typing.Type[CreateWrapperOfType_2_T1], typing.Type[CreateWrapperOfType_2_T2]
            ],
        ...
        class CreateWrapperOfType_2(
            typing.Generic[CreateWrapperOfType_2_T1, CreateWrapperOfType_2_T2]
        ):
            CreateWrapperOfType_2_T = (
                Marshal.CreateWrapperOfType_MethodGroup.CreateWrapperOfType_2_T1
            )
            CreateWrapperOfType_2_TWrapper = (
                Marshal.CreateWrapperOfType_MethodGroup.CreateWrapperOfType_2_T2
            )
            def __call__(
                self, o: CreateWrapperOfType_2_T
            ) -> CreateWrapperOfType_2_TWrapper: ...
    ...
    class DestroyStructure_MethodGroup:
        def __getitem__(
            self, t: typing.Type[DestroyStructure_1_T1]
        ) -> DestroyStructure_1[DestroyStructure_1_T1]: ...
    ...
    class GetComInterfaceForObject_MethodGroup:
        def __getitem__(
            self,
            t: typing.Tuple[
                typing.Type[GetComInterfaceForObject_2_T1],
                typing.Type[GetComInterfaceForObject_2_T2],
            ],
        ) -> GetComInterfaceForObject_2[
            GetComInterfaceForObject_2_T1, GetComInterfaceForObject_2_T2
        ]: ...
        ...
        class GetComInterfaceForObject_2(
            typing.Generic[GetComInterfaceForObject_2_T1, GetComInterfaceForObject_2_T2]
        ):
            GetComInterfaceForObject_2_T = (
                Marshal.GetComInterfaceForObject_MethodGroup.GetComInterfaceForObject_2_T1
            )
        ...
        @typing.overload
        def __call__(
            self, o: typing.Any, T: typing.Type[typing.Any], mode: CustomQueryInterfaceMode
        ) -> int: ...
    ...
    class GetDelegateForFunctionPointer_MethodGroup:
        ...
        GetDelegateForFunctionPointer_1_T1 = typing.TypeVar(
            'GetDelegateForFunctionPointer_1_T1'
        )
        class GetDelegateForFunctionPointer_1(
            typing.Generic[GetDelegateForFunctionPointer_1_T1]
        ):
    ...
    class GetFunctionPointerForDelegate_MethodGroup:
        ...
        GetFunctionPointerForDelegate_1_T1 = typing.TypeVar(
            'GetFunctionPointerForDelegate_1_T1'
        )
        class GetFunctionPointerForDelegate_1(
            typing.Generic[GetFunctionPointerForDelegate_1_T1]
        ):
    ...
    class GetNativeVariantForObject_MethodGroup:
        ...
        class GetNativeVariantForObject_1(typing.Generic[GetNativeVariantForObject_1_T1]):
            GetNativeVariantForObject_1_T = (
                Marshal.GetNativeVariantForObject_MethodGroup.GetNativeVariantForObject_1_T1
            )
            def __call__(
                self, obj: GetNativeVariantForObject_1_T, pDstNativeVariant: int
            ) -> None: ...
    ...
    class GetObjectForNativeVariant_MethodGroup:
        ...
        class GetObjectForNativeVariant_1(typing.Generic[GetObjectForNativeVariant_1_T1]):
            GetObjectForNativeVariant_1_T = (
                Marshal.GetObjectForNativeVariant_MethodGroup.GetObjectForNativeVariant_1_T1
            )
    ...
    class GetObjectsForNativeVariants_MethodGroup:
        ...
        class GetObjectsForNativeVariants_1(typing.Generic[GetObjectsForNativeVariants_1_T1]):
            ...
            def __call__(
                self, aSrcNativeVariant: int, cVars: int
            ) -> Array_1[GetObjectsForNativeVariants_1_T]: ...
    ...
    class PtrToStructure_MethodGroup:
        def __getitem__(
            self, t: typing.Type[PtrToStructure_1_T1]
        ) -> PtrToStructure_1[PtrToStructure_1_T1]: ...
    ...
    class StructureToPtr_MethodGroup:
        def __getitem__(
            self, t: typing.Type[StructureToPtr_1_T1]
        ) -> StructureToPtr_1[StructureToPtr_1_T1]: ...
        ...
        class StructureToPtr_1(typing.Generic[StructureToPtr_1_T1]):
            ...
            def __call__(
                self, structure: StructureToPtr_1_T, ptr: int, fDeleteOld: bool
            ) -> None: ...
    ...
    class UnsafeAddrOfPinnedArrayElement_MethodGroup:
        ...
        UnsafeAddrOfPinnedArrayElement_1_T1 = typing.TypeVar(
            'UnsafeAddrOfPinnedArrayElement_1_T1'
        )
        class UnsafeAddrOfPinnedArrayElement_1(
            typing.Generic[UnsafeAddrOfPinnedArrayElement_1_T1]
        ):
            ...
            def __call__(
                self, arr: Array_1[UnsafeAddrOfPinnedArrayElement_1_T], index: int
            ) -> int: ...
...
class MemoryMarshal(abc.ABC):
    ...
    class AsMemory_MethodGroup:
        ...
        class AsMemory_1(typing.Generic[AsMemory_1_T1]):
            ...
            def __call__(
                self, memory: ReadOnlyMemory_1[AsMemory_1_T]
            ) -> Memory_1[AsMemory_1_T]: ...
    ...
    class Cast_MethodGroup:
        ...
        class Cast_2(typing.Generic[Cast_2_T1, Cast_2_T2]):
            ...
            @typing.overload
            def __call__(
                self, span: ReadOnlySpan_1[Cast_2_TFrom]
            ) -> ReadOnlySpan_1[Cast_2_TTo]: ...
    ...
    class CreateFromPinnedArray_MethodGroup:
        ...
        class CreateFromPinnedArray_1(typing.Generic[CreateFromPinnedArray_1_T1]):
            CreateFromPinnedArray_1_T = (
                MemoryMarshal.CreateFromPinnedArray_MethodGroup.CreateFromPinnedArray_1_T1
            )
            def __call__(
                self, array: Array_1[CreateFromPinnedArray_1_T], start: int, length: int
    ...
    class CreateReadOnlySpan_MethodGroup:
        ...
        class CreateReadOnlySpan_1(typing.Generic[CreateReadOnlySpan_1_T1]):
            CreateReadOnlySpan_1_T = (
                MemoryMarshal.CreateReadOnlySpan_MethodGroup.CreateReadOnlySpan_1_T1
            )
            def __call__(
                self, reference: clr.Reference[CreateReadOnlySpan_1_T], length: int
    ...
    class CreateSpan_MethodGroup:
        ...
        class CreateSpan_1(typing.Generic[CreateSpan_1_T1]):
            ...
            def __call__(
                self, reference: clr.Reference[CreateSpan_1_T], length: int
    ...
    class GetArrayDataReference_MethodGroup:
        ...
        class GetArrayDataReference_1(typing.Generic[GetArrayDataReference_1_T1]):
            GetArrayDataReference_1_T = (
                MemoryMarshal.GetArrayDataReference_MethodGroup.GetArrayDataReference_1_T1
            )
            def __call__(
    ...
    class GetReference_MethodGroup:
        def __getitem__(
            self, t: typing.Type[GetReference_1_T1]
        ) -> GetReference_1[GetReference_1_T1]: ...
        ...
        class GetReference_1(typing.Generic[GetReference_1_T1]):
            ...
            @typing.overload
            def __call__(
                self, span: Span_1[GetReference_1_T]
            ) -> clr.Reference[GetReference_1_T]: ...
            @typing.overload
            def __call__(
                self, span: ReadOnlySpan_1[GetReference_1_T]
            ) -> clr.Reference[GetReference_1_T]: ...
    ...
    class ToEnumerable_MethodGroup:
        def __getitem__(
            self, t: typing.Type[ToEnumerable_1_T1]
        ) -> ToEnumerable_1[ToEnumerable_1_T1]: ...
        ...
        class ToEnumerable_1(typing.Generic[ToEnumerable_1_T1]):
            ...
            def __call__(
                self, memory: ReadOnlyMemory_1[ToEnumerable_1_T]
            ) -> IEnumerable_1[ToEnumerable_1_T]: ...
    ...
    class TryGetArray_MethodGroup:
        def __getitem__(
            self, t: typing.Type[TryGetArray_1_T1]
        ) -> TryGetArray_1[TryGetArray_1_T1]: ...
        ...
        class TryGetArray_1(typing.Generic[TryGetArray_1_T1]):
            ...
            def __call__(
                self,
                memory: ReadOnlyMemory_1[TryGetArray_1_T],
                segment: clr.Reference[ArraySegment_1[TryGetArray_1_T]],
            ) -> bool: ...
    ...
    class TryGetMemoryManager_MethodGroup:
        def __getitem__(
            self,
            t: typing.Tuple[
                typing.Type[TryGetMemoryManager_2_T1], typing.Type[TryGetMemoryManager_2_T2]
            ],
        ...
        class TryGetMemoryManager_2(
            typing.Generic[TryGetMemoryManager_2_T1, TryGetMemoryManager_2_T2]
        ):
            TryGetMemoryManager_2_T = (
                MemoryMarshal.TryGetMemoryManager_MethodGroup.TryGetMemoryManager_2_T1
            )
            TryGetMemoryManager_2_TManager = (
                MemoryMarshal.TryGetMemoryManager_MethodGroup.TryGetMemoryManager_2_T2
            )
            @typing.overload
            def __call__(
                self,
                memory: ReadOnlyMemory_1[TryGetMemoryManager_2_T],
                manager: clr.Reference[TryGetMemoryManager_2_TManager],
            ) -> bool: ...
            @typing.overload
            def __call__(
                self,
    ...
    class TryRead_MethodGroup:
        ...
        class TryRead_1(typing.Generic[TryRead_1_T1]):
            ...
            def __call__(
                self, source: ReadOnlySpan_1[int], value: clr.Reference[TryRead_1_T]
            ) -> bool: ...
    ...
    class TryWrite_MethodGroup:
        ...
        class TryWrite_1(typing.Generic[TryWrite_1_T1]):
            ...
            def __call__(
                self, destination: Span_1[int], value: clr.Reference[TryWrite_1_T]
            ) -> bool: ...
    ...
    class Write_MethodGroup:
        ...
        class Write_1(typing.Generic[Write_1_T1]):
            ...
            def __call__(
                self, destination: Span_1[int], value: clr.Reference[Write_1_T]
            ) -> None: ...
...
class NativeMemory(abc.ABC):
    ...
    @staticmethod
    def AlignedRealloc(
        ptr: clr.Reference[None], byteCount: UIntPtr, alignment: UIntPtr
    ) -> clr.Reference[None]: ...
    @staticmethod
    def Clear(ptr: clr.Reference[None], byteCount: UIntPtr) -> None: ...
    @staticmethod
    def Copy(
        source: clr.Reference[None], destination: clr.Reference[None], byteCount: UIntPtr
    ) -> None: ...
    @staticmethod
    ...
    class Alloc_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, elementCount: UIntPtr, elementSize: UIntPtr
        ) -> clr.Reference[None]: ...
...
class NFloat(IBinaryFloatingPointIeee754_1[NFloat], IMinMaxValue_1[NFloat]):
    ...
    class CreateSaturating_MethodGroup:
        ...
        class CreateSaturating_1(typing.Generic[CreateSaturating_1_T1]):
            CreateSaturating_1_TOther = (
                NFloat.CreateSaturating_MethodGroup.CreateSaturating_1_T1
            )
    ...
    class CreateTruncating_MethodGroup:
        ...
        class CreateTruncating_1(typing.Generic[CreateTruncating_1_T1]):
            CreateTruncating_1_TOther = (
                NFloat.CreateTruncating_MethodGroup.CreateTruncating_1_T1
            )
    ...
    class Parse_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, utf8Text: ReadOnlySpan_1[int], provider: IFormatProvider
        ) -> NFloat: ...
        @typing.overload
    ...
    class TryParse_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, utf8Text: ReadOnlySpan_1[int], result: clr.Reference[NFloat]
        ) -> bool: ...
        @typing.overload
        ...
        @typing.overload
        def __call__(
            self, s: str, provider: IFormatProvider, result: clr.Reference[NFloat]
        ) -> bool: ...
        @typing.overload
        def __call__(
            self,
...
class PosixSignalRegistration(IDisposable):
    @staticmethod
    def Create(
        signal: PosixSignal, handler: Action_1[PosixSignalContext]
...
class SafeBuffer(SafeHandleZeroOrMinusOneIsInvalid):
    ...
    class Initialize_MethodGroup:
        def __getitem__(
            self, t: typing.Type[Initialize_1_T1]
        ) -> Initialize_1[Initialize_1_T1]: ...
    ...
    class ReadArray_MethodGroup:
        def __getitem__(
            self, t: typing.Type[ReadArray_1_T1]
        ) -> ReadArray_1[ReadArray_1_T1]: ...
        ...
        class ReadArray_1(typing.Generic[ReadArray_1_T1]):
            ...
            def __call__(
                self, byteOffset: int, array: Array_1[ReadArray_1_T], index: int, count: int
            ) -> None: ...
    ...
    class WriteArray_MethodGroup:
        def __getitem__(
            self, t: typing.Type[WriteArray_1_T1]
        ) -> WriteArray_1[WriteArray_1_T1]: ...
        ...
        class WriteArray_1(typing.Generic[WriteArray_1_T1]):
            ...
            def __call__(
                self, byteOffset: int, array: Array_1[WriteArray_1_T], index: int, count: int
            ) -> None: ...
    ...
    class WriteSpan_MethodGroup:
        def __getitem__(
            self, t: typing.Type[WriteSpan_1_T1]
        ) -> WriteSpan_1[WriteSpan_1_T1]: ...
        ...
        class WriteSpan_1(typing.Generic[WriteSpan_1_T1]):
            ...
            def __call__(
                self, byteOffset: int, data: ReadOnlySpan_1[WriteSpan_1_T]
            ) -> None: ...
