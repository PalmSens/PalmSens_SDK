...
from System.Collections.Generic import IEnumerable_1, IList_1, KeyValuePair_2
...
class AsyncIteratorMethodBuilder:
    ...
    class AwaitOnCompleted_MethodGroup:
        def __getitem__(
            self,
            t: typing.Tuple[
                typing.Type[AwaitOnCompleted_2_T1], typing.Type[AwaitOnCompleted_2_T2]
            ],
        ) -> AwaitOnCompleted_2[AwaitOnCompleted_2_T1, AwaitOnCompleted_2_T2]: ...
        ...
        class AwaitOnCompleted_2(typing.Generic[AwaitOnCompleted_2_T1, AwaitOnCompleted_2_T2]):
            AwaitOnCompleted_2_TAwaiter = (
                AsyncIteratorMethodBuilder.AwaitOnCompleted_MethodGroup.AwaitOnCompleted_2_T1
            )
            AwaitOnCompleted_2_TStateMachine = (
                AsyncIteratorMethodBuilder.AwaitOnCompleted_MethodGroup.AwaitOnCompleted_2_T2
            )
            def __call__(
                self,
                awaiter: clr.Reference[AwaitOnCompleted_2_TAwaiter],
                stateMachine: clr.Reference[AwaitOnCompleted_2_TStateMachine],
            ) -> None: ...
    ...
    class AwaitUnsafeOnCompleted_MethodGroup:
        def __getitem__(
            self,
            t: typing.Tuple[
                typing.Type[AwaitUnsafeOnCompleted_2_T1],
                typing.Type[AwaitUnsafeOnCompleted_2_T2],
            ],
        ) -> AwaitUnsafeOnCompleted_2[
            AwaitUnsafeOnCompleted_2_T1, AwaitUnsafeOnCompleted_2_T2
        ]: ...
        ...
        class AwaitUnsafeOnCompleted_2(
            typing.Generic[AwaitUnsafeOnCompleted_2_T1, AwaitUnsafeOnCompleted_2_T2]
        ):
            ...
            def __call__(
                self,
                awaiter: clr.Reference[AwaitUnsafeOnCompleted_2_TAwaiter],
                stateMachine: clr.Reference[AwaitUnsafeOnCompleted_2_TStateMachine],
            ) -> None: ...
    ...
    class MoveNext_MethodGroup:
        ...
        class MoveNext_1(typing.Generic[MoveNext_1_T1]):
            MoveNext_1_TStateMachine = (
                AsyncIteratorMethodBuilder.MoveNext_MethodGroup.MoveNext_1_T1
            )
            def __call__(
                self, stateMachine: clr.Reference[MoveNext_1_TStateMachine]
            ) -> None: ...
...
class AsyncTaskMethodBuilder_GenericClasses(abc.ABCMeta):
    Generic_AsyncTaskMethodBuilder_GenericClasses_AsyncTaskMethodBuilder_1_TResult = (
        typing.TypeVar(
            'Generic_AsyncTaskMethodBuilder_GenericClasses_AsyncTaskMethodBuilder_1_TResult'
        )
    )
...
class AsyncTaskMethodBuilder(
    AsyncTaskMethodBuilder_0, metaclass=AsyncTaskMethodBuilder_GenericClasses
): ...
...
class AsyncTaskMethodBuilder_0:
    ...
    class AwaitOnCompleted_MethodGroup:
        ...
        class AwaitOnCompleted_2(typing.Generic[AwaitOnCompleted_2_T1, AwaitOnCompleted_2_T2]):
            AwaitOnCompleted_2_TAwaiter = (
                AsyncTaskMethodBuilder_0.AwaitOnCompleted_MethodGroup.AwaitOnCompleted_2_T1
            )
            AwaitOnCompleted_2_TStateMachine = (
                AsyncTaskMethodBuilder_0.AwaitOnCompleted_MethodGroup.AwaitOnCompleted_2_T2
            )
            def __call__(
                self,
                awaiter: clr.Reference[AwaitOnCompleted_2_TAwaiter],
...
class AsyncTaskMethodBuilder_1(typing.Generic[AsyncTaskMethodBuilder_1_TResult]):
    ...
    AwaitOnCompleted_MethodGroup_AsyncTaskMethodBuilder_1_TResult = typing.TypeVar(
        'AwaitOnCompleted_MethodGroup_AsyncTaskMethodBuilder_1_TResult'
    )
    class AwaitOnCompleted_MethodGroup(
        typing.Generic[AwaitOnCompleted_MethodGroup_AsyncTaskMethodBuilder_1_TResult]
    ):
        ...
        def __getitem__(
            ...
            AwaitOnCompleted_MethodGroup_AsyncTaskMethodBuilder_1_TResult,
            AwaitOnCompleted_2_T1,
            AwaitOnCompleted_2_T2,
        ]: ...

        AwaitOnCompleted_2_AsyncTaskMethodBuilder_1_TResult = typing.TypeVar(
            'AwaitOnCompleted_2_AsyncTaskMethodBuilder_1_TResult'
        )
        AwaitOnCompleted_2_T1 = typing.TypeVar('AwaitOnCompleted_2_T1')
        AwaitOnCompleted_2_T2 = typing.TypeVar('AwaitOnCompleted_2_T2')
        class AwaitOnCompleted_2(
            typing.Generic[
                AwaitOnCompleted_2_AsyncTaskMethodBuilder_1_TResult,
                AwaitOnCompleted_2_T1,
                AwaitOnCompleted_2_T2,
            ...
            AwaitOnCompleted_2_TAwaiter = (
                AsyncTaskMethodBuilder_1.AwaitOnCompleted_MethodGroup.AwaitOnCompleted_2_T1
            )
            AwaitOnCompleted_2_TStateMachine = (
                AsyncTaskMethodBuilder_1.AwaitOnCompleted_MethodGroup.AwaitOnCompleted_2_T2
            )
            def __call__(
                self,
                awaiter: clr.Reference[AwaitOnCompleted_2_TAwaiter],
    ...
    AwaitUnsafeOnCompleted_MethodGroup_AsyncTaskMethodBuilder_1_TResult = typing.TypeVar(
        'AwaitUnsafeOnCompleted_MethodGroup_AsyncTaskMethodBuilder_1_TResult'
    )
    class AwaitUnsafeOnCompleted_MethodGroup(
        typing.Generic[AwaitUnsafeOnCompleted_MethodGroup_AsyncTaskMethodBuilder_1_TResult]
    ):
        ...
        def __getitem__(
            ...
            AwaitUnsafeOnCompleted_MethodGroup_AsyncTaskMethodBuilder_1_TResult,
            AwaitUnsafeOnCompleted_2_T1,
            AwaitUnsafeOnCompleted_2_T2,
        ]: ...

        AwaitUnsafeOnCompleted_2_AsyncTaskMethodBuilder_1_TResult = typing.TypeVar(
            'AwaitUnsafeOnCompleted_2_AsyncTaskMethodBuilder_1_TResult'
        )
        AwaitUnsafeOnCompleted_2_T1 = typing.TypeVar('AwaitUnsafeOnCompleted_2_T1')
        AwaitUnsafeOnCompleted_2_T2 = typing.TypeVar('AwaitUnsafeOnCompleted_2_T2')
        class AwaitUnsafeOnCompleted_2(
    ...
    Start_MethodGroup_AsyncTaskMethodBuilder_1_TResult = typing.TypeVar(
        'Start_MethodGroup_AsyncTaskMethodBuilder_1_TResult'
    )
    class Start_MethodGroup(typing.Generic[Start_MethodGroup_AsyncTaskMethodBuilder_1_TResult]):
        Start_MethodGroup_AsyncTaskMethodBuilder_1_TResult = (
            AsyncTaskMethodBuilder_1.Start_MethodGroup_AsyncTaskMethodBuilder_1_TResult
        )
        def __getitem__(
            self, t: typing.Type[Start_1_T1]
        ) -> Start_1[Start_MethodGroup_AsyncTaskMethodBuilder_1_TResult, Start_1_T1]: ...

        Start_1_AsyncTaskMethodBuilder_1_TResult = typing.TypeVar(
            'Start_1_AsyncTaskMethodBuilder_1_TResult'
        )
        Start_1_T1 = typing.TypeVar('Start_1_T1')
...
class AsyncValueTaskMethodBuilder_GenericClasses(abc.ABCMeta):
    Generic_AsyncValueTaskMethodBuilder_GenericClasses_AsyncValueTaskMethodBuilder_1_TResult = typing.TypeVar(
        'Generic_AsyncValueTaskMethodBuilder_GenericClasses_AsyncValueTaskMethodBuilder_1_TResult'
    )
    def __getitem__(
        self,
        types: typing.Type[
        ...
        AsyncValueTaskMethodBuilder_1[
            Generic_AsyncValueTaskMethodBuilder_GenericClasses_AsyncValueTaskMethodBuilder_1_TResult
        ]
    ]: ...

class AsyncValueTaskMethodBuilder(
    AsyncValueTaskMethodBuilder_0, metaclass=AsyncValueTaskMethodBuilder_GenericClasses
): ...
...
class AsyncValueTaskMethodBuilder_0:
    ...
    class AwaitOnCompleted_MethodGroup:
        ...
        class AwaitOnCompleted_2(typing.Generic[AwaitOnCompleted_2_T1, AwaitOnCompleted_2_T2]):
            AwaitOnCompleted_2_TAwaiter = (
                AsyncValueTaskMethodBuilder_0.AwaitOnCompleted_MethodGroup.AwaitOnCompleted_2_T1
            )
            AwaitOnCompleted_2_TStateMachine = (
                AsyncValueTaskMethodBuilder_0.AwaitOnCompleted_MethodGroup.AwaitOnCompleted_2_T2
            )
            def __call__(
                self,
                awaiter: clr.Reference[AwaitOnCompleted_2_TAwaiter],
...
class AsyncValueTaskMethodBuilder_1(typing.Generic[AsyncValueTaskMethodBuilder_1_TResult]):
    ...
    AwaitOnCompleted_MethodGroup_AsyncValueTaskMethodBuilder_1_TResult = typing.TypeVar(
        'AwaitOnCompleted_MethodGroup_AsyncValueTaskMethodBuilder_1_TResult'
    )
    class AwaitOnCompleted_MethodGroup(
        typing.Generic[AwaitOnCompleted_MethodGroup_AsyncValueTaskMethodBuilder_1_TResult]
    ):
        ...
        AwaitOnCompleted_2_AsyncValueTaskMethodBuilder_1_TResult = typing.TypeVar(
            'AwaitOnCompleted_2_AsyncValueTaskMethodBuilder_1_TResult'
        )
        AwaitOnCompleted_2_T1 = typing.TypeVar('AwaitOnCompleted_2_T1')
        AwaitOnCompleted_2_T2 = typing.TypeVar('AwaitOnCompleted_2_T2')
        class AwaitOnCompleted_2(
            ...
            AwaitOnCompleted_2_TAwaiter = (
                AsyncValueTaskMethodBuilder_1.AwaitOnCompleted_MethodGroup.AwaitOnCompleted_2_T1
            )
            AwaitOnCompleted_2_TStateMachine = (
                AsyncValueTaskMethodBuilder_1.AwaitOnCompleted_MethodGroup.AwaitOnCompleted_2_T2
            )
            def __call__(
                self,
                awaiter: clr.Reference[AwaitOnCompleted_2_TAwaiter],
    ...
    AwaitUnsafeOnCompleted: AwaitUnsafeOnCompleted_MethodGroup[
        AsyncValueTaskMethodBuilder_1_TResult
    ]
    AwaitUnsafeOnCompleted_MethodGroup_AsyncValueTaskMethodBuilder_1_TResult = typing.TypeVar(
        'AwaitUnsafeOnCompleted_MethodGroup_AsyncValueTaskMethodBuilder_1_TResult'
    )
    class AwaitUnsafeOnCompleted_MethodGroup(
        typing.Generic[AwaitUnsafeOnCompleted_MethodGroup_AsyncValueTaskMethodBuilder_1_TResult]
    ):
        ...
        AwaitUnsafeOnCompleted_2_AsyncValueTaskMethodBuilder_1_TResult = typing.TypeVar(
            'AwaitUnsafeOnCompleted_2_AsyncValueTaskMethodBuilder_1_TResult'
        )
        AwaitUnsafeOnCompleted_2_T1 = typing.TypeVar('AwaitUnsafeOnCompleted_2_T1')
        AwaitUnsafeOnCompleted_2_T2 = typing.TypeVar('AwaitUnsafeOnCompleted_2_T2')
        class AwaitUnsafeOnCompleted_2(
    ...
    Start_MethodGroup_AsyncValueTaskMethodBuilder_1_TResult = typing.TypeVar(
        'Start_MethodGroup_AsyncValueTaskMethodBuilder_1_TResult'
    )
    class Start_MethodGroup(
        typing.Generic[Start_MethodGroup_AsyncValueTaskMethodBuilder_1_TResult]
    ):
        ...
        def __getitem__(
            self, t: typing.Type[Start_1_T1]
        ) -> Start_1[Start_MethodGroup_AsyncValueTaskMethodBuilder_1_TResult, Start_1_T1]: ...

        Start_1_AsyncValueTaskMethodBuilder_1_TResult = typing.TypeVar(
            'Start_1_AsyncValueTaskMethodBuilder_1_TResult'
        )
        Start_1_T1 = typing.TypeVar('Start_1_T1')
        class Start_1(
            typing.Generic[Start_1_AsyncValueTaskMethodBuilder_1_TResult, Start_1_T1]
        ):
...
class AsyncVoidMethodBuilder:
    ...
    class AwaitOnCompleted_MethodGroup:
        ...
        class AwaitOnCompleted_2(typing.Generic[AwaitOnCompleted_2_T1, AwaitOnCompleted_2_T2]):
            AwaitOnCompleted_2_TAwaiter = (
                AsyncVoidMethodBuilder.AwaitOnCompleted_MethodGroup.AwaitOnCompleted_2_T1
            )
            AwaitOnCompleted_2_TStateMachine = (
                AsyncVoidMethodBuilder.AwaitOnCompleted_MethodGroup.AwaitOnCompleted_2_T2
            )
            def __call__(
                self,
                awaiter: clr.Reference[AwaitOnCompleted_2_TAwaiter],
...
class CallSite_GenericClasses(abc.ABCMeta):
    Generic_CallSite_GenericClasses_CallSite_1_T = typing.TypeVar(
        'Generic_CallSite_GenericClasses_CallSite_1_T'
    )
    def __getitem__(
        self, types: typing.Type[Generic_CallSite_GenericClasses_CallSite_1_T]
    ) -> typing.Type[CallSite_1[Generic_CallSite_GenericClasses_CallSite_1_T]]: ...
...
class CallSiteBinder(abc.ABC):
    ...
    class BindDelegate_MethodGroup:
        def __getitem__(
            self, t: typing.Type[BindDelegate_1_T1]
        ) -> BindDelegate_1[BindDelegate_1_T1]: ...
        ...
        class BindDelegate_1(typing.Generic[BindDelegate_1_T1]):
            ...
            def __call__(
                self, site: CallSite_1[BindDelegate_1_T], args: Array_1[typing.Any]
            ) -> BindDelegate_1_T: ...
...
class ConditionalWeakTable_GenericClasses(abc.ABCMeta):
    Generic_ConditionalWeakTable_GenericClasses_ConditionalWeakTable_2_TKey = typing.TypeVar(
        'Generic_ConditionalWeakTable_GenericClasses_ConditionalWeakTable_2_TKey'
    )
    Generic_ConditionalWeakTable_GenericClasses_ConditionalWeakTable_2_TValue = typing.TypeVar(
        'Generic_ConditionalWeakTable_GenericClasses_ConditionalWeakTable_2_TValue'
    )
    def __getitem__(
        self,
        types: typing.Tuple[
...
class ConditionalWeakTable_2(
    typing.Generic[ConditionalWeakTable_2_TKey, ConditionalWeakTable_2_TValue],
    IEnumerable_1[KeyValuePair_2[ConditionalWeakTable_2_TKey, ConditionalWeakTable_2_TValue]],
):
    def __init__(self) -> None: ...

    CreateValueCallback_GenericClasses_ConditionalWeakTable_2_TKey = typing.TypeVar(
        'CreateValueCallback_GenericClasses_ConditionalWeakTable_2_TKey'
    )
    CreateValueCallback_GenericClasses_ConditionalWeakTable_2_TValue = typing.TypeVar(
        'CreateValueCallback_GenericClasses_ConditionalWeakTable_2_TValue'
    )
    class CreateValueCallback_GenericClasses(
        typing.Generic[
            CreateValueCallback_GenericClasses_ConditionalWeakTable_2_TKey,
            CreateValueCallback_GenericClasses_ConditionalWeakTable_2_TValue,
        ],
        ...
        def __call__(
            self,
        ) -> ConditionalWeakTable_2.CreateValueCallback_2[
            CreateValueCallback_GenericClasses_ConditionalWeakTable_2_TKey,
            CreateValueCallback_GenericClasses_ConditionalWeakTable_2_TValue,
        ]: ...

    CreateValueCallback: CreateValueCallback_GenericClasses[
        ConditionalWeakTable_2_TKey, ConditionalWeakTable_2_TValue
    ]
    ...
    class CreateValueCallback_2(
        typing.Generic[CreateValueCallback_2_TKey, CreateValueCallback_2_TValue],
        MulticastDelegate,
    ):
        ...
        def BeginInvoke(
            self, key: CreateValueCallback_2_TKey, callback: AsyncCallback, object: typing.Any
        ) -> IAsyncResult: ...
    ...
    def Add(
        self, key: ConditionalWeakTable_2_TKey, value: ConditionalWeakTable_2_TValue
    ) -> None: ...
    def AddOrUpdate(
        self, key: ConditionalWeakTable_2_TKey, value: ConditionalWeakTable_2_TValue
    ) -> None: ...
    ...
    def GetOrCreateValue(
        self, key: ConditionalWeakTable_2_TKey
    ) -> ConditionalWeakTable_2_TValue: ...
    def GetValue(
        self,
        key: ConditionalWeakTable_2_TKey,
        createValueCallback: ConditionalWeakTable_2.CreateValueCallback_2[
            ConditionalWeakTable_2_TKey, ConditionalWeakTable_2_TValue
        ],
    ) -> ConditionalWeakTable_2_TValue: ...
    ...
    def TryGetValue(
        self,
        key: ConditionalWeakTable_2_TKey,
        value: clr.Reference[ConditionalWeakTable_2_TValue],
    ) -> bool: ...
...
class ConfiguredCancelableAsyncEnumerable_GenericClasses(abc.ABCMeta):
    Generic_ConfiguredCancelableAsyncEnumerable_GenericClasses_ConfiguredCancelableAsyncEnumerable_1_T = typing.TypeVar(
        'Generic_ConfiguredCancelableAsyncEnumerable_GenericClasses_ConfiguredCancelableAsyncEnumerable_1_T'
    )
    def __getitem__(
        self,
        types: typing.Type[
...
ConfiguredCancelableAsyncEnumerable_1_T = typing.TypeVar(
    'ConfiguredCancelableAsyncEnumerable_1_T'
)

class ConfiguredCancelableAsyncEnumerable_1(
    typing.Generic[ConfiguredCancelableAsyncEnumerable_1_T]
):
    Enumerator_GenericClasses_ConfiguredCancelableAsyncEnumerable_1_T = typing.TypeVar(
        'Enumerator_GenericClasses_ConfiguredCancelableAsyncEnumerable_1_T'
    )
    class Enumerator_GenericClasses(
        typing.Generic[Enumerator_GenericClasses_ConfiguredCancelableAsyncEnumerable_1_T],
        abc.ABCMeta,
    ):
        ...
        def __call__(
            self,
        ) -> ConfiguredCancelableAsyncEnumerable_1.Enumerator_1[
            Enumerator_GenericClasses_ConfiguredCancelableAsyncEnumerable_1_T
        ]: ...
    ...
    ) -> ConfiguredCancelableAsyncEnumerable_1[ConfiguredCancelableAsyncEnumerable_1_T]: ...
...
class ConfiguredTaskAwaitable_GenericClasses(abc.ABCMeta):
    Generic_ConfiguredTaskAwaitable_GenericClasses_ConfiguredTaskAwaitable_1_TResult = (
        typing.TypeVar(
            'Generic_ConfiguredTaskAwaitable_GenericClasses_ConfiguredTaskAwaitable_1_TResult'
        )
    )
...
class ConfiguredTaskAwaitable(
    ConfiguredTaskAwaitable_0, metaclass=ConfiguredTaskAwaitable_GenericClasses
): ...
...
class ConfiguredTaskAwaitable_1(typing.Generic[ConfiguredTaskAwaitable_1_TResult]):
    ConfiguredTaskAwaiter_GenericClasses_ConfiguredTaskAwaitable_1_TResult = typing.TypeVar(
        'ConfiguredTaskAwaiter_GenericClasses_ConfiguredTaskAwaitable_1_TResult'
    )
    class ConfiguredTaskAwaiter_GenericClasses(
        typing.Generic[ConfiguredTaskAwaiter_GenericClasses_ConfiguredTaskAwaitable_1_TResult],
        abc.ABCMeta,
    ):
        ...
        def __call__(
            self,
        ) -> ConfiguredTaskAwaitable_1.ConfiguredTaskAwaiter_1[
            ConfiguredTaskAwaiter_GenericClasses_ConfiguredTaskAwaitable_1_TResult
        ]: ...

    ConfiguredTaskAwaiter: ConfiguredTaskAwaiter_GenericClasses[
        ConfiguredTaskAwaitable_1_TResult
    ]

    ConfiguredTaskAwaiter_1_TResult = typing.TypeVar('ConfiguredTaskAwaiter_1_TResult')
    class ConfiguredTaskAwaiter_1(
        typing.Generic[ConfiguredTaskAwaiter_1_TResult], ICriticalNotifyCompletion
    ):
        ConfiguredTaskAwaiter_1_TResult = (
            ConfiguredTaskAwaitable_1.ConfiguredTaskAwaiter_1_TResult
        )
        @property
        def IsCompleted(self) -> bool: ...
...
class ConfiguredValueTaskAwaitable_GenericClasses(abc.ABCMeta):
    Generic_ConfiguredValueTaskAwaitable_GenericClasses_ConfiguredValueTaskAwaitable_1_TResult = typing.TypeVar(
        'Generic_ConfiguredValueTaskAwaitable_GenericClasses_ConfiguredValueTaskAwaitable_1_TResult'
    )
    def __getitem__(
        self,
        types: typing.Type[
...
class ConfiguredValueTaskAwaitable(
    ConfiguredValueTaskAwaitable_0, metaclass=ConfiguredValueTaskAwaitable_GenericClasses
): ...
...
ConfiguredValueTaskAwaitable_1_TResult = typing.TypeVar(
    'ConfiguredValueTaskAwaitable_1_TResult'
)

class ConfiguredValueTaskAwaitable_1(typing.Generic[ConfiguredValueTaskAwaitable_1_TResult]):
    ConfiguredValueTaskAwaiter_GenericClasses_ConfiguredValueTaskAwaitable_1_TResult = (
        typing.TypeVar(
            'ConfiguredValueTaskAwaiter_GenericClasses_ConfiguredValueTaskAwaitable_1_TResult'
        )
    )
    class ConfiguredValueTaskAwaiter_GenericClasses(
        typing.Generic[
            ConfiguredValueTaskAwaiter_GenericClasses_ConfiguredValueTaskAwaitable_1_TResult
        ],
        abc.ABCMeta,
        ...
        def __call__(
            self,
        ) -> ConfiguredValueTaskAwaitable_1.ConfiguredValueTaskAwaiter_1[
            ConfiguredValueTaskAwaiter_GenericClasses_ConfiguredValueTaskAwaitable_1_TResult
        ]: ...

    ConfiguredValueTaskAwaiter: ConfiguredValueTaskAwaiter_GenericClasses[
        ConfiguredValueTaskAwaitable_1_TResult
    ]

    ConfiguredValueTaskAwaiter_1_TResult = typing.TypeVar(
        'ConfiguredValueTaskAwaiter_1_TResult'
    )
    class ConfiguredValueTaskAwaiter_1(
        typing.Generic[ConfiguredValueTaskAwaiter_1_TResult], ICriticalNotifyCompletion
    ):
        ConfiguredValueTaskAwaiter_1_TResult = (
            ConfiguredValueTaskAwaitable_1.ConfiguredValueTaskAwaiter_1_TResult
        )
        @property
        def IsCompleted(self) -> bool: ...
...
class DefaultInterpolatedStringHandler:
    ...
    @typing.overload
    def __init__(
        self, literalLength: int, formattedCount: int, provider: IFormatProvider
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    class AppendFormatted_MethodGroup:
        def __getitem__(
            self, t: typing.Type[AppendFormatted_1_T1]
        ) -> AppendFormatted_1[AppendFormatted_1_T1]: ...
        ...
        class AppendFormatted_1(typing.Generic[AppendFormatted_1_T1]):
            ...
            @typing.overload
            def __call__(
                self, value: AppendFormatted_1_T, alignment: int, format: str
            ) -> None: ...
        ...
        @typing.overload
        def __call__(
            self, value: ReadOnlySpan_1[str], alignment: int = ..., format: str = ...
        ) -> None: ...
        @typing.overload
        def __call__(self, value: str, alignment: int = ..., format: str = ...) -> None: ...
        @typing.overload
        def __call__(
            self, value: typing.Any, alignment: int = ..., format: str = ...
        ) -> None: ...
...
class ICastable(typing.Protocol):
    ...
    @abc.abstractmethod
    def IsInstanceOfInterface(
        self, interfaceType: RuntimeTypeHandle, castError: clr.Reference[Exception]
    ) -> bool: ...
...
class PoolingAsyncValueTaskMethodBuilder_GenericClasses(abc.ABCMeta):
    Generic_PoolingAsyncValueTaskMethodBuilder_GenericClasses_PoolingAsyncValueTaskMethodBuilder_1_TResult = typing.TypeVar(
        'Generic_PoolingAsyncValueTaskMethodBuilder_GenericClasses_PoolingAsyncValueTaskMethodBuilder_1_TResult'
    )
    def __getitem__(
        self,
        types: typing.Type[
        ...
        PoolingAsyncValueTaskMethodBuilder_1[
            Generic_PoolingAsyncValueTaskMethodBuilder_GenericClasses_PoolingAsyncValueTaskMethodBuilder_1_TResult
        ]
    ]: ...

class PoolingAsyncValueTaskMethodBuilder(
    PoolingAsyncValueTaskMethodBuilder_0,
    metaclass=PoolingAsyncValueTaskMethodBuilder_GenericClasses,
): ...
...
class PoolingAsyncValueTaskMethodBuilder_0:
    ...
    class Start_MethodGroup:
        ...
        Start_1_T1 = typing.TypeVar('Start_1_T1')
        class Start_1(typing.Generic[Start_1_T1]):
            Start_1_TStateMachine = (
                PoolingAsyncValueTaskMethodBuilder_0.Start_MethodGroup.Start_1_T1
            )
            def __call__(self, stateMachine: clr.Reference[Start_1_TStateMachine]) -> None: ...

PoolingAsyncValueTaskMethodBuilder_1_TResult = typing.TypeVar(
    'PoolingAsyncValueTaskMethodBuilder_1_TResult'
)

class PoolingAsyncValueTaskMethodBuilder_1(
    typing.Generic[PoolingAsyncValueTaskMethodBuilder_1_TResult]
):
    @property
    def Task(self) -> ValueTask_1[PoolingAsyncValueTaskMethodBuilder_1_TResult]: ...
    @staticmethod
    def Create() -> PoolingAsyncValueTaskMethodBuilder_1[
        PoolingAsyncValueTaskMethodBuilder_1_TResult
    ]: ...
    def SetException(self, exception: Exception) -> None: ...
    ...
    AwaitOnCompleted_MethodGroup_PoolingAsyncValueTaskMethodBuilder_1_TResult = typing.TypeVar(
        'AwaitOnCompleted_MethodGroup_PoolingAsyncValueTaskMethodBuilder_1_TResult'
    )
    class AwaitOnCompleted_MethodGroup(
        typing.Generic[
            AwaitOnCompleted_MethodGroup_PoolingAsyncValueTaskMethodBuilder_1_TResult
        ...
        AwaitOnCompleted_2_PoolingAsyncValueTaskMethodBuilder_1_TResult = typing.TypeVar(
            'AwaitOnCompleted_2_PoolingAsyncValueTaskMethodBuilder_1_TResult'
        )
        AwaitOnCompleted_2_T1 = typing.TypeVar('AwaitOnCompleted_2_T1')
        AwaitOnCompleted_2_T2 = typing.TypeVar('AwaitOnCompleted_2_T2')
        class AwaitOnCompleted_2(
    ...
    AwaitUnsafeOnCompleted_MethodGroup_PoolingAsyncValueTaskMethodBuilder_1_TResult = (
        typing.TypeVar(
            'AwaitUnsafeOnCompleted_MethodGroup_PoolingAsyncValueTaskMethodBuilder_1_TResult'
        )
    )
    class AwaitUnsafeOnCompleted_MethodGroup(
        ...
        AwaitUnsafeOnCompleted_2_PoolingAsyncValueTaskMethodBuilder_1_TResult = typing.TypeVar(
            'AwaitUnsafeOnCompleted_2_PoolingAsyncValueTaskMethodBuilder_1_TResult'
        )
        AwaitUnsafeOnCompleted_2_T1 = typing.TypeVar('AwaitUnsafeOnCompleted_2_T1')
        AwaitUnsafeOnCompleted_2_T2 = typing.TypeVar('AwaitUnsafeOnCompleted_2_T2')
        class AwaitUnsafeOnCompleted_2(
    ...
    Start_MethodGroup_PoolingAsyncValueTaskMethodBuilder_1_TResult = typing.TypeVar(
        'Start_MethodGroup_PoolingAsyncValueTaskMethodBuilder_1_TResult'
    )
    class Start_MethodGroup(
        typing.Generic[Start_MethodGroup_PoolingAsyncValueTaskMethodBuilder_1_TResult]
    ):
        ...
        def __getitem__(
            ...
            Start_MethodGroup_PoolingAsyncValueTaskMethodBuilder_1_TResult, Start_1_T1
        ]: ...

        Start_1_PoolingAsyncValueTaskMethodBuilder_1_TResult = typing.TypeVar(
            'Start_1_PoolingAsyncValueTaskMethodBuilder_1_TResult'
        )
        Start_1_T1 = typing.TypeVar('Start_1_T1')
        class Start_1(
            typing.Generic[Start_1_PoolingAsyncValueTaskMethodBuilder_1_TResult, Start_1_T1]
        ):
            ...
            Start_1_TStateMachine = (
                PoolingAsyncValueTaskMethodBuilder_1.Start_MethodGroup.Start_1_T1
            )
            def __call__(self, stateMachine: clr.Reference[Start_1_TStateMachine]) -> None: ...
...
class RuntimeHelpers(abc.ABC):
    ...
    class TryCode(MulticastDelegate):
        ...
        def Target(self) -> typing.Any: ...
        def BeginInvoke(
            self, userData: typing.Any, callback: AsyncCallback, object: typing.Any
        ) -> IAsyncResult: ...
        def EndInvoke(self, result: IAsyncResult) -> None: ...
    ...
    def ExecuteCodeWithGuaranteedCleanup(
        code: RuntimeHelpers.TryCode,
        backoutCode: RuntimeHelpers.CleanupCode,
        userData: typing.Any,
    ) -> None: ...
    @staticmethod
    ...
    class CreateSpan_MethodGroup:
        def __getitem__(
            self, t: typing.Type[CreateSpan_1_T1]
        ) -> CreateSpan_1[CreateSpan_1_T1]: ...
        ...
        class CreateSpan_1(typing.Generic[CreateSpan_1_T1]):
            ...
            def __call__(
                self, fldHandle: RuntimeFieldHandle
            ) -> ReadOnlySpan_1[CreateSpan_1_T]: ...
    ...
    class GetSubArray_MethodGroup:
        def __getitem__(
            self, t: typing.Type[GetSubArray_1_T1]
        ) -> GetSubArray_1[GetSubArray_1_T1]: ...
        ...
        class GetSubArray_1(typing.Generic[GetSubArray_1_T1]):
            ...
            def __call__(
                self, array: Array_1[GetSubArray_1_T], range: Range
            ) -> Array_1[GetSubArray_1_T]: ...
    ...
    class IsReferenceOrContainsReferences_MethodGroup:
        def __getitem__(
            self, t: typing.Type[IsReferenceOrContainsReferences_1_T1]
        ) -> IsReferenceOrContainsReferences_1[IsReferenceOrContainsReferences_1_T1]: ...

        IsReferenceOrContainsReferences_1_T1 = typing.TypeVar(
            'IsReferenceOrContainsReferences_1_T1'
        )
        class IsReferenceOrContainsReferences_1(
            typing.Generic[IsReferenceOrContainsReferences_1_T1]
        ):
    ...
    class PrepareMethod_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, method: RuntimeMethodHandle, instantiation: Array_1[RuntimeTypeHandle]
        ) -> None: ...
...
class StrongBox_GenericClasses(abc.ABCMeta):
    Generic_StrongBox_GenericClasses_StrongBox_1_T = typing.TypeVar(
        'Generic_StrongBox_GenericClasses_StrongBox_1_T'
    )
    def __getitem__(
        self, types: typing.Type[Generic_StrongBox_GenericClasses_StrongBox_1_T]
    ) -> typing.Type[StrongBox_1[Generic_StrongBox_GenericClasses_StrongBox_1_T]]: ...
...
class TaskAwaiter_GenericClasses(abc.ABCMeta):
    Generic_TaskAwaiter_GenericClasses_TaskAwaiter_1_TResult = typing.TypeVar(
        'Generic_TaskAwaiter_GenericClasses_TaskAwaiter_1_TResult'
    )
    def __getitem__(
        self, types: typing.Type[Generic_TaskAwaiter_GenericClasses_TaskAwaiter_1_TResult]
    ) -> typing.Type[
        TaskAwaiter_1[Generic_TaskAwaiter_GenericClasses_TaskAwaiter_1_TResult]
    ]: ...
...
class Unsafe(abc.ABC):
    ...
    class Add_MethodGroup:
        ...
        class Add_1(typing.Generic[Add_1_T1]):
            ...
            @typing.overload
            def __call__(
                self, source: clr.Reference[None], elementOffset: int
            ) -> clr.Reference[None]: ...
            @typing.overload
            def __call__(
                self, source: clr.Reference[Add_1_T], elementOffset: int
            ) -> clr.Reference[Add_1_T]: ...
            # Method Add(source : T&, elementOffset : IntPtr) was skipped since it collides with above method
            @typing.overload
            def __call__(
                self, source: clr.Reference[Add_1_T], elementOffset: UIntPtr
            ) -> clr.Reference[Add_1_T]: ...
    ...
    class AddByteOffset_MethodGroup:
        def __getitem__(
            self, t: typing.Type[AddByteOffset_1_T1]
        ) -> AddByteOffset_1[AddByteOffset_1_T1]: ...
        ...
        class AddByteOffset_1(typing.Generic[AddByteOffset_1_T1]):
            ...
            @typing.overload
            def __call__(
                self, source: clr.Reference[AddByteOffset_1_T], byteOffset: UIntPtr
            ) -> clr.Reference[AddByteOffset_1_T]: ...
            @typing.overload
            def __call__(
                self, source: clr.Reference[AddByteOffset_1_T], byteOffset: int
            ) -> clr.Reference[AddByteOffset_1_T]: ...
    ...
    class AreSame_MethodGroup:
        ...
        class AreSame_1(typing.Generic[AreSame_1_T1]):
            ...
            def __call__(
                self, left: clr.Reference[AreSame_1_T], right: clr.Reference[AreSame_1_T]
            ) -> bool: ...
    ...
    class As_MethodGroup:
        ...
        class As_2(typing.Generic[As_2_T1, As_2_T2]):
            ...
            def __call__(
                self, source: clr.Reference[As_2_TFrom]
            ) -> clr.Reference[As_2_TTo]: ...
    ...
    class AsPointer_MethodGroup:
        def __getitem__(
            self, t: typing.Type[AsPointer_1_T1]
        ) -> AsPointer_1[AsPointer_1_T1]: ...
    ...
    class AsRef_MethodGroup:
        ...
        class AsRef_1(typing.Generic[AsRef_1_T1]):
            ...
            @typing.overload
            def __call__(
                self, source: clr.Reference[AsRef_1_T]
            ) -> clr.Reference[AsRef_1_T]: ...
    ...
    class BitCast_MethodGroup:
        def __getitem__(
            self, t: typing.Tuple[typing.Type[BitCast_2_T1], typing.Type[BitCast_2_T2]]
        ) -> BitCast_2[BitCast_2_T1, BitCast_2_T2]: ...
    ...
    class ByteOffset_MethodGroup:
        def __getitem__(
            self, t: typing.Type[ByteOffset_1_T1]
        ) -> ByteOffset_1[ByteOffset_1_T1]: ...
        ...
        class ByteOffset_1(typing.Generic[ByteOffset_1_T1]):
            ...
            def __call__(
                self,
                origin: clr.Reference[ByteOffset_1_T],
                target: clr.Reference[ByteOffset_1_T],
            ) -> int: ...
    ...
    class Copy_MethodGroup:
        ...
        class Copy_1(typing.Generic[Copy_1_T1]):
            ...
            @typing.overload
            def __call__(
                self, destination: clr.Reference[None], source: clr.Reference[Copy_1_T]
            ) -> None: ...
            @typing.overload
            def __call__(
                self, destination: clr.Reference[Copy_1_T], source: clr.Reference[None]
            ) -> None: ...
    ...
    class CopyBlock_MethodGroup:
        @typing.overload
        def __call__(
            self, destination: clr.Reference[int], source: clr.Reference[int], byteCount: int
        ) -> None: ...
        @typing.overload
        def __call__(
            self, destination: clr.Reference[None], source: clr.Reference[None], byteCount: int
        ) -> None: ...
    ...
    class InitBlock_MethodGroup:
        @typing.overload
        def __call__(
            self, startAddress: clr.Reference[int], value: int, byteCount: int
        ) -> None: ...
        @typing.overload
        def __call__(
            self, startAddress: clr.Reference[None], value: int, byteCount: int
        ) -> None: ...
    ...
    class IsAddressGreaterThan_MethodGroup:
        def __getitem__(
            self, t: typing.Type[IsAddressGreaterThan_1_T1]
        ) -> IsAddressGreaterThan_1[IsAddressGreaterThan_1_T1]: ...
        ...
        class IsAddressGreaterThan_1(typing.Generic[IsAddressGreaterThan_1_T1]):
            IsAddressGreaterThan_1_T = (
                Unsafe.IsAddressGreaterThan_MethodGroup.IsAddressGreaterThan_1_T1
            )
            def __call__(
                self,
                left: clr.Reference[IsAddressGreaterThan_1_T],
                right: clr.Reference[IsAddressGreaterThan_1_T],
            ) -> bool: ...
    ...
    class IsAddressLessThan_MethodGroup:
        def __getitem__(
            self, t: typing.Type[IsAddressLessThan_1_T1]
        ) -> IsAddressLessThan_1[IsAddressLessThan_1_T1]: ...
        ...
        class IsAddressLessThan_1(typing.Generic[IsAddressLessThan_1_T1]):
            ...
            def __call__(
                self,
                left: clr.Reference[IsAddressLessThan_1_T],
                right: clr.Reference[IsAddressLessThan_1_T],
            ) -> bool: ...
    ...
    class IsNullRef_MethodGroup:
        def __getitem__(
            self, t: typing.Type[IsNullRef_1_T1]
        ) -> IsNullRef_1[IsNullRef_1_T1]: ...
    ...
    class ReadUnaligned_MethodGroup:
        def __getitem__(
            self, t: typing.Type[ReadUnaligned_1_T1]
        ) -> ReadUnaligned_1[ReadUnaligned_1_T1]: ...
    ...
    class Subtract_MethodGroup:
        ...
        class Subtract_1(typing.Generic[Subtract_1_T1]):
            ...
            @typing.overload
            def __call__(
                self, source: clr.Reference[Subtract_1_T], elementOffset: int
            ) -> clr.Reference[Subtract_1_T]: ...
            # Method Subtract(source : T&, elementOffset : IntPtr) was skipped since it collides with above method
            @typing.overload
            def __call__(
                self, source: clr.Reference[Subtract_1_T], elementOffset: UIntPtr
            ) -> clr.Reference[Subtract_1_T]: ...
    ...
    class SubtractByteOffset_MethodGroup:
        def __getitem__(
            self, t: typing.Type[SubtractByteOffset_1_T1]
        ) -> SubtractByteOffset_1[SubtractByteOffset_1_T1]: ...
        ...
        class SubtractByteOffset_1(typing.Generic[SubtractByteOffset_1_T1]):
            SubtractByteOffset_1_T = (
                Unsafe.SubtractByteOffset_MethodGroup.SubtractByteOffset_1_T1
            )
            @typing.overload
            def __call__(
                self, source: clr.Reference[SubtractByteOffset_1_T], byteOffset: int
            ) -> clr.Reference[SubtractByteOffset_1_T]: ...
            @typing.overload
            def __call__(
                self, source: clr.Reference[SubtractByteOffset_1_T], byteOffset: UIntPtr
            ) -> clr.Reference[SubtractByteOffset_1_T]: ...
    ...
    class WriteUnaligned_MethodGroup:
        def __getitem__(
            self, t: typing.Type[WriteUnaligned_1_T1]
        ) -> WriteUnaligned_1[WriteUnaligned_1_T1]: ...
        ...
        class WriteUnaligned_1(typing.Generic[WriteUnaligned_1_T1]):
            ...
            @typing.overload
            def __call__(
                self, destination: clr.Reference[int], value: WriteUnaligned_1_T
            ) -> None: ...
            @typing.overload
            def __call__(
                self, destination: clr.Reference[None], value: WriteUnaligned_1_T
            ) -> None: ...
...
class ValueTaskAwaiter_GenericClasses(abc.ABCMeta):
    Generic_ValueTaskAwaiter_GenericClasses_ValueTaskAwaiter_1_TResult = typing.TypeVar(
        'Generic_ValueTaskAwaiter_GenericClasses_ValueTaskAwaiter_1_TResult'
    )
    def __getitem__(
        self,
        types: typing.Type[Generic_ValueTaskAwaiter_GenericClasses_ValueTaskAwaiter_1_TResult],
    ) -> typing.Type[
        ValueTaskAwaiter_1[Generic_ValueTaskAwaiter_GenericClasses_ValueTaskAwaiter_1_TResult]
    ]: ...
