...
class PackedSimd(abc.ABC):
    ...
    @staticmethod
    def MultiplyRoundedSaturateQ15(
    ...
    class Add_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, left: Vector128_1[UIntPtr], right: Vector128_1[UIntPtr]
        ) -> Vector128_1[UIntPtr]: ...
    ...
    class BitwiseSelect_MethodGroup:
        ...
        def __call__(
            self,
            left: Vector128_1[UIntPtr],
            right: Vector128_1[UIntPtr],
            select: Vector128_1[UIntPtr],
        ) -> Vector128_1[UIntPtr]: ...
    ...
    class ConvertNarrowingSaturateSigned_MethodGroup:
        def __call__(
            self, lower: Vector128_1[int], upper: Vector128_1[int]
        ) -> Vector128_1[int]: ...
    ...
    class ReplaceScalar_MethodGroup:
        @typing.overload
        def __call__(
            self, vector: Vector128_1[float], imm: int, value: float
        ) -> Vector128_1[float]: ...
        ...
        @typing.overload
        def __call__(
            self, vector: Vector128_1[UIntPtr], imm: int, value: UIntPtr
        ) -> Vector128_1[UIntPtr]: ...
    ...
    class Store_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, address: clr.Reference[UIntPtr], source: Vector128_1[UIntPtr]
        ) -> None: ...
    ...
    class StoreSelectedScalar_MethodGroup:
        @typing.overload
        def __call__(
            self, address: clr.Reference[float], source: Vector128_1[float], index: int
        ) -> None: ...
        ...
        @typing.overload
        def __call__(
            self, address: clr.Reference[UIntPtr], source: Vector128_1[UIntPtr], index: int
        ) -> None: ...
    ...
    class Swizzle_MethodGroup:
        def __call__(
            self, vector: Vector128_1[int], indices: Vector128_1[int]
        ) -> Vector128_1[int]: ...
