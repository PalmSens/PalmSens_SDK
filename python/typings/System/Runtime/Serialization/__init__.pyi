...
class SerializationBinder(abc.ABC):
    def BindToName(
        self,
        serializedType: typing.Type[typing.Any],
        assemblyName: clr.Reference[str],
        typeName: clr.Reference[str],
    ) -> None: ...
    @abc.abstractmethod
...
class SerializationInfo:
    @typing.overload
    def __init__(
        self, type: typing.Type[typing.Any], converter: IFormatterConverter
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    class AddValue_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, name: str, value: typing.Any, type: typing.Type[typing.Any]
        ) -> None: ...
