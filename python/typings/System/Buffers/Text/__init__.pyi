...
import clr
from System import DateTime, DateTimeOffset, Decimal, Guid, ReadOnlySpan_1, Span_1, TimeSpan
...
class Base64(abc.ABC):
    ...
    @staticmethod
    def DecodeFromUtf8InPlace(
        buffer: Span_1[int], bytesWritten: clr.Reference[int]
    ) -> OperationStatus: ...
    @staticmethod
    def EncodeToUtf8(
    ...
    class IsValid_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, base64TextUtf8: ReadOnlySpan_1[int], decodedLength: clr.Reference[int]
        ) -> bool: ...
        @typing.overload
        def __call__(
            self, base64Text: ReadOnlySpan_1[str], decodedLength: clr.Reference[int]
        ) -> bool: ...
