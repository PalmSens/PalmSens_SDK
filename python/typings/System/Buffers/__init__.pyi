...
class ArrayPool_GenericClasses(abc.ABCMeta):
    Generic_ArrayPool_GenericClasses_ArrayPool_1_T = typing.TypeVar(
        'Generic_ArrayPool_GenericClasses_ArrayPool_1_T'
    )
    def __getitem__(
...
class MemoryHandle(IDisposable):
    def __init__(
        self, pointer: clr.Reference[None], handle: GCHandle = ..., pinnable: IPinnable = ...
    ) -> None: ...
    @property
...
class MemoryManager_GenericClasses(abc.ABCMeta):
    ...
    def __getitem__(
        ...
        MemoryManager_1[Generic_MemoryManager_GenericClasses_MemoryManager_1_T]
    ]: ...
...
class MemoryManager_1(
    typing.Generic[MemoryManager_1_T], IMemoryOwner_1[MemoryManager_1_T], IPinnable, abc.ABC
):
    @property
...
class ReadOnlySpanAction_2(
    typing.Generic[ReadOnlySpanAction_2_T, ReadOnlySpanAction_2_TArg], MulticastDelegate
):
    ...
    def BeginInvoke(
        ...
        arg: ReadOnlySpanAction_2_TArg,
        callback: AsyncCallback,
        object: typing.Any,
    ) -> IAsyncResult: ...
    def EndInvoke(self, result: IAsyncResult) -> None: ...
    def Invoke(
        self, span: ReadOnlySpan_1[ReadOnlySpanAction_2_T], arg: ReadOnlySpanAction_2_TArg
    ) -> None: ...
...
class StandardFormat(IEquatable_1[StandardFormat]):
    ...
    @staticmethod
    def TryParse(
        format: ReadOnlySpan_1[str], result: clr.Reference[StandardFormat]
    ) -> bool: ...
