...
import clr
from System import Half, Int128, ReadOnlySpan_1, Span_1, UInt128, UIntPtr
...
class BinaryPrimitives(abc.ABC):
    ...
    @staticmethod
    def TryReadDoubleBigEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[float]
    ) -> bool: ...
    @staticmethod
    def TryReadDoubleLittleEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[float]
    ) -> bool: ...
    @staticmethod
    def TryReadHalfBigEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[Half]
    ) -> bool: ...
    @staticmethod
    def TryReadHalfLittleEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[Half]
    ) -> bool: ...
    @staticmethod
    def TryReadInt128BigEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[Int128]
    ) -> bool: ...
    @staticmethod
    def TryReadInt128LittleEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[Int128]
    ) -> bool: ...
    @staticmethod
    def TryReadInt16BigEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[int]
    ) -> bool: ...
    @staticmethod
    def TryReadInt16LittleEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[int]
    ) -> bool: ...
    @staticmethod
    def TryReadInt32BigEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[int]
    ) -> bool: ...
    @staticmethod
    def TryReadInt32LittleEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[int]
    ) -> bool: ...
    @staticmethod
    def TryReadInt64BigEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[int]
    ) -> bool: ...
    @staticmethod
    def TryReadInt64LittleEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[int]
    ) -> bool: ...
    @staticmethod
    def TryReadIntPtrBigEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[int]
    ) -> bool: ...
    @staticmethod
    def TryReadIntPtrLittleEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[int]
    ) -> bool: ...
    @staticmethod
    def TryReadSingleBigEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[float]
    ) -> bool: ...
    @staticmethod
    def TryReadSingleLittleEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[float]
    ) -> bool: ...
    @staticmethod
    def TryReadUInt128BigEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[UInt128]
    ) -> bool: ...
    @staticmethod
    def TryReadUInt128LittleEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[UInt128]
    ) -> bool: ...
    @staticmethod
    def TryReadUInt16BigEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[int]
    ) -> bool: ...
    @staticmethod
    def TryReadUInt16LittleEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[int]
    ) -> bool: ...
    @staticmethod
    def TryReadUInt32BigEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[int]
    ) -> bool: ...
    @staticmethod
    def TryReadUInt32LittleEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[int]
    ) -> bool: ...
    @staticmethod
    def TryReadUInt64BigEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[int]
    ) -> bool: ...
    @staticmethod
    def TryReadUInt64LittleEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[int]
    ) -> bool: ...
    @staticmethod
    def TryReadUIntPtrBigEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[UIntPtr]
    ) -> bool: ...
    @staticmethod
    def TryReadUIntPtrLittleEndian(
        source: ReadOnlySpan_1[int], value: clr.Reference[UIntPtr]
    ) -> bool: ...
    @staticmethod
    ...
    class ReverseEndianness_MethodGroup:
        ...
        @typing.overload
        def __call__(
            self, source: ReadOnlySpan_1[UInt128], destination: Span_1[UInt128]
        ) -> None: ...
        @typing.overload
        def __call__(
            self, source: ReadOnlySpan_1[Int128], destination: Span_1[Int128]
        ) -> None: ...
        @typing.overload
        def __call__(
            self, source: ReadOnlySpan_1[UIntPtr], destination: Span_1[UIntPtr]
        ) -> None: ...
        # Method ReverseEndianness(source : ReadOnlySpan`1, destination : Span`1) was skipped since it collides with above method
