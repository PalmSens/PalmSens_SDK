...
core_dll = PSSDK_DIR / 'PalmSens.Core'
core_linux_dll = PSSDK_DIR / 'PalmSens.Core.Linux'
...
ioports_dll = RUNTIME_DIR / plat / 'native' / 'System.IO.Ports'
...
sdk_version = Diagnostics.FileVersionInfo.GetVersionInfo(str(core_dll) + '.dll').ProductVersion
