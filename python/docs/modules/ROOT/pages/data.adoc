...
The xref:attachment$data/index.html[`ps.data`] submodule contains wrappers for the PyPalmSens .NET SDK libraries.
...
For more information, see the xref:attachment$data/index.html#pypalmsens.data.Measurement[Measurement reference].
...
Sometimes the parameters need to be tuned, see xref:attachment$data/index.html#pypalmsens.data.Curve.find_peaks[`.find_peaks()`] for more information.
====

You can do filtering using xref:attachment$data/index.html#pypalmsens.data.Curve.smooth[`.smooth()`]. Note that this updates the curve in-place.
...
For more information, see the xref:attachment$data/index.html#pypalmsens.data.Curve[Curve reference].
...
For more information, see the xref:attachment$data/index.html#pypalmsens.data.Peak[Peak reference].
...
For more information, see the xref:attachment$data/index.html#pypalmsens.data.DataSet[DataSet reference].
...
For more information, see the xref:attachment$data/index.html#pypalmsens.data.DataArray[DataArray reference].
...
For more information, see the xref:attachment$data/index.html#pypalmsens.data.EISData[EISData reference].
