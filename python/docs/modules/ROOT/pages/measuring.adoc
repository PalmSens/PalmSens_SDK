...
:api: attachment$reference/index.html
:api-data: attachment$reference/data/index.html
:api-inst: attachment$reference/instrument/index.html
:api-inst-async: attachment$reference/instrument_async/index.html

[NOTE]

====
This page has moved: xref:attachment$measuring/index.html[Connecting and measuring]
====
