...
The data arrays contain the complete data for the measurement. See ... for more information.
...
For impedemetric techniques, the callback returns the full eis dataset (TODO link EIS dataset)
