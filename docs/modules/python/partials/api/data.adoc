...
* link:#pypalmsens.data.ArrayType[*ArrayType*] –
...
* link:#pypalmsens.data.ArrayType.Time[*Time*] –
* link:#pypalmsens.data.ArrayType.Potential[*Potential*] –
* link:#pypalmsens.data.ArrayType.Current[*Current*] –
* link:#pypalmsens.data.ArrayType.Charge[*Charge*] –
* link:#pypalmsens.data.ArrayType.ExtraValue[*ExtraValue*] –
* link:#pypalmsens.data.ArrayType.Frequency[*Frequency*] –
* link:#pypalmsens.data.ArrayType.Phase[*Phase*] –
* link:#pypalmsens.data.ArrayType.ZRe[*ZRe*] –
* link:#pypalmsens.data.ArrayType.ZIm[*ZIm*] –
* link:#pypalmsens.data.ArrayType.Iac[*Iac*] –
* link:#pypalmsens.data.ArrayType.Z[*Z*] –
* link:#pypalmsens.data.ArrayType.Y[*Y*] –
* link:#pypalmsens.data.ArrayType.YRe[*YRe*] –
* link:#pypalmsens.data.ArrayType.YIm[*YIm*] –
* link:#pypalmsens.data.ArrayType.Cs[*Cs*] –
* link:#pypalmsens.data.ArrayType.CsRe[*CsRe*] –
* link:#pypalmsens.data.ArrayType.CsIm[*CsIm*] –
* link:#pypalmsens.data.ArrayType.Index[*Index*] –
* link:#pypalmsens.data.ArrayType.Admittance[*Admittance*] –
* link:#pypalmsens.data.ArrayType.Concentration[*Concentration*] –
* link:#pypalmsens.data.ArrayType.Signal[*Signal*] –
* link:#pypalmsens.data.ArrayType.Func[*Func*] –
* link:#pypalmsens.data.ArrayType.Integral[*Integral*] –
* link:#pypalmsens.data.ArrayType.AuxInput[*AuxInput*] –
* link:#pypalmsens.data.ArrayType.BipotCurrent[*BipotCurrent*] –
* link:#pypalmsens.data.ArrayType.BipotPotential[*BipotPotential*] –
* link:#pypalmsens.data.ArrayType.ReverseCurrent[*ReverseCurrent*] –
* link:#pypalmsens.data.ArrayType.CEPotential[*CEPotential*] –
* link:#pypalmsens.data.ArrayType.DCCurrent[*DCCurrent*] –
...
–
* link:#pypalmsens.data.ArrayType.mEdc[*mEdc*] –
* link:#pypalmsens.data.ArrayType.Eac[*Eac*] –
* link:#pypalmsens.data.ArrayType.MeasuredStepStartIndex[*MeasuredStepStartIndex*]
–
* link:#pypalmsens.data.ArrayType.miDC[*miDC*] –
