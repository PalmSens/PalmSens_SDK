...
2. Open the SDK with a compatible version, and use menu:File[Save for previous version]. See https://knowledge.ni.com/KnowledgeArticleDetails?id=kA03q000000YGiHCAW[this page] for more information.
