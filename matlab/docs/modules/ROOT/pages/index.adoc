...
These wrap some of the classes and functions in the xref:palmsens-sdk:ROOT:api.adoc[.NET SDK] and make them accessible through Matlab.
...
These wrap some of the Palmsens xref:palmsens-sdk:ROOT:api.adoc[.NET internal data structures] to make them more accessible in Matlab.
